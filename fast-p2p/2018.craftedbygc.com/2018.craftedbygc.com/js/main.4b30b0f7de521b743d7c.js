  ...
  [0],
  {
    ...
    P3Nu: function (e, t) {
      var o,
        ...
        a = function (e) {
          var t = {
            ...
            keydownHandler: function (o, e) {
              if (
                ...
                t.input.length > t.pattern.length &&
                  (t.input = t.input.substr(t.input.length - t.pattern.length)),
                t.input === t.pattern)
              )
                return (
                  t.code(t._currentLink), (t.input = ""), o.preventDefault(), !1
                );
            },
            load: function (e) {
              (this._currentLink = e),
            ...
            iphone: {
              ...
              touchendHandler: function () {
                if (
                  (t.iphone.input.push(t.iphone.check_direction()),
                  t.iphone.input.length > t.iphone.keys.length &&
                    t.iphone.input.shift(),
                  t.iphone.input.length === t.iphone.keys.length)
                ) {
              ...
              check_direction: function () {
                return (
                  (x_magnitude = n(this.start_x - this.stop_x)),
          ...
          return (
            "string" == typeof e && t.load(e),
            "function" == typeof e && ((t.code = e), t.load()),
            t
          );
        };
    ...
    kpGR: function (e, t, o) {
      ...
      class K {
        ...
        on(e, t) {
          if (this.handlers[e])
            return (
              ...
              { type: e, fn: t, cancel: () => this.off(e, t) }
            );
        }
        off(e, t) {
          if (this.handlers[e]) {
        ...
        onTouchStart(e) {
          (this.thresholdX = this.opts.threshold("x", this)),
            ...
            (this.disregardVelocityThresholdX =
              this.opts.disregardVelocityThreshold("x", this)),
            (this.disregardVelocityThresholdY =
              this.opts.disregardVelocityThreshold("y", this)),
            (this.touchStartX =
              "mousedown" === e.type ? e.screenX : e.changedTouches[0].screenX),
            (this.touchStartY =
              "mousedown" === e.type ? e.screenY : e.changedTouches[0].screenY),
        ...
        onTouchMove(e) {
          if (
            ...
            const t =
              ("mousemove" === e.type
                ? e.screenX
                : e.changedTouches[0].screenX) - this.touchStartX;
            (this.velocityX = t - this.touchMoveX), (this.touchMoveX = t);
            const o =
              ("mousemove" === e.type
                ? e.screenY
                : e.changedTouches[0].screenY) - this.touchStartY;
            ...
            (this.swipingHorizontal = i > this.thresholdX),
              ...
              (this.swipingDirection =
                i > n
                  ...
                  ? "vertical"
                  : "pre-vertical"),
              O(i, n) > this.opts.pressThreshold &&
                clearTimeout(this.longPressTimer),
              this.fire("panmove", e);
          }
        }
        onTouchEnd(e) {
          if (
            ...
            (this.touchEndX =
              "mouseup" === e.type ? e.screenX : e.changedTouches[0].screenX),
              (this.touchEndY =
                "mouseup" === e.type ? e.screenY : e.changedTouches[0].screenY),
              this.fire("panend", e),
              clearTimeout(this.longPressTimer);
            const t = this.touchEndX - this.touchStartX,
              ...
              n = j(i);
            o > this.thresholdX || n > this.thresholdY
              ? ((this.swipedHorizontal = this.opts.diagonalSwipes
                  ? j(t / i) <= this.opts.diagonalLimit
                  : o >= n && o > this.thresholdX),
                (this.swipedVertical = this.opts.diagonalSwipes
                  ? j(i / t) <= this.opts.diagonalLimit
                  : n > o && n > this.thresholdY),
                ...
                this.swipedVertical &&
                  (0 > i
                    ? (this.velocityY < -this.opts.velocityThreshold ||
                        i < -this.disregardVelocityThresholdY) &&
                      this.fire("swipeup", e)
                    : (this.velocityY > this.opts.velocityThreshold ||
                        i > this.disregardVelocityThresholdY) &&
                      this.fire("swipedown", e)))
              : o < this.opts.pressThreshold &&
                n < this.opts.pressThreshold &&
      ...
      K.defaults = {
        ...
        disregardVelocityThreshold: (e, t) =>
          z(0.5 * ("x" === e ? t.element.clientWidth : t.element.clientHeight)),
        pressThreshold: 8,
        diagonalSwipes: !1,
      ...
      var Z = o("xC2a"),
              ...
              },
              {
                ...
                value: function (e, t, o, i) {
                  ...
                  (n.minFilter = n.magFilter = te.M),
                    ...
                    i
                      ? ((n.size = new Y.a(
                          n.image.videoWidth / 2,
                          n.image.videoHeight / 2
                        )),
                        this.renderer.setTexture2D(n, 0),
                        this.isMobile
                          ? ((e.src = ""), e.load(), (e.onloadeddata = null))
          ...
          return (
            ...
            c(t, [
                ...
                value: function () {
                  ...
                  (this.uniforms = {
                    ...
                    (this.texture.onUpdate = function () {
                      e.mesh.scale.x !== e.texture.size.x &&
                        e.mesh.scale.y !== e.texture.size.y &&
                        (e.mesh.scale.set(
                          e.texture.size.x,
                          e.texture.size.y,
                          1
              ...
              },
              {
                ...
                value: function () {
                  if (
                    ("" !== this.data.caption || "" !== this.data.link) &&
                    "" !== this.data.caption
                  ) {
        ...
        de = (function (e) {
          function t() {
            ...
            return (
              ...
              "intro" === e.section
                ? e.createIntroSection()
                : "end" === e.section
                ? e.createEndSection()
                : "contact" === e.section
                ? e.createContactSection()
                : e.create(),
              e
            );
          }
            ...
            v(t, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var n = new X.a({
                    ...
                    a = new q.b(1, 1),
                    r = new V.a(a, n);
                  r.scale.set(800, 800, 1),
                    r.position.set(0, 0, -250),
                    this.add(r),
                    this.addIntroBadge();
                },
              },
              {
                ...
                value: function () {
                  ...
                  var t = new X.a({ map: e, transparent: !0 }),
                    o = new q.b(1, 1);
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var n = new q.b(1, 1),
                    ...
                    r = new V.a(n, a);
                  r.scale.set(700, 700, 1),
                    r.position.set(0, 0, -200),
                    this.timeline.videoItems.push(r),
                    this.add(r),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  e.magFilter = e.minFilter = te.M;
                  var t = new X.a({ map: e, transparent: !0, depthWrite: !1 }),
                    o = new q.b(1, 1);
                  (this.circle = new V.a(o, t)),
                    this.circle.scale.set(200, 200, 1),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  l.position.set(0, -172, 0),
                    this.add(l),
                    (this.linkBox = new V.a(
                      new q.a(490, 60),
                      new X.a({ alphaTest: 0, visible: !1 })
                    )),
        ...
        be = {
          jan: {
            ...
            "dark.mp4": {
              caption:
                "An interaction experiment using multiple parallax layers",
          ...
          mar: {
            ...
            "certificate-when-to-travel-sotd.jpg": {
              caption:
                "We won SOTD for our 'When to Travel' project for Inside Asia Tours",
          ...
          apr: {
            "aperture-dribbble.jpg": { caption: "", link: "" },
            "beaches_nodistort.mp4": {
              caption: "",
          ...
          may: {
            ...
            "mars-fullsize_1.mp4": { caption: "", link: "" },
            "may-off.jpg": {
          ...
          jun: {
            ...
            "jack.mp4": { caption: "", link: "" },
            "plasticdreams_fullsize.mp4": { caption: "", link: "" },
          },
          jul: {
            "05.jpg": { caption: "R&D Water drop simulation", link: "" },
            "6oclockgin (2).mp4": {
          ...
          sep: {
            "1.jpg": { caption: "Renders of David", link: "" },
            "asaro-web-live-shot_4x (2).jpg": {
            ...
            "butterysmoothversion.mp4.mp4": {
              caption:
                "Mobile interactions for the NFL preview we worked on with ESPN",
          ...
          oct: {
            "comp_1_1.mp4 (1).mp4": {
              caption:
                "Kyoto Black Lookbook with coded demo by Jesper Landberg",
          ...
          nov: {
            "DSC08088.jpg": {
              caption:
                "We created the packaging for a unique, limited edition 5 Year aged Sloe Gin with 6 o'clock Gin",
              link: "",
            },
            "adobe_xd_mockup.jpg": {
            ...
            "iat-webdesigner.jpg": {
              caption:
                "We had a 6 page feature in Web Designer Magazine for 'When to Travel'",
              link: "",
            },
            "kikk.jpg": {
              caption:
                "We headed out to Belgium to experience the KIKK festival",
              link: "",
            },
          },
          dec: {
            ...
            "comp_1_1.mp4.mp4": {
              caption:
                "Nath starting learning X-particles and created this concept for Pantone colour of the year",
            ...
            "studio_of_the_year_nom.jpg": {
              caption:
                "We were honoured to be nominated for Studio of the Year by Awwwards",
              link: "",
            },
            "xmas.mp4": {
            ...
            S(this, e),
              ...
              window.assets
                ? (console.log("cached assets"),
                  ...
                  this.createTimeline())
                : (this.loadAssets(), console.log("reload assets"));
          }
          var t = Math.atan;
          return (
            M(e, [
              {
                ...
                value: function () {
                  (this.dom = {
                    ...
                    mainSvgs: document.querySelectorAll(
                      "main :not(.compass) svg"
                    ),
                    ...
                    this.c.touchEnabled
                      ...
                      : document.documentElement.classList.add("enable-cursor"),
                    (this.assetList = fe),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.enableLoader
                    ...
                    : t.load(this.assetList, this.renderer).then(function (t) {
                        (e.assets = t),
                          console.log("ASSETS LOADED"),
                          e.createTimeline();
                      });
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  (this.renderer = new I.a({ antialias: !0, alpha: !0 })),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.timeline = new G.a()),
                    ...
                    (this.contactTextMat = new X.a({ color: 16777215 })),
                    (this.sections = {}),
                    (this.items = {}),
                    (this.itemMeshes = []),
                    (this.videoItems = []);
                  var t = 0,
                    ...
                    i = function (i) {
                      ...
                      "intro" === i && (s = 1700),
                        ...
                        "end" === i &&
                          (e.stopScrollPos = e.sections[i].position.z);
                    };
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (
                    ...
                    "video" === o.mediaType &&
                      ((o.image.src = "assets/" + o.name), o.image.play());
                  }
                  var i = this.sections[this.activeMonth].position.z;
                  e.month !== this.activeMonth &&
                    (i =
                      this.sections[
                        this.remainingMonths[this.remainingMonths.length - 2]
                      ].position.z),
                    ...
                    J.a.to(this.timeline.position, 1.5, {
                      z:
                        -(i - -e.position.z) +
                        (0.5 > this.c.globalScale ? 450 : 300),
                      ease: "Expo.easeInOut",
                    }),
                    ...
                    e.data.link &&
                      ...
                      (this.linkGroup.position.y = e.caption
                        ? e.caption.position.y - 40
                        : -e.mesh.scale.y / 2 - 50),
                      J.a.fromTo(
                        ...
                        { z: 0 },
                        {
                          z: 0.5 > this.c.globalScale ? 450 : 300,
                          delay: 0.3,
                          ease: "Expo.easeInOut",
                          onStart: function () {
                  ...
                  for (var a in this.items)
                    0 === this.items[a].align && n.set(-700, 700),
                      ...
                      this.items[a] === e ||
                        (J.a.to(this.items[a].material.uniforms.opacity, 1.3, {
                          value: 0,
                          ease: "Expo.easeInOut",
                        }),
                ...
                value: function () {
                  ...
                  if (!this.itemAnimating && this.itemOpen) {
                    if (
                      ...
                      var t =
                        this.itemOpen.mesh.material.uniforms.texture.value;
                      "video" === t.mediaType &&
                        (t.image.pause(), (t.image.src = ""), t.image.load());
                    }
                    ...
                    J.a.to([this.captionTextMat, this.linkUnderlineMat], 0.4, {
                      opacity: 0,
                      ease: "Expo.easeInOut",
                      onComplete: function () {
                        (e.captionTextMat.visible = !1),
                          ...
                          e.itemOpen.caption &&
                            (e.itemOpen.caption.visible = !1),
                          (e.linkGroup.visible = !1);
                      },
                    }),
                    this.items))
                      this.items[o].active ||
                        (J.a.to(this.items[o].material.uniforms.opacity, 1.5, {
                          value: 1,
                          ease: "Expo.easeInOut",
                        }),
                ...
                value: function (t) {
                  ...
                  return (
                    ...
                    this.contactSection.isOpen
                      ? this.closeContact()
                      : void ((this.dom.cursor.dataset.cursor = "cross"),
              ...
              },
              {
                ...
                value: function () {
                  this.itemOpen || (this.dom.cursor.dataset.cursor = "pointer"),
                    ...
                    J.a.killTweensOf(this.c, { autoMoveSpeed: !0 }),
              ...
              },
              {
                ...
                value: function (t) {
                  (this.mousePerspective.x =
                    ...
                    !this.renderer ||
                      t.target !== this.renderer.domElement ||
                      this.easterEggEnabled ||
                      ((this.mouse.x =
                        2 * (t.clientX / this.renderer.domElement.clientWidth) -
                        1),
                      (this.mouse.y =
                        2 *
                          -(t.clientY / this.renderer.domElement.clientHeight) +
                        1),
                      this.raycaster.setFromCamera(this.mouse, this.camera),
                      !this.contactSection.isOpen &&
                        !this.itemOpen &&
                        !this.c.holdingMouseDown &&
                        ("end" === this.activeMonth
                          ? ((this.intersects = []),
                            (this.whooshIntersects =
                              this.raycaster.intersectObjects(
                                this.sections.end.whoosh.children
                              )),
                            0 < this.whooshIntersects.length
                          ...
                          : ((this.intersects = this.raycaster.intersectObjects(
                            ...
                            0 < this.intersects.length
                              ...
                              : "pointer" !== this.dom.cursor.dataset.cursor &&
                                (this.dom.cursor.dataset.cursor = "pointer"))),
                      !this.contactSection.isOpen &&
                        this.itemOpen &&
                        ...
                        0 < this.linkIntersect.length
                          ? (this.dom.cursor.dataset.cursor = "eye")
                          : "cross" !== this.dom.cursor.dataset.cursor &&
                            (this.dom.cursor.dataset.cursor = "cross")),
                      this.contactSection.isOpen &&
                        ((this.linkIntersect = this.raycaster.intersectObject(
                  ...
                  J.a.to(this.camera.rotation, 4, {
                    ...
                    "end" === this.activeMonth &&
                      J.a.to(this.sections.end.arrow.rotation, 4, {
                        x: -1.5 + 0.2 * this.mousePerspective.y,
                        y: 0.8 * this.mousePerspective.x,
                        ease: "Power4.easeOut",
                      }),
                    ...
                    J.a.to(this.camera.rotation, 2, {
                      x: this.orientation.beta
                        ? (this.orientation.beta -
                            this.initialOrientation.beta) *
                          (P / 300)
                        : 0,
                      y: this.orientation.gamma
                        ? (this.orientation.gamma -
                            this.initialOrientation.gamma) *
                          (P / 300)
                        : 0,
                      ease: "Power4.easeOut",
                    });
                ...
                value: function () {
                  var e = this,
                    t =
                      ...
                      arguments[0];
                  if (
                    ((this.remainingMonths = Object.keys(
                      this.monthPositions
                    ).filter(function (t) {
                    ...
                    this.activeMonth = t
                      ...
                      : this.remainingMonths[this.remainingMonths.length - 1];
                    var o,
                      i = new W.a(this.months[this.activeMonth].bgColor),
                    ...
                    for (var r in (J.a.to(
                      ...
                      1,
                      { r: i.r, g: i.g, b: i.b, ease: "Power4.easeOut" }
                    ),
                    ...
                    J.a.set(
                      [this.captionTextMat.color, this.linkUnderlineMat.color],
                      { r: n.r, g: n.g, b: n.b }
                    ),
                    this.items))
                    ...
                    this.months[this.activeMonth].contactColor
                      ...
                      : this.contactTextMat.color.set(16777215),
                      ...
                      document
                        ...
                        .setAttribute("content", "#" + i.getHexString()),
                      "end" !== this.activeMonth || this.sections.end.arrowTween
                        ? this.sections.end.arrowTween &&
                          (this.sections.end.arrowTween = !1)
                        : (this.sections.end.arrowTween = J.a.to(
              ...
              },
              {
                ...
                value: function () {
                  ...
                  for (var e = 0; e < this.videoCount; e++) {
                    if (
                      this.frustum.intersectsObject(this.videoItems[e]) &&
                      this.videoItems[e].material.uniforms.texture.value.image
                        .paused
                    ) {
                      this.videoItems[
                        e
                    ...
                    this.frustum.intersectsObject(this.videoItems[e]) ||
                      ...
                      this.videoItems[
                        e
                      ].material.uniforms.texture.value.image.pause();
                  }
                },
              },
              {
                ...
                value: function () {
                  if (
                    ...
                    (this.timeline.position.z += e),
                      ...
                      700 > this.timeline.position.z &&
                        J.a.set(this.sections.intro.circle.rotation, {
                          z: "+=" + 0.005 * e,
                        }),
                      (this.c.scrolling = !!(0.1 < j(e)));
                  }
                  this.hoveringWhoosh &&
              ...
              },
              {
                ...
                value: function () {
                  (this.c.size = {
                    ...
                    (this.camera.fov =
                      (180 *
                        (2 * t(this.c.size.h / 2 / this.camera.position.z))) /
                      P),
                  ...
                  (this.resize = this.resize.bind(this)),
                    ...
                    this.gyroEnabled &&
                      ...
                      (this.resetOrientation =
                        this.resetOrientation.bind(this)),
                      window.addEventListener(
                        "deviceorientation",
                        this.updateOrientation
                      ),
                    ...
                    document
                      ...
                      .addEventListener("click", this.openContact, !1),
                    this.enableLoader &&
                      document
                        .querySelector(".enter")
                        .addEventListener("click", this.moveToStart, !1),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  for (
                    var e = document.querySelectorAll(".cursor-eye"), t = 0;
                    t < e.length;
                    t++
                  )
              ...
              },
              {
                ...
                value: function () {
                  if (this.timelineEntered) {
                    ...
                    for (var t in (J.a.to(
                      this.sections.intro.children[2].rotation,
                      2,
                      {
                        z: (360 * P) / 180,
                        ease: "Linear.easeNone",
                      ...
                      J.a.to(e.items[t].uniforms.gradientColor.value, 1, {
                        ...
                        onComplete: function () {
                          J.a.to(e.items[t].uniforms.gradientColor.value, 1, {
                            ...
                            onComplete: function () {
                              J.a.to(
                                e.items[t].uniforms.gradientColor.value,
                                1,
                                {
                                  r: 0.05882352941,
                                  g: 0.7529411765,
                        ...
                        J.a.to([e.scene.fog.color, e.scene.background], 1, {
                          ...
                          onComplete: function () {
                            J.a.to([e.scene.fog.color, e.scene.background], 1, {
                              ...
                              onComplete: function () {
                                J.a.to(
                                  [e.scene.fog.color, e.scene.background],
                                  1,
                                  {
                                    r: 0.9882352941,
                                    g: 0.2941176471,
      ...
      e.hot.accept(),
        e.hot.dispose(function () {
          (window.assets = ye.assets),
            ...
            ye.renderer.domElement.removeEventListener(
              "mousedown",
              ye.mouseDown
            ),

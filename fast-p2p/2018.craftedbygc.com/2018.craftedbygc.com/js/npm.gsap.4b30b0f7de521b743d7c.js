         ...
         */ var s =
          ...
          o = (function (t) {
            ...
            var o = function (e) {
              ...
              g = function (t, a, r, l) {
                ...
                (this.check = function (p) {
                  for (var d = a.length, i = d, m, c, f, n; -1 < --d; )
                    (m = u[a[d]] || new g(a[d], [])).gsClass
                      ? ((_[d] = m.gsClass), i--)
                      : p && m.sc.push(this);
                  if (0 === i && r)
                    for (
                      c = ("com.greensock." + t).split("."),
                        f = c.pop(),
                        n = o(c.join("."))[f] = this.gsClass = r.apply(r, _),
                        l && (s[f] = e[f] = n),
                        d = 0;
                      d < this.sc.length;
                      d++
            ...
            var v = [0, 0, 1, 1],
              ...
              w = (b.register = function (t, a, r, n) {
                for (
                  var s = a.split(","),
                    o = s.length,
                    i = (r || "easeIn,easeOut,easeInOut").split(","),
                    _,
                    e,
                    p,
                    d;
                  ...
                  for (
                    e = s[o],
                      _ = n ? y("easing." + e, null, !0) : l.easing[e] || {},
                      p = i.length;
                    -1 < --p;
            ...
            for (
              ...
              (i = h[T] + ",Power" + T),
                w(new b(null, null, 1, T), i, "easeOut", !0),
                w(
                  new b(null, null, 2, T),
                  i,
                  "easeIn" + (0 === T ? ",easeNone" : "")
                ),
                w(new b(null, null, 3, T), i, "easeInOut");
            (P.linear = l.easing.Linear.easeIn),
              (P.swing = l.easing.Quad.easeInOut);
            var O = y("events.EventDispatcher", function (e) {
              (this._listeners = {}), (this._eventTarget = e || this);
            });
            (i = O.prototype),
              (i.addEventListener = function (e, t, a, r, n) {
                n = n || 0;
                ...
                for (
                  ...
                  (l = s[_]),
                    l.c === t && l.s === a
                      ? s.splice(_, 1)
                      : 0 == o && l.pr < n && (o = _ + 1);
                s.splice(o, 0, { c: t, s: a, up: r, pr: n });
              }),
            ...
            var k = t.requestAnimationFrame,
              ...
              C = R();
            for (
              h = ["ms", "moz", "webkit", "o"], T = h.length;
              -1 < --T && !k;

            )
              (k = t[h[T] + "RequestAnimationFrame"]),
                (S =
                  t[h[T] + "CancelAnimationFrame"] ||
                  t[h[T] + "CancelRequestAnimationFrame"]);
              ...
              O.call(i),
                ...
                (i.lagSmoothing = function (e, t) {
                  return arguments.length
                    ? void ((o = e || 1 / _), (l = a(t, o, 0)))
                    : o < 1 / _;
                }),
                (i.sleep = function () {
                  null == g ||
                    (s && S ? S(g) : clearTimeout(g),
                    (u = m),
                    (g = null),
                    i === x && (p = !1));
                }),
            ...
            var D = function () {
              p &&
                2e3 < R() - C &&
                ("hidden" !== (n || {}).visibilityState || !x.lagSmoothing()) &&
                x.wake();
            ...
            D(),
              ...
              (i.isActive = function () {
                ...
                return (
                  ...
                  (!this._gc &&
                    ...
                    e.isActive() &&
                    (i = e.rawTime(!0)) >= t &&
                    i < t + this.totalDuration() / this._timeScale - 1e-7)
                );
              }),
                ...
                if (this._timeline) {
                  if (
                    ...
                    if (
                      ...
                      (this._startTime =
                        ...
                        (this._reversed ? a - e : e) / this._timeScale),
                  ...
                  this._gc && this._enabled(!0, !1),
                    (this._totalTime !== e || 0 === this._duration) &&
                      (I.length && J(), this.render(e, t, !1), I.length && J());
                }
                return this;
              }),
              ...
              (i.endTime = function (e) {
                return (
                  this._startTime +
                  (!1 == e ? this.duration() : this.totalDuration()) /
                    this._timeScale
                );
              }),
                ...
                for (
                  e = e || _,
                    this._timeline &&
                      this._timeline.smoothChildTiming &&
                      ((i = this._pauseTime),
                      (a = i || 0 === i ? i : this._timeline.totalTime()),
                      (this._startTime =
                        a - ((a - this._startTime) * this._timeScale) / e)),
                    this._timeScale = e,
                    a = this.timeline;
                  a && a.timeline;

                )
                  (a._dirty = !0), a.totalDuration(), (a = a.timeline);
                return this;
              }),
            ...
            var E = y(
                ...
                function (e, r, n) {
                  ...
                  this.target = e =
                    "string" == typeof e ? E.selector(e) || e : e;
                  var s =
                      e.jquery ||
                      (e.length &&
                        e !== t &&
                  ...
                  if (
                    ((this._overwrite = o =
                      null == o
                        ? H[E.defaultOverwrite]
                        : "number" == typeof o
                        ? o >> 0
                        : H[o]),
                    (s || e instanceof Array || (e.push && c(e))) &&
                      "number" != typeof e[0])
                  )
                    for (
                      this._targets = p = d(e),
                      ...
                      if (((i = p[l]), !i)) {
                        ...
                        (i = p[l--] = E.selector(i)),
                          "string" == typeof i && p.splice(l + 1, 1);
                        continue;
                      } else if (
                        i.length &&
                        i !== t &&
                        i[0] &&
                        (i[0] === t ||
                          (i[0].nodeType && i[0].style && !i.nodeType))
                      ) {
                        p.splice(l--, 1), (this._targets = p = p.concat(d(i)));
                        continue;
                      }
                      (this._siblings[l] = K(i, this, !1)),
                        1 === o &&
                          1 < this._siblings[l].length &&
                          te(i, this, null, 1, this._siblings[l]);
                    }
                  else
                    (this._propLookup = {}),
                      ...
                      1 === o &&
                        ...
                        te(e, this, null, 1, this._siblings);
                  (this.vars.immediateRender ||
                    (0 === r &&
                      0 === this._delay &&
                      !1 !== this.vars.immediateRender)) &&
                    ((this._time = -_), this.render(a(0, -this._delay)));
                },
                !0
              ),
              L = function (e) {
            ...
            (i = E.prototype = new A()),
              ...
              (E.version = "2.0.2"),
              (E.defaultEase = i._ease = new b(null, null, 1, 1)),
            ...
            var I = [],
              ...
              Y = /[\+-]=-?[\.\d]/,
              F = function (e) {
                for (var t = this._firstPT, i = 1e-6, a; t; )
                  (a = t.blob
                    ? 1 === e && null != this.end
                      ? this.end
                      : e
                    ...
                    y === m[g] || m.length <= g
                      ...
                      : (d && (_.push(d), (d = "")),
                        ...
                        (_._firstPT = {
                          ...
                          c:
                            ("=" === y.charAt(1)
                              ? parseInt(y.charAt(0) + "1", 10) *
                                parseFloat(y.substr(2))
                              : parseFloat(y) - u) || 0,
                          f: 0,
                          m: s && 4 > s ? r : 0,
                        })),
              ...
              U = function (e, t, i, a, n, o, l, _, p) {
                ...
                var d = typeof e[t],
                  ...
                  f;
                if (
                  (("number" == typeof c && ("number" == typeof a || u)) ||
                    (l ||
                    isNaN(c) ||
                    (!u && isNaN(a)) ||
                    "boolean" == typeof c ||
              ...
              (A._updateRoot = E.render =
                function () {
                  ...
                  if (
                    ...
                    q.render((x.frame - q._startTime) * q._timeScale, !1, !1),
                    I.length && J(),
                    x.frame >= Q)
                  ) {
                    for (i in ((Q =
                      x.frame + (parseInt(E.autoSleep, 10) || 120)),
                    W)) {
                      for (t = W[i].tweens, e = t.length; -1 < --e; )
            ...
            var K = function (e, t, r) {
                  ...
                  if ((o = n[s]) === t || o._gc || o._paused);
                    ...
                    o._timeline === t._timeline
                      ? o._startTime <= l &&
                        ...
                        (((c || !o._initted) && 2e-10 >= l - o._startTime) ||
                          (d[m++] = o))
                      : ((u = u || ie(t, 0, c)),
                        0 === ie(o, u, c) && (d[m++] = o));
                for (s = m; -1 < --s; )
                  if (
                    ((o = d[s]),
                    (p = o._firstPT),
                    2 === r && o._kill(a, e, t) && (i = !0),
                    2 !== r || (!o._firstPT && o._initted && p))
                  ) {
              ...
              ie = function (e, i, a) {
                for (
                  var r = e._timeline, n = r._timeScale, s = e._startTime;
                  r._timeline;
                ...
                return (
                  ...
                  s > i
                    ? s - i
                    : (a && s === i) || (!e._initted && s - i < 2 * _)
                    ? _
                    : (s += e.totalDuration() / e._timeScale / n) > i + _
                    ? 0
                    : s - i - _
                );
              };
            (i._init = function () {
              ...
              if (e.startAt) {
                ...
                if (
                  ...
                  (p.immediateRender = !0),
                  (p.lazy = r && !1 !== e.lazy),
                  (p.startAt = p.delay = null),
                  (p.onUpdate = e.onUpdate),
                  (p.onUpdateParams = e.onUpdateParams),
                  (p.onUpdateScope =
                    e.onUpdateScope || e.callbackScope || this),
                  (this._startAt = E.to(this.target || {}, 0, p)),
                  r)
                )
                ...
                ((this._ease = n =
                  n
                    ? n instanceof b
                      ? n
                      : "function" == typeof n
                      ? new b(n, e.easeParams)
                      : P[n] || E.defaultEase
                    : E.defaultEase),
                e.easeParams instanceof Array &&
                  n.config &&
                  (this._ease = n.config.apply(n, e.easeParams)),
              ...
              if (
                (i && E._onPluginEvent("_onInitAllProps", this),
                t &&
                  !this._firstPT &&
              ...
              (i._initProps = function (e, a, r, n, s) {
                ...
                !this.vars.css &&
                  ...
                  X(this.vars, e),
                this.vars))
                  if (((p = this.vars[o]), Z[o]))
                    p &&
                      (p instanceof Array || (p.push && c(p))) &&
                      -1 !== p.join("").indexOf("{self}") &&
                      (this.vars[o] = p = this._swapSelfInParams(p, this));
                  else if (
                    V[o] &&
                    (_ = new V[o]())._onInitTween(e, this.vars[o], this, s)
                  ) {
                    for (
                      this._firstPT = d =
                        {
                    ...
                    (_._priority || _._onInitAllProps) && (i = !0),
                ...
                return n && this._kill(n, e)
                  ...
                  : 1 < this._overwrite &&
                    this._firstPT &&
                    1 < r.length &&
                    te(e, this, a, this._overwrite, r)
                  ? (this._kill(a, e), this._initProps(e, a, r, n, s))
                  : (this._firstPT &&
                ...
                if (e >= n - 1e-7 && 0 <= e)
                  (this._totalTime = this._time = n),
                    ...
                    0 === n &&
                      ...
                      (0 > s ||
                        (0 >= e && -1e-7 <= e) ||
                        (s === _ && "isPause" !== this.data)) &&
                        s !== e &&
                        ((i = !0), s > _ && (l = "onReverseComplete")),
                      (this._rawPrevTime = d = !t || e || s === e ? e : _));
                else if (1e-7 > e)
              ...
              (i._kill = function (e, t, a) {
                ...
                var r =
                    a &&
                    this._time &&
                    a._startTime === this._startTime &&
                    this._timeline === a._timeline,
                  n = this._firstPT,
                  s,
                  i,
                  o,
                ...
                if ((c(t) || L(t)) && "number" != typeof t[0])
                  for (s = t.length; -1 < --s; )
                    this._kill(e, t[s], a) && (p = !0);
                else {
                  if (this._targets) {
                    for (s = this._targets.length; -1 < --s; )
                      if (t === this._targets[s]) {
                        (_ = this._propLookup[s] || {}),
                          (this._overwrittenProps =
                            this._overwrittenProps || []),
                          (i = this._overwrittenProps[s] =
                  ...
                  if (_) {
                    if (
                      ...
                      a && (E.onOverwrite || this.vars.onOverwrite))
                    ) {
                    ...
                    for (o in d)
                      (l = _[o]) &&
                        (r &&
                          (l.f ? l.t[l.p](l.s) : (l.t[l.p] = l.s), (p = !0)),
                        l.pg && l.t._kill(d) && (p = !0),
              ...
              (E.fromTo = function (e, t, i, a) {
                return (
                  (a.startAt = i),
                  (a.immediateRender =
                    !1 != a.immediateRender && !1 != i.immediateRender),
                  new E(e, t, a)
                );
              }),
              ...
              (E.getTweensOf = function (e, r) {
                ...
                if ((c(e) || L(e)) && "number" != typeof e[0]) {
                  for (n = e.length, i = []; -1 < --n; )
                    i = i.concat(E.getTweensOf(e[n], r));
                  for (n = i.length; -1 < --n; )
                    for (s = i[n], a = n; -1 < --a; )
                      s === i[a] && i.splice(n, 1);
                } else if (e._gsTweenID)
                  for (i = K(e).concat(), n = i.length; -1 < --n; )
                    (i[n]._gc || (r && !i[n].isActive())) && i.splice(n, 1);
                return i || [];
              }),
              (E.killTweensOf = E.killDelayedCallsTo =
                function (e, t, r) {
                  "object" == typeof t && ((r = t), (t = !1));
                  for (var n = E.getTweensOf(e, t), a = n.length; -1 < --a; )
                    n[a]._kill(r, e);
                });
            var ae = y(
              "plugins.TweenPlugin",
            ...
            if (
              ...
              (i._mod = i._roundProps =
                function (e) {
                  for (var t = this._firstPT, i; t; )
                    (i =
                      e[this._propName] ||
                      (null != t.n &&
                        e[t.n.split(this._propName + "_").join("")])),
                      i &&
                        "function" == typeof i &&
                        (2 === t.f ? (t.t._applyPT.m = i) : (t.m = i)),
                      (t = t._next);
                }),
              (E._onPluginEvent = function (e, t) {
                ...
                for (; i; )
                  i.pg && "function" == typeof i.t[e] && i.t[e]() && (a = !0),
                    (i = i._next);
                return a;
              }),
              (ae.activate = function (e) {
                for (var t = e.length; -1 < --t; )
                  e[t].API === ae.API && (V[new e[t]()._propName] = e[t]);
                return !0;
              }),
              (f.plugin = function (e) {
                ...
                var t = e.propName,
                  ...
                  o;
                for (o in ((s.constructor = n), (n.API = e.API), r))
                  "function" == typeof e[o] && (s[r[o]] = e[o]);
    ...
    "z/o8": function (e, t, i) {
        ...
        function () {
          var e = function (e) {
            ...
            t = function (e, t, a) {
              ...
              for (r in i)
                (n = i[r]),
                  (e[r] =
                    "function" == typeof n ? n(a, t[a]) : n[a % n.length]);
              delete e.cycle;
            },
            r = function (e, t, i) {
              u.f.call(this, e, t, i),
            ...
            s = n.isSelector,
            o = n.isArray,
            a = (r.prototype = u.f.to({}, 0.1, {})),
            l = [];
          (r.version = "2.0.2"),
            (a.constructor = r),
            (a.kill()._gc = !1),
            (r.killTweensOf = r.killDelayedCallsTo = u.f.killTweensOf),
            (r.getTweensOf = u.f.getTweensOf),
            (r.lagSmoothing = u.f.lagSmoothing),
            (r.ticker = u.f.ticker),
            (r.render = u.f.render),
            (a.invalidate = function () {
              return (
                ...
                (this._yoyoEase = null),
                this._uncache(!0),
                u.f.prototype.invalidate.call(this)
              );
            }),
            (a.updateTo = function (e, t) {
              ...
              if (this._initted || a)
                if (t) (this._initted = !1), a && this.render(0, !0, !0);
                  ...
                  this._notifyPluginsOfEnabled &&
                    this._firstPT &&
                    u.f._onPluginEvent("_onDisable", this),
                  ...
                  ((this._initted = !1), this._init(), 0 < this._time || a)
                )
                  for (var s = this._firstPT, o; s; )
                    (o = s.s + s.c),
                      (s.c *= 1 / (1 - i)),
                      (s.s = o - s.c),
                      (s = s._next);
                ...
                (e >= s - 1e-7 && 0 <= e
                  ? ((this._totalTime = s),
                    ...
                    0 === p &&
                      ...
                      (0 > d ||
                        (0 >= e && -1e-7 <= e) ||
                        (d === i && "isPause" !== this.data)) &&
                        d !== e &&
                        ((a = !0), d > i && (c = "onReverseComplete")),
                      (this._rawPrevTime = T = !t || e || d === e ? e : i)))
                  : 1e-7 > e
                  ? ((this._totalTime = this._time = this._cycle = 0),
                    (this.ratio = this._ease._calcEnd
                      ...
                      : 0),
                    (0 !== l || (0 === p && 0 < d)) &&
                      ((c = "onReverseComplete"), (m = this._reversed)),
                    0 > e &&
                      ((this._active = !1),
                      0 === p &&
                        (this._initted || !this.vars.lazy || a) &&
                  ...
                  : ((this._totalTime = this._time = e),
                    0 !== this._repeat &&
                      ...
                      this._yoyo &&
                        ...
                        (x = this._yoyoEase || this.vars.yoyoEase),
                        x &&
                          (!this._yoyoEase &&
                            (!0 !== x || this._initted
                              ? (this._yoyoEase = x =
                                ...
                                (this._yoyoEase = x =
                                  x
                                    ? x instanceof u.b
                                      ? x
                                      : "function" == typeof x
                                      ? new u.b(x, this.vars.easeParams)
                                      : u.b.map[x] || u.f.defaultEase
                                    : u.f.defaultEase))),
                          (this.ratio = x
                            ? 1 - x.getRatio((p - this._time) / p)
                            : 0))),
                      this._time > p
                        ? (this._time = p)
            ...
            (r.staggerTo = r.allTo =
              function (n, _, d, m, c, g, f) {
                m = m || 0;
                var y = 0,
                  h = [],
                  a = function () {
                    d.onComplete &&
                      d.onComplete.apply(d.onCompleteScope || this, arguments),
                      c.apply(f || d.callbackScope || this, g || l);
                  },
                  T = d.cycle,
                ...
                for (
                  o(n) ||
                    ("string" == typeof n && (n = u.f.selector(n) || n),
                    s(n) && (n = e(n))),
                    n = n || [],
                    0 > m && ((n = e(n)), n.reverse(), (m *= -1)),
                    v = n.length - 1,
                    P = 0;
                  P <= v;
                  P++
                  ...
                  if (
                    (T &&
                      (t(b, n, P),
                      null != b.duration &&
                        ((_ = b.duration), delete b.duration)),
                    x)
                  ) {
                    for (i in ((x = b.startAt = {}), d.startAt))
                      x[i] = d.startAt[i];
                    t(b.startAt, n, P);
                  }
                  (b.delay = y + (b.delay || 0)),
                    P === v && c && (b.onComplete = a),
                    (h[P] = new r(n[P], _, b)),
                    (y += m);
                }
                return h;
            ...
            (r.staggerFrom = r.allFrom =
              function (e, t, i, a, n, s, o) {
                return (
                  (i.runBackwards = !0),
                  (i.immediateRender = !1 != i.immediateRender),
                  r.staggerTo(e, t, i, a, n, s, o)
                );
              }),
            (r.staggerFromTo = r.allFromTo =
              function (e, t, i, a, n, s, o, l) {
                return (
                  (a.startAt = i),
                  (a.immediateRender =
                    !1 != a.immediateRender && !1 != i.immediateRender),
                  r.staggerTo(e, t, a, n, s, o, l)
                );
              }),
          ...
          var _ = function (e, t) {
            ...
            p = (r.getAllTweens = function (e) {
              return _(u.a._rootTimeline, e).concat(
                _(u.a._rootFramesTimeline, e)
              );
            });
          (r.killAll = function (e, t, r, n) {
            ...
            for (d = 0; d < a; d++)
              (_ = s[d]),
                (o ||
                  _ instanceof u.c ||
                  ((l = _.target === _.vars.onComplete) && r) ||
                  (t && !l)) &&
                  (e
                    ? _.totalTime(_._reversed ? 0 : _.totalDuration())
                    : _._enabled(!1, !1));
          }),
            (r.killChildTweensOf = function (t, _) {
              if (null != t) {
                var d = n.tweenLookup,
                  ...
                  i;
                if (
                  ("string" == typeof t && (t = u.f.selector(t) || t),
                  s(t) && (t = e(t)),
                  o(t))
                ) {
                ...
                for (c in ((m = []), d))
                  for (a = d[c].target.parentNode; a; )
                    a === t && (m = m.concat(d[c].tweens)), (a = a.parentNode);
                for (i = m.length, p = 0; p < i; p++)
                  _ && m[p].totalTime(m[p].totalDuration()),
                    m[p]._enabled(!1, !1);
              }
            });
          var d = function (e, t, r, n) {
            (t = !1 !== t), (r = !1 !== r), (n = !1 !== n);
            for (var s = p(n), a = t && r && n, o = s.length, i, l; -1 < --o; )
              (l = s[o]),
                (a ||
                  l instanceof u.c ||
                  ((i = l.target === l.vars.onComplete) && r) ||
                  (t && !i)) &&
                  l.paused(e);
          };
          return (
            ...
            (r.globalTimeScale = function (e) {
              ...
              return arguments.length
                ? ((e = e || i),
                  (a._startTime = r - ((r - a._startTime) * a._timeScale) / e),
                  (a = u.a._rootFramesTimeline),
                  (r = u.f.ticker.frame),
                  (a._startTime = r - ((r - a._startTime) * a._timeScale) / e),
                  (a._timeScale = u.a._rootTimeline._timeScale = e),
                  e)
                : a._timeScale;
            }),
            ...
            (a.duration = function (e) {
              return arguments.length
                ? u.a.prototype.duration.call(this, e)
                : this._duration;
            }),
      ...
      u.e._gsDefine(
        ...
        function () {
          ...
          var t = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
            ...
            U = function (e, t) {
              return N.createElementNS
                ? N.createElementNS(t || "http://www.w3.org/1999/xhtml", e)
                : N.createElement(e);
            },
            M = U("div"),
            V = U("img"),
            W = (g._internals = { _specialProps: c }),
            ...
            Z = (function () {
              ...
              return (
                ...
                (ve =
                  Te && 6 > parseFloat(G.substr(G.indexOf("Version/") + 8, 2))),
                (xe = -1 !== G.indexOf("Firefox")),
                (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(G) ||
                  /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(G)) &&
                  (be = parseFloat(RegExp.$1)),
                !!t) &&
              ...
              return Z || "opacity" !== t
                ? (!a && e.style[t]
                    ...
                    ? (n =
                        ...
                        i.getPropertyValue(t.replace(R, "-$1").toLowerCase()))
            ...
            te = (W.convertToPixels = function (e, t, i, a, r) {
              ...
              var n = z.test(t),
                ...
                d,
                m;
              if ((l && (i = -i), _ && (i *= 100), "lineHeight" === t && !a))
                (d = K(e).lineHeight),
                  (e.style.lineHeight = i),
                  (p = parseFloat(K(e).lineHeight)),
                  (e.style.lineHeight = d);
              else if ("%" === a && -1 !== t.indexOf("border"))
                p = (i / 100) * (n ? e.clientWidth : e.clientHeight);
              else {
                if (
                  ((o.cssText =
                  ...
                  if (
                    ((s = e.parentNode || N.body),
                    -1 !== ee(s, "display").indexOf("flex") &&
                      (o.position = "absolute"),
                    (d = s._gsCache),
                    (m = u.f.ticker.frame),
                    d && n && d.time === m)
                ...
                s.appendChild(M),
                  (p = parseFloat(M[n ? "offsetWidth" : "offsetHeight"])),
                  s.removeChild(M),
                  n &&
                    "%" == a &&
                    !1 !== g.cacheWidths &&
                    ((d = s._gsCache = s._gsCache || {}),
                    (d.time = m),
                    (d.width = 100 * (p / i))),
                  0 !== p || r || (p = te(e, t, i, a, !0));
              }
            ...
            ie = (W.calculateOffset = function (e, t, i) {
              ...
              return (
                e["offset" + a] -
                (te(e, t, parseFloat(r), r.replace(O, "")) || 0)
              );
            }),
            ae = function (e, t) {
              var a = {},
              ...
              if ((t = t || K(e, null))) {
                if ((r = t.length))
                  for (; -1 < --r; )
                    (n = t[r]),
                      (-1 === n.indexOf("-transform") || je === n) &&
                        (a[n.replace(C, D)] = t.getPropertyValue(n));
                else
                  for (r in t)
                ...
                "cssText" !== l &&
                  ...
                  ((n[l] =
                    "auto" === o && ("left" === l || "top" === l)
                      ...
                      ? 0
                      : o),
                  void 0 !== s[l] && (_ = new Re(s, l, s[l], _)));
              if (a) for (l in a) "className" !== l && (n[l] = a[l]);
              return { difs: n, firstMPT: _ };
            },
            ...
            oe = function (e, t, r) {
              ...
              var n = parseFloat(
                ...
                s = ne[t],
                a = s.length;
              for (r = r || K(e, null); -1 < --a; )
                (n -= parseFloat(ee(e, "padding" + s[a], r, !0)) || 0),
                  (n -=
                    parseFloat(ee(e, "border" + s[a] + "Width", r, !0)) || 0);
              return n;
            },
            le = function (e, t) {
              ...
              return (
                ...
                ("center" === a ||
                  ...
                  (a = "50%"),
                (e = a + " " + n + (2 < r.length ? " " + r[2] : "")),
                t &&
                  ((t.oxp = -1 !== a.indexOf("%")),
                  (t.oyp = -1 !== n.indexOf("%")),
                  (t.oxr = "=" === a.charAt(1)),
                  (t.oyr = "=" === n.charAt(1)),
                  (t.ox = parseFloat(a.replace(P, ""))),
                  (t.oy = parseFloat(n.replace(P, ""))),
                  (t.v = e)),
                t || e
              );
            },
            _e = function (t, i) {
              return (
                "function" == typeof t && (t = t(we, Pe)),
                "string" == typeof t && "=" === t.charAt(1)
                  ? parseInt(t.charAt(0) + "1", 10) * parseFloat(t.substr(2))
                  : parseFloat(t) - parseFloat(i) || 0
              );
            },
            pe = function (e, t) {
            ...
            ue = (g.parseColor = function (e, i) {
              ...
              if (!e) n = me.black;
                ...
                if (
                  ...
                  n = e.match(t) || me.transparent;
                else if (((n = d = e.match(t)), !i))
                  (m = (+n[0] % 360) / 360),
                    (c = +n[1] / 100),
                    (s = +n[2] / 100),
                    (r = 0.5 >= s ? s * (c + 1) : s + c - s * c),
                    (a = 2 * s - r),
                    3 < n.length && (n[3] = +n[3]),
                    (n[0] = ce(m + 1 / 3, a, r)),
                    (n[1] = ce(m, a, r)),
          ...
          for (e in me) fe += "|" + e + "\\b";
          (fe = new RegExp(fe + ")", "gi")),
            (g.colorStringFilter = function (e) {
              var t = e[0] + " " + e[1],
                i;
              fe.test(t) &&
                ((i = -1 !== t.indexOf("hsl(") || -1 !== t.indexOf("hsla(")),
                (e[0] = ge(e[0], i)),
                (e[1] = ge(e[1], i))),
                (fe.lastIndex = 0);
            }),
            u.f.defaultStringFilter ||
              (u.f.defaultStringFilter = g.colorStringFilter);
          var Oe = function (e, i, a, r) {
            ...
            Se = (W._setPluginRatio = function (e) {
              ...
              for (
                ...
                (s = a[r.v]),
                  r.r ? (s = r.r(s)) : s < n && s > -n && (s = 0),
                  (r.t[r.p] = s),
                  (r = r._next);
              if (
                (t.autoRotate &&
                  (t.autoRotate.rotation = t.mod
                    ? t.mod.call(this._tween, a.rotation, this.t, this._tween)
                    : a.rotation),
                1 === e || 0 === e)
              )
                for (r = t.firstMPT, _ = 1 === e ? "e" : "b"; r; ) {
                  if (((o = r.t), !o.type)) o[_] = o.s + o.xs0;
                    ...
                    for (i = o.xs0 + o.s + o.xs1, l = 1; l < o.l; l++)
                      i += o["xn" + l] + o["xs" + (l + 1)];
                    o[_] = i;
                  }
                  r = r._next;
                ...
                if (
                  ...
                  for (c = r.l; 0 < --c; )
                    (p = "xn" + c),
                      ...
                      (_[i] = r.data[p]),
                      (l[i] = r[p]),
                      s || (u = new Re(r, p, i, u, r.rxp[p]));
                r = r._next;
              }
              return { proxy: l, end: _, firstMPT: u, pt: g };
            }),
            Ae = (W.CSSPropTween = function (i, t, a, s, o, l, _, n, p, d, c) {
              (this.t = i),
                ...
                (this.c = s),
                (this.n = _ || t),
                i instanceof Ae || h.push(this.n),
                (this.r = n ? ("function" == typeof n ? n : m) : n),
                (this.type = l || 0),
                p && ((this.pr = p), (f = !0)),
                (this.b = void 0 === d ? a : d),
                (this.e = void 0 === c ? a + s : c),
            ...
            ze = (g.parseComplex = function (a, r, n, s, o, _, p, d, c, u) {
              (n = n || _ || ""),
                "function" == typeof s && (s = s(we, Pe)),
                (p = new Ae(a, r, 0, 0, p, u ? 2 : 1, null, !1, d, n, s)),
                (s += ""),
                o &&
                  fe.test(s + n) &&
                  ((s = [n, s]),
                  g.colorStringFilter(s),
                  (n = s[0]),
                  (s = s[1]));
              var f = n.split(", ").join(",").split(" "),
                ...
                D;
              for (
                (-1 !== s.indexOf(",") || -1 !== n.indexOf(",")) &&
                  (-1 !== (s + n).indexOf("rgb") ||
                  -1 !== (s + n).indexOf("hsl")
                    ? ((f = f.join(" ").replace(X, ", ").split(" ")),
                      (y = y.join(" ").replace(X, ", ").split(" ")))
                    : ((f = f.join(" ").split(",").join(", ").split(" ")),
                      (y = y.join(" ").split(",").join(", ").split(" "))),
                  (h = f.length)),
                  h !== y.length &&
                    ((f = (_ || "").split(" ")), (h = f.length)),
                  p.plugin = c,
                  p.setRatio = u,
                  fe.lastIndex = 0,
                  T = 0;
                ...
                if (
                  ...
                  (A = P.indexOf(")") + 1),
                    ...
                    (b = ue(b, D)),
                    (P = ue(P, D)),
                    (S = 6 < b.length + P.length),
                    S && !Z && 0 === P[3]
                      ? ((p["xs" + p.l] += p.l
                          ? " transparent"
                          : "transparent"),
                        (p.e = p.e.split(y[T]).join("transparent")))
                      : (!Z && (S = !1),
                        D
                          ? p
                              .appendXtra(
                                R.substr(0, R.indexOf("hsl")) +
                                  (S ? "hsla(" : "hsl("),
                                b[0],
                                _e(P[0], b[0]),
                                ",",
                    ...
                    (fe.lastIndex = 0);
                else if (((w = b.match(t)), !w))
                  p["xs" + p.l] += p.l || p["xs" + p.l] ? " " + P : P;
                else {
                  if (((O = P.match(x)), !O || O.length !== w.length)) return p;
                  for (v = 0, i = 0; i < w.length; i++)
                    (C = w[i]),
                      (R = b.indexOf(C, v)),
                      p.appendXtra(
                        b.substr(v, R - v),
              ...
              if (-1 !== s.indexOf("=") && p.data) {
                for (A = p.xs0 + p.data.s, T = 1; T < p.l; T++)
                  A += p["xs" + T] + p.data["xn" + T];
                p.e = A + p["xs" + T];
              }
              return p.l || ((p.type = -1), (p.xs0 = p.e)), p.xfirst || p;
            }),
            Ee = 9;
          for (e = Ae.prototype, e.l = e.pr = 0; 0 < --Ee; )
            (e["xn" + Ee] = 0), (e["xs" + Ee] = "");
          (e.xs0 = ""),
            (e._next =
              e._prev =
          ...
          var Le = function (e, t) {
              (t = t || {}),
                ...
                (this.format =
                  t.formatter ||
                  Oe(t.defaultValue, t.color, t.collapsible, t.multi)),
            ...
            i = (W._registerComplexSpecialProp = function (e, t, r) {
              "object" != typeof t && (t = { parser: r });
              var n = e.split(","),
                a = t.defaultValue,
                s,
                i;
              for (r = r || [a], s = 0; s < n.length; s++)
                (t.prefix = 0 === s && t.prefix),
                  (t.defaultValue = r[s] || a),
                  (i = new Le(n[s], t));
            }),
              ...
              if (!c[e]) {
                ...
                i(e, {
                  parser: function (i, t, e, n, s, o, l) {
                    ...
                    return _
                      ? (_._cssRegister(), c[e].parse(i, t, e, n, s, o, l))
                      : (q("Error: " + r + " js file not loaded."), s);
                  },
                });
              }
            });
          (e = Le.prototype),
            (e.parseComplex = function (a, t, r, e, n, s) {
              var o = this.keyword,
                _,
                i,
                p,
              ...
              if (
                ...
                for (
                  d = p.length > i.length ? p.length : i.length, _ = 0;
                  _ < d;
                  _++
                )
                  (t = i[_] = i[_] || this.dflt),
            ...
            (e.parse = function (i, t, e, a, r, n) {
              return this.parseComplex(
                i.style,
                this.format(ee(i, this.p, T, !1, this.dflt)),
                this.format(t),
                r,
                n
              );
          ...
          var Ie = [
            ...
            We = (function () {
              ...
              return (
                N.createElementNS &&
                  !e &&
                  ((t = Me("svg", Ve)),
                  (i = Me("rect", t, { width: 100, height: 50, x: 100 })),
                  (a = i.getBoundingClientRect().width),
                  (i.style[Ye] = "50% 50%"),
                  (i.style[Be] = "scaleX(0.5)"),
                  (e = a === i.getBoundingClientRect().width && !(xe && Fe)),
                  Ve.removeChild(t)),
                e
              );
            })(),
            Ge = function (t, e, i, r, n, s) {
              var o = t._gsTransform,
                ...
                P,
                w;
              o && ((P = o.xOrigin), (w = o.yOrigin)),
                (!r || 2 > (_ = r.split(" ")).length) &&
                  ((a = t.getBBox()),
                  0 === a.x &&
                    0 === a.y &&
                    0 === a.width + a.height &&
                  ...
                  (_ = [
                    (-1 === e[0].indexOf("%")
                      ? parseFloat(e[0])
                      : (parseFloat(e[0]) / 100) * a.width) + a.x,
                    (-1 === e[1].indexOf("%")
                      ? parseFloat(e[1])
                      : (parseFloat(e[1]) / 100) * a.height) + a.y,
                  ])),
                (i.xOrigin = u = parseFloat(_[0])),
                (i.yOrigin = f = parseFloat(_[1])),
                r &&
                  l !== $e &&
                  ((y = l[0]),
                  (a = l[1]),
                  ...
                  (v = y * T - a * h),
                  v &&
                    ((p = u * (T / v) + f * (-h / v) + (h * x - T * d) / v),
                    (m = u * (-a / v) + f * (y / v) - (y * x - a * d) / v),
                    (u = i.xOrigin = _[0] = p),
                    (f = i.yOrigin = _[1] = m))),
                o &&
                  (s &&
                    ((i.xOffset = o.xOffset), (i.yOffset = o.yOffset), (o = i)),
                  n || (!1 !== n && !1 !== g.defaultSmoothOrigin)
                    ? ((p = u - P),
                      (m = f - w),
                      (o.xOffset += p * l[0] + m * l[2] - p),
                      (o.yOffset += p * l[1] + m * l[3] - m))
                    : (o.xOffset = o.yOffset = 0)),
                s || t.setAttribute("data-svg-origin", _.join(" "));
            },
            Ze = function (e) {
              var t = U(
                  "svg",
            ...
            Qe = function (i, e) {
              ...
              if (
                (Be
                  ? (_ = ee(i, je, null, !0))
                  : i.currentStyle &&
                    ((_ = i.currentStyle.filter.match(E)),
                    (_ =
                      _ && 4 === _.length
                        ? [
                            _[0].substr(4),
                        ...
                        : "")),
                (l = !_ || "none" === _ || "matrix(1, 0, 0, 1, 0, 0)" === _),
                Be &&
                  ((m = !K(i) || "none" === K(i).display) || !i.parentNode) &&
                  (m && ((d = o.display), (o.display = "block")),
                  !i.parentNode && ((n = 1), Ve.appendChild(i)),
                  (_ = ee(i, je, null, !0)),
                  (l = !_ || "none" === _ || "matrix(1, 0, 0, 1, 0, 0)" === _),
                  d ? (o.display = d) : m && at(o, "display"),
                  n && Ve.removeChild(i)),
                (a.svg || (i.getCTM && qe(i))) &&
                  (l &&
                    -1 !== (o[Be] + "").indexOf("matrix") &&
                    ((_ = o[Be]), (l = 0)),
                  (p = i.getAttribute("transform")),
                  l &&
                    p &&
                    ((p = i.transform.baseVal.consolidate().matrix),
                    (_ =
                      "matrix(" +
                      p.a +
                      "," +
                ...
                return $e;
              for (p = (_ || "").match(t) || [], Ee = p.length; -1 < --Ee; )
                (d = +p[Ee]),
                  (p[Ee] = (n = d - (d |= 0))
                    ? (0 | (n * r + (0 > n ? -0.5 : 0.5))) / r + d
                    : d);
              return e && 6 < p.length
                ? [p[0], p[1], p[4], p[5], p[12], p[13]]
                : p;
            },
            Je = (W.getTransform = function (e, t, _, p) {
              ...
              var f = _ ? e._gsTransform || new Ne() : new Ne(),
                ...
                T = 1e5,
                x = Fe
                  ? parseFloat(ee(e, Ye, t, !1, "0 0 0").split(" ")[2]) ||
                    f.zOrigin ||
                    0
                  : 0,
              ...
              if (
                ...
                if (16 === P.length) {
                  ...
                  f.zOrigin &&
                    ...
                    V &&
                      ...
                      (I = Z)),
                    f.rotationX &&
                      359.9 < n(f.rotationX) + n(f.rotation) &&
                      ((f.rotationX = f.rotation = 0),
                      (f.rotationY = 180 - f.rotationY)),
                    (V = l(z, E)),
                    (f.scaleX = (0 | (r(R * R + C * C + A * A) * T + 0.5)) / T),
                    (f.scaleY = (0 | (r(E * E + L * L) * T + 0.5)) / T),
                    (f.scaleZ = (0 | (r(I * I + B * B + Y * Y) * T + 0.5)) / T),
                    (R /= f.scaleX),
                    (z /= f.scaleY),
                    (C /= f.scaleX),
                    (E /= f.scaleY),
                    n(V) > h
                      ? ((f.skewX = V * j),
                        (z = 0),
                        "simple" !== f.skewType && (f.scaleY *= 1 / o(V)))
                      : (f.skewX = 0),
                    ...
                    f.svg &&
                      ...
                      (f.y -= f.yOrigin - (f.yOrigin * C - f.xOrigin * E)));
                } else if (
                  !Fe ||
                  p ||
                  !P.length ||
                  ...
                  (f.x = P[4] || 0),
                    ...
                    (i = r(k * k + a * a)),
                    (w = r(c * c + b * b)),
                    (O = k || a ? l(a, k) * j : f.rotation || 0),
                    (S = b || c ? l(b, c) * j + O : f.skewX || 0),
                    (f.scaleX = i),
                    (f.scaleY = w),
                    (f.rotation = O),
                    (f.skewX = S),
                ...
                for (m in (90 < n(f.skewX) &&
                  270 > n(f.skewX) &&
                  (y
                    ? ((f.scaleX *= -1),
                      (f.skewX += 0 >= f.rotation ? 180 : -180),
                      (f.rotation += 0 >= f.rotation ? 180 : -180))
                    : ((f.scaleY *= -1),
                      (f.skewX += 0 >= f.skewX ? 180 : -180))),
                (f.zOrigin = x),
                f))
                  f[m] < h && f[m] > -h && (f[m] = 0);
              }
              return (
                _ &&
                  ...
                  f.svg &&
                    (tt && e.style[Be]
                      ? u.f.delayedCall(0.001, function () {
                          at(e.style, Be);
                        })
                      : !tt &&
            ...
            Ke = function (e) {
              ...
              if (f) {
                ...
                if (
                  (null != i.ox &&
                    ((R = (i.oxp ? 0.01 * (x * i.ox) : i.ox) - x / 2),
                    (C = (i.oyp ? 0.01 * (v * i.oy) : i.oy) - v / 2),
                    (w += R - (R * l + C * _)),
                    (S += C - (R * p + C * u))),
                  h
                    ? ((R = x / 2),
                  ...
                  (g.filter =
                    -1 === y.indexOf("DXImageTransform.Microsoft.Matrix(")
                      ? P + " " + y
                      : y.replace(L, P)),
                  (0 !== e && 1 !== e) ||
                    1 != l ||
                    ...
                    (k.test(y) && 100 !== parseFloat(RegExp.$1)) ||
                    -1 !== y.indexOf(y.indexOf("Alpha")) ||
                  ...
                  for (
                    R = i.ieOffsetX || 0,
                      C = i.ieOffsetY || 0,
                      i.ieOffsetX = m(
                        (x - ((0 > l ? -l : l) * x + (0 > _ ? -_ : _) * v)) /
                          2 +
                          w
                      ),
                      i.ieOffsetY = m(
                        (v - ((0 > u ? -u : u) * v + (0 > p ? -p : p) * x)) /
                          2 +
                          S
                      ),
                      Ee = 0;
                    ...
                    (z = se[Ee]),
                      ...
                      (T =
                        -1 === D.indexOf("px")
                          ? te(this.t, z, parseFloat(D), D.replace(O, "")) || 0
                          : parseFloat(D)),
                      (E =
                        T === i[z]
                          ? 2 > Ee
                ...
                function (e) {
                    ...
                    return void (n || x || f
                      ? ((n *= B),
                        ...
                        f &&
                          ((c +=
                            a.xOrigin -
                            (a.xOrigin * b + a.yOrigin * P) +
                            a.xOffset),
                          (u +=
                            a.yOrigin -
                            (a.xOrigin * O + a.yOrigin * k) +
                            a.yOffset),
                          tt &&
                            (a.xPercent || a.yPercent) &&
                            ((I = this.t.getBBox()),
                            (c += 0.01 * a.xPercent * I.width),
                            (u += 0.01 * a.yPercent * I.height)),
                          (I = 1e-6),
                          c < I && c > -I && (c = 0),
                          u < I && u > -I && (u = 0)),
                        (N =
                          ...
                          ")"),
                        f && tt
                          ? this.t.setAttribute("transform", "matrix(" + N)
                          : (t[Be] =
                              (a.xPercent || a.yPercent
                                ? "translate(" +
                                  a.xPercent +
                  ...
                  if (
                    (xe &&
                      ...
                      p < I && p > -I && (p = m = 2e-5),
                      d < I && d > -I && (d = m = 2e-5),
                      y && !a.z && !a.rotationX && !a.rotationY && (y = 0)),
                    n || x)
                  )
                    (n *= B),
                      (j = b = o(n)),
          ...
          (e = Ne.prototype),
              ...
              "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
              {
                parser: function (a, t, e, r, n, s, l) {
                  ...
                  var _ = l.scale && "function" == typeof l.scale ? l.scale : 0,
                    d;
                  "function" == typeof l[e] && ((d = l[e]), (l[e] = t)),
                    _ && (l.scale = _(we, a));
                  ...
                  if (
                    ((P.skewType =
                      i.skewType || P.skewType || g.defaultSkewType),
                    (r._transform = P),
                    "rotationZ" in i && (i.rotation = i.rotationZ),
                    w && "string" == typeof w && Be)
                  )
                    (k = M.style),
                      (k[Be] = w),
                      (k.display = "block"),
                      ...
                      -1 !== w.indexOf("%") &&
                        ((k.width = ee(a, "width")),
                        (k.height = ee(a, "height"))),
                      N.body.appendChild(M),
                      (O = Je(M, null, !1)),
                      "simple" === P.skewType && (O.scaleY *= o(O.skewX * B)),
                      P.svg &&
                        ((A = P.xOrigin),
                        (x = P.yOrigin),
                        (O.x -= P.xOffset),
                      ...
                      O.perspective || (O.perspective = P.perspective),
                      null != i.xPercent &&
                        (O.xPercent = pe(i.xPercent, P.xPercent)),
                      null != i.yPercent &&
                        (O.yPercent = pe(i.yPercent, P.yPercent));
                  else if ("object" == typeof i) {
                    if (
                      ((O = {
                        scaleX: pe(
                          null == i.scaleX ? i.scale : i.scaleX,
                          P.scaleX
                        ),
                        scaleY: pe(
                          null == i.scaleY ? i.scale : i.scaleY,
                          P.scaleY
                        ),
                      ...
                      (C = i.directionalRotation),
                      null != C)
                    )
                      if ("object" == typeof C) for (k in C) i[k] = C[k];
                      else i.rotation = C;
                    "string" == typeof i.x &&
                      -1 !== i.x.indexOf("%") &&
                      ((O.x = 0), (O.xPercent = pe(i.x, P.xPercent))),
                      "string" == typeof i.y &&
                        -1 !== i.y.indexOf("%") &&
                        ((O.y = 0), (O.yPercent = pe(i.y, P.yPercent))),
                      (O.rotation = de(
                        "rotation" in i
                          ? i.rotation
                          : "shortRotation" in i
                  ...
                  for (
                    Fe &&
                      ...
                      S =
                        ...
                        O.rotationY ||
                        O.perspective,
                      S || null == i.scale || (O.scaleZ = 1);
                    -1 < --f;

                  )
                    (D = Ie[f]),
                      (w = O[D] - P[D]),
                      (w > u || w < -u || null != i[D] || null != Y[D]) &&
                        ((R = !0),
                        (n = new Ae(P, D, P[D], w, n)),
                        D in h && (n.e = h[D]),
                        (n.xs0 = 0),
                        (n.plugin = s),
                  ...
                  return (
                    ...
                    P.svg &&
                      ...
                      ((A = P.xOffset),
                      (x = P.yOffset),
                      Ge(a, le(w), O, i.svgOrigin, i.smoothOrigin),
                      (n = De(
                        P,
                        "xOrigin",
                        (m ? P : O).xOrigin,
                    ...
                    (w || (Fe && S && P.zOrigin)) &&
                      (Be
                        ? ((R = !0),
                          (D = Ye),
                          (w = (w || ee(a, D, T, !1, "50% 50%")) + ""),
                          (n = new Ae(c, D, 0, 0, n, -1, b)),
                          (n.b = c[D]),
                          (n.plugin = s),
                          Fe
                            ? ((k = P.zOrigin),
                              (w = w.split(" ")),
                              (P.zOrigin =
                                (2 < w.length && (0 === k || "0px" !== w[2])
                                  ? parseFloat(w[2])
                                  : k) || 0),
                              (n.xs0 = n.e =
                                w[0] + " " + (w[1] || "50%") + " 0px"),
                              (n = new Ae(P, "zOrigin", 0, 0, n, -1, n.n)),
                              (n.b = k),
                              (n.xs0 = n.e = P.zOrigin))
                            : (n.xs0 = n.e = w))
                        : le(w + "", P)),
                    R &&
                      (r._transformType =
                        !(P.svg && tt) && (S || 3 === this._transformType)
                          ? 3
                          : 2),
                    d && (l[e] = d),
                    _ && (l.scale = _),
            ...
            i("borderRadius", {
              ...
              parser: function (a, t, e, r, n) {
                ...
                for (
                  ...
                  this.p.indexOf("border") && (s[_] = J(s[_])),
                    ...
                    v
                      ...
                      : ((u = parseFloat(m)), (h = m.substr((u + "").length))),
                    "" === h && (h = y[e] || x),
                    h !== x &&
              ...
              "borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRightRadius",
              {
                ...
                parser: function (i, t, e, a, r) {
                  return ze(
                    i.style,
                    e,
                    this.format(ee(i, e, T, !1, "0px 0px")),
                    this.format(t),
                    !1,
                    "0px",
                    r
              ...
              parser: function (a, t, e, r, n, s) {
                var o = "background-position",
                  ...
                  _ = this.format(
                    (l
                      ? be
                        ? l.getPropertyValue(o + "-x") +
                          " " +
                          l.getPropertyValue(o + "-y")
                        : l.getPropertyValue(o)
                  ...
                  for (
                    ...
                    (_ = d[c]),
                      ...
                      i !== (-1 !== m[c].indexOf("%")) &&
                        ((u =
                          0 === c
                            ? a.offsetWidth - V.width
                            : a.offsetHeight - V.height),
                        (d[c] = i
              ...
              parser: function (i, t, e, a, r, n) {
                ...
                return (
                  9 > be
                    ...
                    : ((s = this.format(ee(i, this.p, T, !1, this.dflt))),
                      (t = this.format(t))),
                  this.parseComplex(i.style, s, t, r, n)
                );
              },
            }),
            i("textShadow", {
            ...
            i("border", {
              ...
              parser: function (i, t, e, a, r, n) {
                ...
                return (
                  "px" !== l &&
                    (s = parseFloat(s) / te(i, "borderTopWidth", 1, l) + l),
                  this.parseComplex(
                    i.style,
                    this.format(
                      s +
                        " " +
                        ee(i, "borderTopStyle", T, !1, "solid") +
                        " " +
                        ee(i, "borderTopColor", T, !1, "#000")
                    ),
                    o.join(" "),
                    r,
                    n
          ...
          var it = function (e) {
            ...
            100 == a &&
              ...
              -1 === t.indexOf("radient(") &&
              -1 === t.indexOf("oader(")
                ? (i.removeAttribute("filter"), (r = !ee(this.data, "filter")))
                : ((i.filter = t.replace(S, "")), (r = !0))),
              r ||
                (this.xn1 && (i.filter = t = t || "alpha(opacity=" + a + ")"),
                -1 === t.indexOf("pacity")
                  ? (0 != a || !this.xn1) &&
          ...
          i("opacity,alpha,autoAlpha", {
            ...
            parser: function (i, t, a, r, n, s) {
              ...
              return (
                ...
                _ &&
                  1 === o &&
                  "hidden" === ee(i, "visibility", T) &&
                  0 !== t &&
                  (o = 0),
                Z
                  ? (n = new Ae(l, "opacity", o, t - o, n))
                  : ((n = new Ae(l, "opacity", 100 * o, 100 * (t - o), n)),
                    (n.xn1 = _ ? 1 : 0),
                    (l.zoom = 1),
                    (n.type = 2),
            ...
            rt = function (e) {
              if (((this.t._gsClassPT = this), 1 === e || 0 === e)) {
                ...
                for (var t = this.data, i = this.t.style; t; )
                  t.v ? (i[t.p] = t.v) : at(i, t.p), (t = t._next);
                1 == e &&
          ...
          i("className", {
            parser: function (i, t, e, a, r, n, s) {
              var o = i.getAttribute("class") || "",
                ...
                c;
              if (
                ((r = a._classNamePT = new Ae(i, e, 0, 0, r, 2)),
                (r.setRatio = rt),
                (r.pr = -11),
                (f = !0),
                (r.b = o),
              ...
              return (
                ...
                (r.data = _.firstMPT),
                (i.style.cssText = l),
                (r = r.xfirst = a.parse(i, _.difs, r, n)),
                r
              );
            },
          });
          var nt = function (e) {
            if (
              ...
              if ("all" === this.e) (t.cssText = ""), (i = !0);
                ...
                for (
                  n = this.e.split(" ").join("").split(","), s = n.length;
                  -1 < --s;
          ...
          (e = g.prototype),
            ...
            (e._onInitTween = function (e, t, i, a) {
              ...
              if (
                ...
                "string" == typeof t &&
                  ...
                  (r.cssText = l + ";" + t),
                  (n = re(e, n, ae(e)).difs),
                  !Z && w.test(t) && (n.opacity = parseFloat(RegExp.$1)),
                  (t = n),
                  (r.cssText = l)),
                (this._firstPT = t.className
                  ? (s = c.className.parse(
                      e,
                      t.className,
                      "className",
                ...
                for (
                  ...
                  o = o._next;
                (m = new Ae(e, "transform", 0, 0, null, 2)),
                  this._linkCSSP(m, null, o),
                  (m.setRatio = Be ? et : Ke),
                  (m.data = this._transform || Je(e, T, !0)),
                  (m.tween = i),
                  (m.pr = -1),
                  h.pop();
              }
              if (f) {
                for (; s; ) {
                  ...
                  (s._prev = o ? o._prev : _) ? (s._prev._next = s) : (l = s),
                    (s._next = o) ? (o._prev = s) : (_ = s),
                    (s = p);
                }
                this._firstPT = l;
              }
            ...
            (e.parse = function (e, t, i, a) {
              ...
              for (n in t) {
                if (
                  ((p = t[n]),
                  "function" == typeof p && (p = p(we, Pe)),
                  (s = c[n]),
                  s)
                )
                  i = s.parse(e, p, n, this, i, a, t);
                else if ("--" === n.substr(0, 2)) {
                  this._tween._propLookup[n] = this._addTween.call(
                    this._tween,
                    e.style,
                    "setProperty",
                    K(e).getPropertyValue(n) + "",
                    p + "",
                    n,
                    !1,
                    n
            ...
            (e.setRatio = function (e) {
              ...
              if (
                ...
                for (; t; ) {
                  ...
                  else if (((r = t.r(t.s + t.c)), !t.type))
                    t.t[t.p] = r + t.xs0;
                  else if (1 === t.type) {
                    for (s = t.l, n = t.xs0 + r + t.xs1, s = 1; s < t.l; s++)
                      n += t["xn" + s] + t["xs" + (s + 1)];
                    t.t[t.p] = n;
                  }
                  t = t._next;
                ...
                for (; t; ) {
                  if (
                    ...
                    for (n = t.xs0 + r + t.xs1, s = 1; s < t.l; s++)
                      n += t["xn" + s] + t["xs" + (s + 1)];
                    t.t[t.p] = n;
                  }
                  t = t._next;
                ...
                for (; t; )
                  2 === t.type ? t.setRatio(e) : (t.t[t.p] = t.b),
                    (t = t._next);
            }),
            (e._enableTransforms = function (e) {
              (this._transform = this._transform || Je(this._target, T, !0)),
                (this._transformType =
              ...
              return (
                e &&
                  ...
                  e._prev
                    ? (e._prev._next = e._next)
                    : this._firstPT === e &&
                      ((this._firstPT = e._next), (a = !0)),
                  i
                    ? (i._next = e)
                    : !a && null === this._firstPT && (this._firstPT = e),
                  (e._next = t),
                  (e._prev = i)),
                e
              );
          ...
          var ot = function (t, e, a) {
            ...
            for (r = t.childNodes, n = r.length; -1 < --n; )
              (i = r[n]),
                (s = i.type),
                i.style && (e.push(ae(i)), a && a.push(i)),
                (1 === s || 9 === s || 11 === s) &&
                  i.childNodes.length &&
                  ot(i, e, a);
          };
          return (
            (g.cascadeTo = function (t, a, r) {
              var n = u.f.to(t, a, r),
                s = [n],
                o = [],
                l = [],
       ...
       **/ (x._onInitAllProps = function () {
        var e = this._tween,
          ...
          o,
          i;
        if ("object" == typeof t && !t.push) for (i in t) a[i] = h(t[i]);
        else
          for (
            "string" == typeof t && (t = t.split(",")), o = t.length;
            -1 < --o;
            ...
            (s = n._next),
              n.pg
                ...
                : n.n === i &&
                  (2 === n.f && n.t
                    ? T(n.t._firstPT, a[i])
                    : (this._add(n.t, i, n.s, n.c, a[i]),
                      s && (s._prev = n._prev),
                      n._prev
                        ? (n._prev._next = s)
                        : e._firstPT === n && (e._firstPT = s),
        ...
        (x._add = function (e, t, i, a, r) {
          this._addTween(e, t, i, i + a, t, r || m),
            ...
            "useRadians" !== s &&
              ...
              (_ = this.finals[s] =
                "string" == typeof o && "=" === o.charAt(1)
                  ? l + parseInt(o.charAt(0) + "1", 10) * +o.substr(2)
                  : +o || 0),
              (p = _ - l),
              m.length &&
                ((o = m.join("_")),
                -1 !== o.indexOf("short") &&
                  ((p %= r), p !== p % (r / 2) && (p = 0 > p ? p + r : p - r)),
                -1 !== o.indexOf("_cw") && 0 > p
                  ? (p = ((p + 9999999999 * r) % r) - (0 | (p / r)) * r)
                  : -1 !== o.indexOf("ccw") &&
                    0 < p &&
                    (p = ((p - 9999999999 * r) % r) - (0 | (p / r)) * r)),
              (p > n || p < -n) &&
                (this._addTween(e, s, l, l + p, s),
            ...
            return (
              ...
              (y.staggerTo = function (t, a, n, s, o, l, _, p) {
                ...
                for (
                  ...
                  (y = m(n)),
                    y.startAt &&
                      ((y.startAt = m(y.startAt)),
                      y.startAt.cycle && c(y.startAt, t, h)),
                    g &&
                      (c(y, t, h),
                      null != y.duration &&
                        ((a = y.duration), delete y.duration)),
                    d.to(t[h], a, y, h * s);
                return this.add(d, o);
              }),
              (y.staggerFrom = function (e, t, i, a, r, n, s, o) {
                return (
                  (i.immediateRender = !1 != i.immediateRender),
                  (i.runBackwards = !0),
                  this.staggerTo(e, t, i, a, r, n, s, o)
                );
              }),
              (y.staggerFromTo = function (e, t, i, a, r, n, s, o, l) {
                return (
                  ...
                  (a.immediateRender =
                    !1 != a.immediateRender && !1 != i.immediateRender),
                  this.staggerTo(e, t, a, r, n, s, o, l)
                );
              }),
              ...
              (e.exportRoot = function (t, i) {
                ...
                for (
                  null == i && (i = !0),
                    r._remove(a, !0),
                    a._startTime = 0,
                    a._rawPrevTime = a._time = a._totalTime = r._time,
                    o = r._first;
                  o;

                )
                  (l = o._next),
                    (i && o instanceof u.f && o.target === o.vars.onComplete) ||
              ...
              (y.add = function (t, a, r, o) {
                ...
                if (
                  ("number" != typeof a &&
                    (a = this._parseTimeOrLabel(a, 0, !0, t)),
                  !(t instanceof u.a))
                ) {
                  if (t instanceof Array || (t && t.push && s(t))) {
                    for (
                      r = r || "normal", o = o || 0, d = a, m = t.length, l = 0;
                      l < m;
                      l++
                    )
                      s((i = t[l])) && (i = new e({ tweens: i })),
                        this.add(i, d),
                        "string" != typeof i &&
                          "function" != typeof i &&
                          ("sequence" === r
                            ? (d =
                                i._startTime + i.totalDuration() / i._timeScale)
                            : "start" === r && (i._startTime -= i.delay())),
                        (d += o);
                ...
                if (
                  (u.c.prototype.add.call(this, t, a),
                  t._time &&
                    ((d = _(
                      0,
                      p(
                    ...
                    1e-5 < n(d - t._totalTime) && t.render(d, !1, !1)),
                  (this._gc || this._time === this._duration) &&
                    !this._paused &&
                    this._duration < this.duration())
                )
                  for (c = this, g = c.rawTime() > t._startTime; c._timeline; )
                    g && c._timeline.smoothChildTiming
              ...
              (y.addPause = function (e, i, a, r) {
                ...
                return (
                  (n.vars.onComplete = n.vars.onReverseComplete = i),
                  (n.data = "isPause"),
                  (this._hasPause = !0),
                  this.add(n, e)
                );
              ...
              (y._parseTimeOrLabel = function (e, t, a, r) {
                ...
                if (
                  ...
                  return this._parseTimeOrLabel(
                    t,
                    a && "number" == typeof e && null == this._labels[t]
                      ? e - n
                      : 0,
                    a
                  );
                  ...
                  if (((o = e.indexOf("=")), -1 === o))
                    return null == this._labels[e]
                      ? a
                        ...
                        : t
                      : this._labels[e] + t;
                  (t = parseInt(e.charAt(o - 1) + "1", 10) * +e.substr(o + 1)),
                    (e =
                      1 < o
                        ? this._parseTimeOrLabel(e.substr(0, o - 1), 0, a)
                        : n);
                } else null == e && (e = n);
                return +e + t;
              }),
              ...
              (y.render = function (e, i, a) {
                ...
                if (
                  ...
                  (this._totalTime = this._time = n),
                    this._reversed ||
                      ...
                      0 === this._duration &&
                        ...
                        this._first &&
                        ((g = !0),
                        this._rawPrevTime > t && (u = "onReverseComplete"))),
                    (this._rawPrevTime =
                      this._duration || !i || e || this._rawPrevTime === e
                        ? e
                        : t),
                    (e = n + 1e-4);
                else if (!(1e-7 > e)) {
                  if (this._hasPause && !this._forcingPlayhead && !i) {
                    if (e >= r)
                      for (d = this._first; d && d._startTime <= e && !f; )
                        d._duration ||
                          "isPause" !== d.data ||
                          d.ratio ||
                      ...
                      for (d = this._last; d && d._startTime >= e && !f; )
                        !d._duration &&
                          "isPause" === d.data &&
                          0 < d._rawPrevTime &&
                          (f = d),
                  ...
                  (0 !== r ||
                    (0 === this._duration &&
                      this._rawPrevTime !== t &&
                      (0 < this._rawPrevTime ||
                        (0 > e && 0 <= this._rawPrevTime)))) &&
                    ((u = "onReverseComplete"), (m = this._reversed)),
                  0 > e)
                )
                  (this._active = !1),
                    this._timeline.autoRemoveChildren && this._reversed
                      ? ((g = m = !0), (u = "onReverseComplete"))
                      : 0 <= this._rawPrevTime && this._first && (g = !0),
                    (this._rawPrevTime = e);
                else {
                  if (
                    ((this._rawPrevTime =
                ...
                if ((this._time !== r && this._first) || a || g || f) {
                  if (
                    ...
                    for (
                      d = this._first;
                      d &&
                      ((c = d._next), y === this._time && (!this._paused || p));

                    )
                      (d._active ||
                        (d._startTime <= y && !d._paused && !d._gc)) &&
                        (f === d && this.pause(),
                        d._reversed
                          ? d.render(
                              (d._dirty
                          ...
                          : d.render((e - d._startTime) * d._timeScale, i, a)),
                        (d = c);
                  else
                    for (
                      d = this._last;
                      d &&
                      ((c = d._prev), y === this._time && (!this._paused || p));

                    ) {
                      if (
                        d._active ||
                        (d._startTime <= r && !d._paused && !d._gc)
                      ) {
                        if (f === d) {
                          for (f = d._prev; f && f.endTime() > this._time; )
                            f.render(
                              f._reversed
                                ? f.totalDuration() -
                  ...
                  this._onUpdate &&
                    !i &&
                    (o.length && l(), this._callback("onUpdate")),
                    u &&
                      !this._gc &&
                      (s === this._startTime || _ !== this._timeScale) &&
                      ...
                      (m &&
                        ...
                        this._timeline.autoRemoveChildren &&
                          this._enabled(!1, !1),
                        (this._active = !1)),
                      !i && this.vars[u] && this._callback(u));
                }
              }),
                ...
                for (var n = [], a = this._first, s = 0; a; )
                  a._startTime < r ||
                    (a instanceof u.f
                      ...
                      : (!1 !== i && (n[s++] = a),
                        !1 !== e &&
                          ((n = n.concat(a.getChildren(!0, t, i))),
                          (s = n.length)))),
                    (a = a._next);
                return n;
              }),
              (y.getTweensOf = function (e, t) {
                ...
                for (
                  ...
                  (s[o].timeline === this || (t && this._contains(s[o]))) &&
                    (n[a++] = s[o]);
              ...
              (y.shiftChildren = function (e, t, i) {
                i = i || 0;
                for (var a = this._first, r = this._labels, n; a; )
              ...
              (y.clear = function (e) {
                var t = this.getChildren(!1, !0, !0),
                  a = t.length;
                for (this._time = this._totalTime = 0; -1 < --a; )
                  t[a]._enabled(!1, !1);
              ...
              (y.totalDuration = function (e) {
                if (!arguments.length) {
                  if (this._dirty) {
                    for (var t = 0, i = this._last, a = 999999999999, r, n; i; )
                      (r = i._prev),
          ...
          return (
            ...
            (l.removeCallback = function (e, t) {
              if (e)
                if (null == t) this._kill(null, e);
                  ...
                  for (
                    var r = this.getTweensOf(e, !1),
                      a = r.length,
                      i = this._parseTimeOrLabel(t);
                    -1 < --a;

                  )
                    r[a]._startTime === i && r[a]._enabled(!1, !1);
              return this;
            }),
            ...
            (l.tweenTo = function (e, i) {
              ...
              return (
                ...
                (l = n(+a.time - this._time) / this._timeScale || 0.001),
                (p = new r(this, l, a)),
                (a.onStart = function () {
                  p.target.paused(!0),
                    p.vars.time === p.target.time() ||
                      l !== p.duration() ||
                      p.isFromTo ||
                      p
                        .duration(
                          n(p.vars.time - p.target.time()) / p.target._timeScale
                        )
                        .render(p.time(), !0, !0),
                    i.onStart &&
                      i.onStart.apply(
                        i.onStartScope || i.callbackScope || p,
                        i.onStartParams || []
                      );
                }),
                p
            ...
            (l.tweenFromTo = function (e, i, a) {
              ...
              return (
                (r.isFromTo = 1),
                r.duration(n(r.vars.time - e) / this._timeScale || 0.001)
              );
            }),
            (l.render = function (e, i, n) {
              ...
              if (
                ...
                this._locked ||
                  ...
                  this._reversed ||
                    ...
                    ((f = !0),
                    (h = "onComplete"),
                    (T = !!this._timeline.autoRemoveChildren),
                    0 === this._duration &&
                      ((0 >= e && -1e-7 <= e) || 0 > m || m === t) &&
                      m !== e &&
                      this._first &&
                      ((T = !0), m > t && (h = "onReverseComplete"))),
                  (this._rawPrevTime =
                    this._duration || !i || e || this._rawPrevTime === e
                      ? e
                      : t),
                ...
                if (
                  ...
                  (this._active = !1),
                    this._timeline.autoRemoveChildren && this._reversed
                      ? ((T = f = !0), (h = "onReverseComplete"))
                      : 0 <= m && this._first && (T = !0),
                    (this._rawPrevTime = e);
                else {
                  if (
                    ((this._rawPrevTime =
                      l || !i || e || this._rawPrevTime === e ? e : t),
                    0 === e && f)
                  )
                    for (g = this._first; g && 0 === g._startTime; )
                      g._duration || (f = !1), (g = g._next);
                ...
                this._locked ||
                  ((this._totalTime = e),
                  0 !== this._repeat &&
                    ((x = l + this._repeatDelay),
                    (this._cycle = (this._totalTime / x) >> 0),
                    0 !== this._cycle &&
                      this._cycle === this._totalTime / x &&
                      _ <= e &&
                      this._cycle--,
                    (this._time = this._totalTime - this._cycle * x),
                    this._yoyo &&
                      0 != (1 & this._cycle) &&
                      (this._time = l - this._time),
                    this._time > l
                      ? ((this._time = l), (e = l + 1e-4))
                      : 0 > this._time
                      ? (this._time = e = 0)
                      : (e = this._time))),
                this._hasPause && !this._forcingPlayhead && !i)
              ) {
                if (
                  ((e = this._time),
                  e >= s || (this._repeat && u !== this._cycle))
                )
                  for (g = this._first; g && g._startTime <= e && !v; )
                    g._duration ||
                      "isPause" !== g.data ||
                      g.ratio ||
                      (0 === g._startTime && 0 === this._rawPrevTime) ||
                      (v = g),
                      (g = g._next);
                else
                  for (g = this._last; g && g._startTime >= e && !v; )
                    !g._duration &&
                      "isPause" === g.data &&
                      0 < g._rawPrevTime &&
                      (v = g),
              ...
              if (this._cycle !== u && !this._locked) {
                ...
                if (
                  ((this._totalTime = u * l),
                  this._cycle < u ? (P = !P) : (this._totalTime += l),
                  (this._time = s),
                  (this._rawPrevTime = 0 === l ? m - 1e-4 : m),
                  (this._cycle = u),
                  (this._locked = !0),
                  (s = P ? 0 : l),
                  this.render(s, i, 0 === l),
              ...
              if ((this._time === s || !this._first) && !n && !T && !v)
                return void (
                  _ !== this._totalTime &&
                  this._onUpdate &&
                  !i &&
              ...
              if (
                ...
                for (
                  g = this._first;
                  g &&
                  ((y = g._next), b === this._time && (!this._paused || c));

                )
                  (g._active ||
                    (g._startTime <= this._time && !g._paused && !g._gc)) &&
                    (v === g && this.pause(),
                    g._reversed
                      ? g.render(
                          (g._dirty ? g.totalDuration() : g._totalDuration) -
                            (e - g._startTime) * g._timeScale,
                          i,
                          n
                        )
                      : g.render((e - g._startTime) * g._timeScale, i, n)),
                    (g = y);
              else
                for (
                  g = this._last;
                  g &&
                  ((y = g._prev), b === this._time && (!this._paused || c));

                ) {
                  if (
                    g._active ||
                    (g._startTime <= s && !g._paused && !g._gc)
                  ) {
                    if (v === g) {
                      for (v = g._prev; v && v.endTime() > this._time; )
                        v.render(
                          v._reversed
                            ? v.totalDuration() -
                                (e - v._startTime) * v._timeScale
                            : (e - v._startTime) * v._timeScale,
                          i,
                          n
                        ),
              ...
              this._onUpdate &&
                !i &&
                (a.length && r(), this._callback("onUpdate")),
                h &&
                  !this._locked &&
                  !this._gc &&
                  ...
                  (f &&
                    ...
                    this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                    (this._active = !1)),
                  !i && this.vars[h] && this._callback(h));
            }),
            ...
            (l.getLabelAfter = function (e) {
              ...
              var t = this.getLabelsArray(),
                a = t.length,
                r;
              for (r = 0; r < a; r++) if (t[r].time > e) return t[r].name;
              return null;
            }),
            ...
            (l.getLabelsArray = function () {
              ...
              for (i in this._labels)
                e[t++] = { time: this._labels[i], name: i };
              return (
                e.sort(function (e, t) {
            ...
            (l.totalDuration = function (e) {
              return arguments.length
                ? -1 !== this._repeat && e
                  ...
                  : this
                : (this._dirty &&
                    (b.prototype.totalDuration.call(this),
                    (this._totalDuration =
                      -1 === this._repeat
                        ? 999999999999
                        : this._duration * (this._repeat + 1) +
      ...
      var P = u.g.TimelineMax,
          ...
          for (_ = 0; _ < s; _++)
            (m = e[o]),
              ...
              n
                ? ((h = w[_]),
                  (T = O[_]),
                  (x = (0.25 * ((T + h) * t)) / (r ? 0.5 : k[_] || 0.5)),
                  (c = p - (p - i) * (r ? 0.5 * t : 0 === h ? 0 : x / h)),
                  (u = p + (d - p) * (r ? 0.5 * t : 0 === T ? 0 : x / T)),
                  (g =
                    p - (c + (((u - c) * ((3 * h) / (h + T) + 0.5)) / 4 || 0))))
                : ((c = p - 0.5 * ((p - i) * t)),
                  (u = p + 0.5 * ((d - p) * t)),
                  (g = p - (c + u) / 2)),
              (c += g),
              (u += g),
              (m.c = f = c),
              (m.b = 0 === _ ? (l = m.a + 0.6 * (m.c - m.a)) : l),
              (m.da = p - i),
              (m.ca = f - i),
              (m.ba = l - i),
              a
                ? ((y = A(i, l, f, p)),
                  e.splice(o, 1, y[0], y[1], y[2], y[3]),
                  (o += 4))
                : o++,
              (l = u);
          (m = e[o]),
        ...
        z = function (e, t, r, n) {
          var s = [],
            ...
            p;
          if (n)
            for (e = [n].concat(e), o = e.length; -1 < --o; )
              "string" == typeof (p = e[o][t]) &&
                "=" === p.charAt(1) &&
                (e[o][t] = n[t] + +(p.charAt(0) + p.substr(2)));
          if (((a = e.length - 2), 0 > a))
            return (s[0] = new C(e[0][t], 0, 0, e[0][t])), s;
          for (o = 0; o < a; o++)
            (i = e[o][t]),
              (l = e[o + 1][t]),
              (s[o] = new C(i, 0, 0, l)),
        ...
        E = function (e, t, s, o, _, d) {
          ...
          for (w.length = O.length = k.length = 0, g = c.length; -1 < --g; )
            (i = c[g]),
              (S[i] = -1 !== _.indexOf("," + i + ",")),
              (m[i] = z(e, i, S[i], d));
          ...
          if (!o) {
            for (g = c.length; -1 < --g; )
              if (S[i])
                for (p = m[c[g]], y = p.length - 1, a = 0; a < y; a++)
                  (f = p[a + 1].da / O[a] + p[a].da / w[a] || 0),
                    (k[a] = (k[a] || 0) + f * f);
            for (g = k.length; -1 < --g; ) k[g] = r(k[g]);
          }
          for (g = c.length, a = s ? 4 : 1; -1 < --g; )
            (i = c[g]),
              (p = m[i]),
              D(p, t, s, o, S[i]),
              l && (p.splice(0, a), p.splice(p.length - a, a));
          return m;
        },
        L = function (e, t, r) {
          t = t || "soft";
          var n = {},
            ...
            p,
            y;
          if ((o && r && (e = [r].concat(e)), null == e || e.length < s + 1))
            throw "invalid Bezier data";
          for (l in e[0]) _.push(l);
          for (g = _.length; -1 < --g; ) {
            for (
              l = _[g], n[l] = d = [], p = 0, f = e.length, i = 0;
              i < f;
              i++
            )
              (m =
                null == r
                  ? e[i][l]
                  : "string" == typeof (y = e[i][l]) && "=" === y.charAt(1)
                  ? r[l] + +(y.charAt(0) + y.substr(2))
                  : +y),
                o && 1 < i && i < f - 1 && (d[p++] = (m + d[p - 2]) / 2),
                (d[p++] = m);
            for (f = p - s + 1, p = 0, i = 0; i < f; i += s)
              (m = d[i]),
                (a = d[i + 1]),
                (u = d[i + 2]),
                (c = 2 == s ? 0 : d[i + 3]),
          ...
          for (i = n.length, p = 0; p < i; p++)
            (s += r(n[p])),
              ...
              l === _ &&
                ...
                (s = 0),
                (m = []));
          return { length: o, lengths: a, segments: d };
        },
          ...
          init: function (e, t, a) {
            ...
            for (p = this._props.length; -1 < --p; )
              (l = this._props[p]),
                ...
                (_ = this._func[l] = "function" == typeof e[l]),
                (n[l] = _
                  ? e[
                      l.indexOf("set") ||
                      "function" != typeof e["get" + l.substr(3)]
                        ? l
                        : "get" + l.substr(3)
                    ]()
                  : parseFloat(e[l])),
          ...
          set: function (e) {
            ...
            if (!this._timeRes)
              ...
              if (
                ...
                (e -= this._l1),
                (m = this._si),
                e > this._s2 && m < f.length - 1)
              ) {
                for (u = f.length - 1; m < u && (this._s2 = f[++m]) <= e; );
                (this._s1 = f[m - 1]), (this._si = m);
              } else if (e < this._s1 && 0 < m) {
                for (; 0 < m && (this._s1 = f[--m]) >= e; );
                0 === m && e < this._s1 ? (this._s1 = 0) : m++,
                  (this._s2 = f[m]),
                  (this._si = m);
              }
              c =
                (m + (e - this._s1) / (this._s2 - this._s1)) * this._prec || 0;
            }
            for (_ = 1 - c, m = this._props.length; -1 < --m; )
              (i = this._props[m]),
                (p = this._beziers[i][o]),
                (t = (c * c * p.da + 3 * _ * (c * p.ca + _ * p.ba)) * c + p.a),
                this._mod[i] && (t = this._mod[i](t, n)),
                r[i] ? n[i](t) : (n[i] = t);
            if (this._autoRotate) {
              ...
              for (m = y.length; -1 < --m; )
                (i = y[m][2]),
                  (P = y[m][3] || 0),
                  (w = !0 === y[m][4] ? 1 : 180 / d),
                  (p = this._beziers[y[m][0]]),
                  (h = this._beziers[y[m][1]]),
                  p &&
                    h &&
                    ((p = p[o]),
                    (h = h[o]),
       ...
       * @author: Jack Doyle, jack@greensock.com
       **/ (B.bezierThrough = E),
        (B.cubicToQuadratic = A),
        (B._autoCSS = !0),
        (B.quadraticToCubic = function (e, t, i) {
          ...
          if (e) {
            ...
            t._registerComplexSpecialProp("bezier", {
              parser: function (s, t, o, _, d, m) {
                t instanceof Array && (t = { values: t }), (m = new B());
                var c = t.values,
                  u = c.length - 1,
                  l = [],
                  g = {},
                ...
                if (0 > u) return d;
                for (f = 0; f <= u; f++)
                  (p = a(s, c[f], _, d, m, u !== f)), (l[f] = p.end);
                for (i in t) g[i] = t[i];
                return (
                  (g.values = l),
                  (d = new n(s, "bezier", 0, 0, p.pt, 2)),
                  (d.data = p),
                  (d.plugin = m),
                  (d.setRatio = r),
                  ...
                  g.autoRotate &&
                    ...
                    ((f = !0 === g.autoRotate ? 0 : +g.autoRotate),
                    (g.autoRotate =
                      null == p.end.left
                        ? null != p.end.x && [["x", "y", "rotation", f, !1]]
                        : [["left", "top", "rotation", f, !1]])),
                  g.autoRotate &&
                    (!_._transform && _._enableTransforms(!1),
                    (p.autoRotate = _._target._gsTransform),
                    (p.proxy.rotation = p.autoRotate.rotation || 0),
                    _._overwriteProps.push("rotation")),
                  m._onInitTween(p.proxy, g, _._tween),
                  d
                );
              },
            });
        ...
        (j._mod = function (e) {
          for (var t = this._overwriteProps, a = t.length, i; -1 < --a; )
            (i = e[t[a]]), i && "function" == typeof i && (this._mod[t[a]] = i);
        }),
        (j._kill = function (e) {
          var t = this._props,
            a,
          ...
          for (a in this._beziers)
            if (a in e)
              for (
                delete this._beziers[a], delete this._func[a], r = t.length;
                -1 < --r;
          ...
          function () {
            var e = u.e.GreenSockGlobals || u.e,
              ...
              c = function (e, t, i, a) {
                var r = l(
                  "easing." + e,
                  { easeOut: new t(), easeIn: new i(), easeInOut: new a() },
                  !0
                );
                return m(r, e), r;
              },
            ...
            return (
              ...
              (T = p.prototype = new u.b()),
              (T.constructor = p),
              (T.getRatio = function (e) {
                return (
                  0 > e ? (e = 0) : 1 <= e && (e = 0.999999999),
                  ((0 | (this._p2 * e)) + this._p3) * this._p1
                );
              }),
              (T.config = p.config =
                function (e, t) {
                ...
                function (e) {
                  ...
                  for (
                    var t = e.taper || "none",
                      ...
                      i = !1 !== e.randomize,
                      o = !0 === e.clamp,
                      l = e.template instanceof u.b ? e.template : null,
                      _ =
                  ...
                  for (
                    ...
                    (f = r[s]), (h = new g(f.x, f.y, h));
                  this._prev = new g(0, 0, 0 === h.t ? h.next : h);
                },
                !0
              )),
              (T = v.prototype = new u.b()),
              (T.constructor = v),
              (T.getRatio = function (e) {
                var t = this._prev;
                if (e > t.t) {
                ...
                var r = l(
                    ...
                    function (e, t) {
                      (this._p1 = 1 <= e ? e : 1),
                        ...
                        (this._p3 =
                          (this._p2 / i) * (Math.asin(1 / this._p1) || 0)),
                        (this._p2 = i / this._p2);
                    },
                    !0
                  ),
              ...
              c(
                ...
                b(
                  ...
                  function (e) {
                    return (
                      this._p1 * a(2, -10 * e) * s((e - this._p3) * this._p2) +
                      1
                    );
                  },
                  0.3
              ...
              c(
                "Expo",
                _("ExpoOut", function (e) {
                  return 1 - a(2, -10 * e);
                }),
                _("ExpoIn", function (e) {
                  return a(2, 10 * (e - 1)) - 0.001;
                }),
              ...
              m(e.SlowMo, "SlowMo", "ease,"),
              m(v, "RoughEase", "ease,"),
              m(p, "SteppedEase", "ease,"),
              y
            );
          },
          !0

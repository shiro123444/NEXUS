(function (a) {
  function b(b) {
    for (
      var d, e, f = b[0], g = b[1], h = b[2], j = 0, k = [];
      j < f.length;
      j++
    )
      (e = f[j]), K[e] && k.push(K[e][0]), (K[e] = 0);
  ...
  function c() {
    for (var a, b = 0; b < L.length; b++) {
      for (var c, d = L[b], e = !0, f = 1; f < d.length; f++)
        (c = d[f]), 0 !== K[c] && (e = !1);
  ...
  function g(a) {
    ...
    var c = function (c) {
        return (
          b.hot.active
            ? (J[c]
                ? -1 === J[c].parents.indexOf(a) && J[c].parents.push(a)
                : ((A = [a]), (s = c)),
              -1 === b.children.indexOf(c) && b.children.push(c))
            : (console.warn(
  ...
  function m(a, b) {
    if (I[a] && H[a]) {
      for (var c in ((H[a] = !1), b))
        Object.prototype.hasOwnProperty.call(b, c) && (u[c] = b[c]);
      0 == --E && 0 === F && o();
    }
  }
  function n(a) {
  ...
  function o() {
    ...
    if (((t = null), !!a))
      if (w)
        ...
        var b = [];
        for (var c in u)
          Object.prototype.hasOwnProperty.call(u, c) && b.push(j(c));
        a.resolve(b);
      }
  }
  function p(b) {
    function c(a) {
      for (
        ...
        if (((l = J[g]), l && !l.hot._selfAccepted)) {
          ...
          if (l.hot._main) return { type: "unaccepted", chain: h, moduleId: g };
          for (var j = 0; j < l.parents.length; j++) {
            var i = l.parents[j],
              k = J[i];
            if (k) {
              if (k.hot._declinedDependencies[g])
                return {
                  type: "declined",
                  chain: h.concat([i]),
                  moduleId: g,
    ...
    for (var r in u)
      if (Object.prototype.hasOwnProperty.call(u, r)) {
        i = j(r);
        var s = u[r] ? c(i) : { type: "disposed", moduleId: r };
        var t = !1,
          w = !1,
          y = !1,
          B = "";
        switch (
          ...
          case "self-declined":
            b.onDeclined && b.onDeclined(s),
              b.ignoreDeclined ||
                (t = new Error(
                  "Aborted because of self decline: " + s.moduleId + B
                ));
            break;
          case "declined":
            b.onDeclined && b.onDeclined(s),
            ...
            break;
          case "unaccepted":
            b.onUnaccepted && b.onUnaccepted(s),
              b.ignoreUnaccepted ||
                (t = new Error(
                  "Aborted because " + i + " is not accepted" + B
                ));
            break;
          case "accepted":
        ...
        if (w)
          for (i in ((o[i] = u[i]),
          e(n, s.outdatedModules),
          s.outdatedDependencies))
            Object.prototype.hasOwnProperty.call(s.outdatedDependencies, i) &&
              (m[i] || (m[i] = []), e(m[i], s.outdatedDependencies[i]));
    ...
    for (g = 0; g < n.length; g++)
      (i = n[g]),
        J[i] &&
          J[i].hot._selfAccepted &&
          C.push({ module: i, errorHandler: J[i].hot._selfAccepted });
    k("dispose"),
    ...
    for (var E, F = n.slice(); 0 < F.length; )
      if (((i = F.pop()), (l = J[i]), l)) {
        ...
        for (
          z[i] = G, l.hot.active = !1, delete J[i], delete m[i], h = 0;
          h < l.children.length;
          h++
        ) {
    ...
    for (i in m)
      if (Object.prototype.hasOwnProperty.call(m, i) && ((l = J[i]), l))
        for (M = m[i], h = 0; h < M.length; h++)
          (L = M[h]),
            (E = l.children.indexOf(L)),
            0 <= E && l.children.splice(E, 1);
    for (i in (k("apply"), (x = v), o))
        ...
        if ("function" == typeof P.errorHandler)
          try {
            ...
            b.onErrored &&
              ...
              b.ignoreErrored || N || (N = c),
              N || (N = a);
          }
        else
          b.onErrored &&
            b.onErrored({ type: "self-accept-errored", moduleId: i, error: a }),
            b.ignoreErrored || N || (N = a);
      }
    }
    return N
      ? (k("fail"), Promise.reject(N))
      : (k("idle"),
  ...
  (q.m = a),
    (q.c = J),
    (q.d = function (a, b, c) {
      q.o(a, b) || Object.defineProperty(a, b, { enumerable: !0, get: c });
    }),
    (q.r = function (a) {

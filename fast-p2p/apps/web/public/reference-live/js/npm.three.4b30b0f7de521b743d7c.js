  ...
  [2],
  {
    "+8Os": function (e, t, r) {
      ...
      function a() {
        l.a.call(this),
          (this.type = "Camera"),
          (this.matrixWorldInverse = new s.a()),
          (this.projectionMatrix = new s.a()),
          (this.projectionMatrixInverse = new s.a());
      }
      function i(e, t, r, i) {
        a.call(this),
          (this.type = "PerspectiveCamera"),
          (this.fov = void 0 === e ? 50 : e),
          (this.zoom = 1),
          (this.near = void 0 === r ? 0.1 : r),
          (this.far = void 0 === i ? 2e3 : i),
          (this.focus = 10),
          (this.aspect = void 0 === t ? 1 : t),
          (this.view = null),
          (this.filmGauge = 35),
          (this.filmOffset = 0),
      ...
      a.prototype = Object.assign(Object.create(l.a.prototype), {
        ...
        copy: function (e, t) {
          return (
            l.a.prototype.copy.call(this, e, t),
        ...
        updateMatrixWorld: function (e) {
          l.a.prototype.updateMatrixWorld.call(this, e),
      ...
      r.d(t, "a", function () {
        ...
        (i.prototype = Object.assign(Object.create(a.prototype), {
          ...
          copy: function (e, t) {
            return (
              a.prototype.copy.call(this, e, t),
              (this.fov = e.fov),
              (this.zoom = e.zoom),
              (this.near = e.near),
              (this.far = e.far),
          ...
          getFocalLength: function () {
            var e = n(0.5 * c.a.DEG2RAD * this.fov);
            return (0.5 * this.getFilmHeight()) / e;
          },
          getEffectiveFOV: function () {
            return (
              2 * c.a.RAD2DEG * o(n(0.5 * c.a.DEG2RAD * this.fov) / this.zoom)
            );
          },
          ...
          updateProjectionMatrix: function () {
            var e = this.near,
              t = (e * n(0.5 * c.a.DEG2RAD * this.fov)) / this.zoom,
              r = 2 * t,
              a = this.aspect * r,
              i = -0.5 * a,
              o = this.view;
    ...
    "/V9W": function (e, t, r) {
      ...
      function a(e, t) {
        (this.min =
          void 0 === e ? new s.a(+Infinity, +Infinity, +Infinity) : e),
          (this.max =
            void 0 === t ? new s.a(-Infinity, -Infinity, -Infinity) : t);
      }
      var n = Math.abs,
        o = Math.max;
      r.d(t, "a", function () {
      ...
      Object.assign(a.prototype, {
        ...
        setFromCenterAndSize: (function () {
          var e = new s.a();
          return function (t, r) {
            var a = e.copy(r).multiplyScalar(0.5);
          ...
          function e(e) {
            ...
            if (void 0 !== n)
              if (n.isGeometry) {
                ...
                if (void 0 !== s)
                  for (a = 0, i = s.count; a < i; a++)
                    t.fromBufferAttribute(s, a).applyMatrix4(e.matrixWorld),
                      r.expandByPoint(t);
              }
          }
          var t = new s.a(),
        ...
        intersectsTriangle: (function () {
          function e(e) {
            ...
            for (s = 0, i = e.length - 3; s <= i; s += 3) {
              c.fromArray(e, s);
              var d = u.x * n(c.x) + u.y * n(c.y) + u.z * n(c.z),
                r = t.dot(c),
                p = a.dot(c),
                m = l.dot(c);
          ...
          return function (n) {
            ...
            return (
              !!e(o) &&
              ((o = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !!e(o)) &&
              (m.crossVectors(r, i), (o = [m.x, m.y, m.z]), e(o))
            );
          };
        })(),
      ...
      var a = new (function (e, t, r) {
        ...
        (this.onStart = void 0),
          ...
          (this.itemStart = function (e) {
            o++,
              !1 == i && void 0 !== a.onStart && a.onStart(e, n, o),
              (i = !0);
          }),
          (this.itemEnd = function (e) {
            n++,
              void 0 !== a.onProgress && a.onProgress(e, n, o),
              n == o && ((i = !1), void 0 !== a.onLoad && a.onLoad());
          }),
    ...
    "3+m9": function (e, t, r) {
      ...
      Object.assign(a.prototype, {
        isMatrix4: !0,
        set: function (e, t, r, a, i, n, o, s, l, d, c, p, u, m, g, f) {
          var h = this.elements;
          return (
            (h[0] = e),
            (h[4] = t),
        ...
        extractRotation: (function () {
          ...
          return function (t) {
            var r = this.elements,
              ...
              n = 1 / e.setFromMatrixColumn(t, 1).length(),
        ...
        lookAt: (function () {
          ...
          return function (a, i, n) {
            ...
            return (
              ...
              e.crossVectors(n, r),
              0 === e.lengthSq() &&
                (1 === Math.abs(n.z) ? (r.x += 1e-4) : (r.z += 1e-4),
                r.normalize(),
                e.crossVectors(n, r)),
              e.normalize(),
              t.crossVectors(r, e),
        ...
        multiplyMatrices: function (e, t) {
          ...
          return (
            ...
            (i[4] = n * M + o * T + s * A + l * I),
            (i[8] = n * S + o * w + s * D + l * z),
            (i[12] = n * L + o * P + s * R + l * U),
            (i[1] = d * b + c * E + p * C + u * N),
            (i[5] = d * M + c * T + p * A + u * I),
            (i[9] = d * S + c * w + p * D + u * z),
            (i[13] = d * L + c * P + p * R + u * U),
            (i[2] = m * b + g * E + f * C + h * N),
            (i[6] = m * M + g * T + f * A + h * I),
            (i[10] = m * S + g * w + f * D + h * z),
            (i[14] = m * L + g * P + f * R + h * U),
            (i[3] = v * b + x * E + y * C + _ * N),
            (i[7] = v * M + x * T + y * A + _ * I),
            (i[11] = v * S + x * w + y * D + _ * z),
            (i[15] = v * L + x * P + y * R + _ * U),
            this
          );
        },
        ...
        decompose: (function () {
          ...
          return function (r, a, i) {
            var n = this.elements,
              o = e.set(n[0], n[1], n[2]).length(),
              s = e.set(n[4], n[5], n[6]).length(),
              l = e.set(n[8], n[9], n[10]).length(),
              d = this.determinant();
            0 > d && (o = -o),
              (r.x = n[12]),
              (r.y = n[13]),
        ...
        equals: function (e) {
          for (var t = this.elements, r = e.elements, a = 0; 16 > a; a++)
            if (t[a] !== r[a]) return !1;
          return !0;
        },
    ...
    "4H5f": function (e, t, r) {
      ...
      function i(e) {
        for (var t = {}, r = 0, i; r < e.length; r++)
          for (var n in ((i = a(e[r])), i)) t[n] = i[n];
        return t;
      }
      r.d(t, "a", function () {
        return a;
    ...
    "8IfN": function (e, t, r) {
      "use strict";
      function a(e, t) {
        (this.center = void 0 === e ? new n.a() : e),
      ...
      Object.assign(a.prototype, {
        ...
        setFromPoints: (function () {
          ...
          return function (t, r) {
            ...
            for (var n = 0, o = 0, i = t.length; o < i; o++)
              n = Math.max(n, a.distanceToSquared(t[o]));
    ...
    "9eRv": function (e, t, r) {
      ...
      function a() {
        Object.defineProperty(this, "id", { value: s++ }),
          ...
          (this.side = n.D),
          (this.flatShading = !1),
          (this.vertexColors = n.db),
          (this.opacity = 1),
          (this.transparent = !1),
          (this.blendSrc = n.ac),
          (this.blendDst = n.lb),
          (this.blendEquation = n.b),
      ...
      a.prototype = Object.assign(Object.create(i.a.prototype), {
        ...
        toJSON: function (e) {
          ...
          if (
            ...
            this.envMap &&
              ...
              void 0 !== this.combine && (a.combine = this.combine),
            ...
            this.blending !== n.fb && (a.blending = this.blending),
            !0 === this.flatShading && (a.flatShading = this.flatShading),
            this.side !== n.D && (a.side = this.side),
            this.vertexColors !== n.db && (a.vertexColors = this.vertexColors),
            ...
            !0 === this.polygonOffset && (a.polygonOffset = !0),
        ...
        copy: function (e) {
          ...
          return (
            (this.clippingPlanes = r), (this.shadowSide = e.shadowSide), this
          );
        },
        dispose: function () {
    ...
    "9y4G": function (e, t, r) {
      "use strict";
      function a(e, t) {
        (this.origin = void 0 === e ? new s.a() : e),
          (this.direction = void 0 === t ? new s.a() : t);
      }
      var i = Math.sqrt,
        n = Math.max,
        o = Math.min;
      ...
      Object.assign(a.prototype, {
        ...
        distanceSqToSegment: (function () {
          ...
          return function (a, i, s, l) {
            e.copy(a).add(i).multiplyScalar(0.5),
              t.copy(i).sub(a).normalize(),
              r.copy(this.origin).sub(e);
            var d = 0.5 * a.distanceTo(i),
            ...
            if (!(0 < c))
              (h = 0 < p ? -d : d),
                (f = n(0, -(p * h + u))),
                (v = -f * f + h * (h + 2 * m) + g);
            else if (((f = p * m - u), (h = p * u - m), (x = d * c), !(0 <= f)))
              h <= -x
                ? ((f = n(0, -(-p * d + u))),
                  (h = 0 < f ? -d : o(n(-d, -m), d)),
                  (v = -f * f + h * (h + 2 * m) + g))
                : h <= x
                ? ((f = 0), (h = o(n(-d, -m), d)), (v = h * (h + 2 * m) + g))
                : ((f = n(0, -(p * d + u))),
                  (h = 0 < f ? d : o(n(-d, -m), d)),
                  (v = -f * f + h * (h + 2 * m) + g));
            else if (!(h >= -x))
              ...
              (f *= y),
                (h *= y),
                (v = f * (f + p * h + 2 * u) + h * (p * f + h + 2 * m) + g);
            } else
              (h = d),
                (f = n(0, -(p * h + u))),
                (v = -f * f + h * (h + 2 * m) + g);
            return (
              s && s.copy(this.direction).multiplyScalar(f).add(this.origin),
              l && l.copy(t).multiplyScalar(h).add(e),
              v
            );
          };
        })(),
        ...
        intersectBox: function (e, t) {
          var r = 1 / this.direction.x,
            ...
            p;
          return (0 <= r
            ? ((o = (e.min.x - n.x) * r), (s = (e.max.x - n.x) * r))
            : ((o = (e.max.x - n.x) * r), (s = (e.min.x - n.x) * r)),
          0 <= a
            ? ((l = (e.min.y - n.y) * a), (d = (e.max.y - n.y) * a))
            : ((l = (e.max.y - n.y) * a), (d = (e.min.y - n.y) * a)),
          o > d || l > s)
            ? null
            : ((l > o || o != o) && (o = l),
              (d < s || s != s) && (s = d),
              0 <= i
                ? ((c = (e.min.z - n.z) * i), (p = (e.max.z - n.z) * i))
                : ((c = (e.max.z - n.z) * i), (p = (e.min.z - n.z) * i)),
              o > p || c > s)
            ? null
            : ((c > o || o != o) && (o = c),
              (p < s || s != s) && (s = p),
              0 > s ? null : this.at(0 <= o ? o : s, t));
        },
    ...
    AIox: function (e, t, r) {
      ...
      (a.prototype = Object.create(i.a.prototype)),
        ...
        (a.prototype.copy = function (e) {
          return (
            i.a.prototype.copy.call(this, e),
            this.color.copy(e.color),
            (this.map = e.map),
    ...
    BR65: function (e, t, r) {
      ...
      function a(e, t, r) {
        (this.name = ""),
          (this.color = new i.a(e)),
          (this.near = void 0 === t ? 1 : t),
          (this.far = void 0 === r ? 1e3 : r);
      }
      r.d(t, "a", function () {
        return a;
      });
        ...
        Object.assign(a.prototype, {
          ...
          applyMatrix4: function (t) {
            var r = this.x,
              ...
              o = t.elements;
            return (
              (this.x = o[0] * r + o[4] * a + o[8] * i + o[12] * n),
              (this.y = o[1] * r + o[5] * a + o[9] * i + o[13] * n),
              (this.z = o[2] * r + o[6] * a + o[10] * i + o[14] * n),
              (this.w = o[3] * r + o[7] * a + o[11] * i + o[15] * n),
              this
            );
          },
          ...
          setAxisAngleFromRotationMatrix: function (e) {
            ...
            if (c(n - p) < t && c(o - g) < t && c(m - f) < t) {
              ...
              return (
                b > M && b > S
                  ? b < t
                    ? ((_ = 0), (x = 0.707106781), (y = 0.707106781))
                    : ((_ = d(b)), (x = L / _), (y = E / _))
                  : M > S
                  ? M < t
                    ? ((_ = 0.707106781), (x = 0), (y = 0.707106781))
                    : ((x = d(M)), (_ = L / x), (y = T / x))
                  : S < t
                  ? ((_ = 0.707106781), (x = 0.707106781), (y = 0))
                  : ((y = d(S)), (_ = E / y), (x = T / y)),
                this.set(_, x, y, v),
                this
              );
          ...
          clamp: function (e, t) {
            return (
              (this.x = s(e.x, p(t.x, this.x))),
              (this.y = s(e.y, p(t.y, this.y))),
              (this.z = s(e.z, p(t.z, this.z))),
              (this.w = s(e.w, p(t.w, this.w))),
              this
            );
          },
          ...
          roundToZero: function () {
            return (
              (this.x = 0 > this.x ? n(this.x) : o(this.x)),
              (this.y = 0 > this.y ? n(this.y) : o(this.y)),
              (this.z = 0 > this.z ? n(this.z) : o(this.z)),
              (this.w = 0 > this.w ? n(this.w) : o(this.w)),
              this
            );
          },
          negate: function () {
    ...
    D10d: function (e, t, r) {
      ...
      function o(e, t, r, a) {
        if (!1 !== e.visible && (e.raycast(t, r), !0 === a))
          for (var n = e.children, s = 0, i = n.length; s < i; s++)
            o(n[s], t, r, !0);
      }
      r.d(t, "a", function () {
        return a;
    ...
    "E3/K": function (e, t, r) {
      ...
      a.prototype = Object.assign(Object.create(i.a.prototype), {
        ...
        copy: function (e, t) {
          return (
            i.a.prototype.copy.call(this, e, t),
    ...
    EpSA: function (e, t, r) {
      ...
      function T(e) {
        E.call(this),
          (this.type = "Path"),
          (this.currentPoint = new W.a()),
          e && this.setFromPoints(e);
      }
      function w(e) {
        T.call(this, e),
          (this.uuid = q.a.generateUUID()),
          (this.type = "Shape"),
          (this.holes = []);
      }
      function P() {
      ...
      function A(e, t, r) {
        for (
          var a = Array.from ? Array.from(e) : (e + "").split(""),
            n = t / r.resolution,
            o =
              (r.boundingBox.yMax - r.boundingBox.yMin + r.underlineThickness) *
              n,
            s = [],
            l = 0,
            d = 0,
      ...
      function D(e, t, r, a, n) {
        ...
        if (o) {
          ...
          if (o.o)
            for (
              var v = o._cachedOutline || (o._cachedOutline = o.o.split(" ")),
                x = 0,
                i = v.length,
                l;
              x < i;
              ...
              (l = v[x++]),
                "m" === l
                  ? ((d = v[x++] * t + r), (c = v[x++] * t + a), s.moveTo(d, c))
                  : "l" === l
                  ? ((d = v[x++] * t + r), (c = v[x++] * t + a), s.lineTo(d, c))
                  : "q" === l
                  ? ((p = v[x++] * t + r),
                    (u = v[x++] * t + a),
                    (m = v[x++] * t + r),
                    (g = v[x++] * t + a),
                    s.quadraticCurveTo(m, g, p, u))
                  : "b" === l
                  ? ((p = v[x++] * t + r),
                    (u = v[x++] * t + a),
                    (m = v[x++] * t + r),
      ...
      Object.assign(a.prototype, {
        ...
        getUtoTmapping: function (e, r) {
          var a = this.getLengths(),
            ...
            o;
          o = r ? r : e * a[i - 1];
          for (var s = 0, l = i - 1, d; s <= l; )
            if (((n = U(s + (l - s) / 2)), (d = a[n] - o), 0 > d)) s = n + 1;
            else if (0 < d) l = n - 1;
            else {
              l = n;
              break;
        ...
        computeFrenetFrames: function (e, t) {
          var r = new X.a(),
            ...
            c;
          for (d = 0; d <= e; d++)
            (i = d / e), (a[d] = this.getTangentAt(i)), a[d].normalize();
          ...
          for (
            u <= p && ((p = u), r.set(1, 0, 0)),
              m <= p && ((p = m), r.set(0, 1, 0)),
              g <= p && r.set(0, 0, 1),
              s.crossVectors(a[0], r).normalize(),
              n[0].crossVectors(a[0], s),
              o[0].crossVectors(a[0], n[0]),
              d = 1;
            d <= e;
            d++
          )
            (n[d] = n[d - 1].clone()),
              (o[d] = o[d - 1].clone()),
              s.crossVectors(a[d - 1], a[d]),
              s.length() > z &&
                (s.normalize(),
                (c = G(q.a.clamp(a[d - 1].dot(a[d]), -1, 1))),
                n[d].applyMatrix4(l.makeRotationAxis(s, c))),
              o[d].crossVectors(a[d], n[d]);
          if (!0 === t)
            for (
              c = G(q.a.clamp(n[0].dot(n[e]), -1, 1)),
                c /= e,
                0 < a[0].dot(s.crossVectors(n[0], n[e])) && (c = -c),
                d = 1;
              d <= e;
              d++
            )
        ...
        (i.prototype.fromJSON = function (e) {
          return (
            a.prototype.fromJSON.call(this, e),
        ...
        (n.prototype.isEllipseCurve = !0),
        (n.prototype.getPoint = function (e, t) {
          for (
            var r = t || new W.a(),
              a = 2 * F,
          ...
          for (; i > a; ) i -= a;
          i < z && (n ? (i = 0) : (i = a)),
            !0 !== this.aClockwise || n || (i === a ? (i = -a) : (i -= a));
          var o = this.aStartAngle + e * i,
            s = this.aX + this.xRadius * B(o),
            l = this.aY + this.yRadius * O(o);
          if (0 !== this.aRotation) {
            var d = B(this.aRotation),
              c = O(this.aRotation),
              p = s - this.aX,
              u = l - this.aY;
      ...
      (l.prototype = Object.create(a.prototype)),
        ...
        (l.prototype.isCatmullRomCurve3 = !0),
        (l.prototype.getPoint = function (e, t) {
          var r = t || new X.a(),
            a = this.points,
            i = a.length,
            n = (i - (this.closed ? 0 : 1)) * e,
            o = U(n),
            s = n - o;
          this.closed
            ? (o += 0 < o ? 0 : (U(V(o) / i) + 1) * i)
          ...
          if (
            (this.closed || 0 < o
              ? (l = a[(o - 1) % i])
              : (Y.subVectors(a[0], a[1]).add(a[0]), (l = Y)),
            (d = a[o % i]),
            (c = a[(o + 1) % i]),
            this.closed || o + 2 < i
              ? (p = a[(o + 2) % i])
              : (Y.subVectors(a[i - 1], a[i - 2]).add(a[i - 1]), (p = Y)),
            "centripetal" === this.curveType || "chordal" === this.curveType)
          ) {
            var u = "chordal" === this.curveType ? 0.5 : 0.25,
              m = I(l.distanceToSquared(d), u),
              g = I(d.distanceToSquared(c), u),
              f = I(c.distanceToSquared(p), u);
            1e-4 > g && (g = 1),
              1e-4 > m && (m = g),
              1e-4 > f && (f = g),
              J.initNonuniformCatmullRom(l.x, d.x, c.x, p.x, m, g, f),
              Z.initNonuniformCatmullRom(l.y, d.y, c.y, p.y, m, g, f),
              Q.initNonuniformCatmullRom(l.z, d.z, c.z, p.z, m, g, f);
          } else
            "catmullrom" === this.curveType &&
              (J.initCatmullRom(l.x, d.x, c.x, p.x, this.tension),
              Z.initCatmullRom(l.y, d.y, c.y, p.y, this.tension),
              Q.initCatmullRom(l.z, d.z, c.z, p.z, this.tension));
          return r.set(J.calc(s), Z.calc(s), Q.calc(s)), r;
        }),
        (l.prototype.copy = function (e) {
          a.prototype.copy.call(this, e), (this.points = []);
          for (var t = 0, r = e.points.length, i; t < r; t++)
            (i = e.points[t]), this.points.push(i.clone());
          return (
        ...
        (l.prototype.toJSON = function () {
          var e = a.prototype.toJSON.call(this);
          e.points = [];
          for (var t = 0, r = this.points.length, i; t < r; t++)
            (i = this.points[t]), e.points.push(i.toArray());
          return (
        ...
        (l.prototype.fromJSON = function (e) {
          ...
          for (var t = 0, r = e.points.length, i; t < r; t++)
            (i = e.points[t]), this.points.push(new X.a().fromArray(i));
          return (
            (this.closed = e.closed),
            (this.curveType = e.curveType),
            (this.tension = e.tension),
        ...
        (y.prototype.isCubicBezierCurve = !0),
        (y.prototype.getPoint = function (e, t) {
          var r = t || new W.a(),
            a = this.v0,
            i = this.v1,
            n = this.v2,
        ...
        (_.prototype.isCubicBezierCurve3 = !0),
        (_.prototype.getPoint = function (e, t) {
          var r = t || new X.a(),
            a = this.v0,
            i = this.v1,
            n = this.v2,
        ...
        (b.prototype.isLineCurve3 = !0),
        (b.prototype.getPoint = function (e, t) {
          var r = t || new X.a();
          return (
            1 === e
              ? r.copy(this.v2)
        ...
        (M.prototype.getPoint = function (e, t) {
          var r = t || new W.a(),
            a = this.v0,
            i = this.v1,
            n = this.v2;
        ...
        (S.prototype.getPoint = function (e, t) {
          var r = t || new X.a(),
            a = this.v0,
            i = this.v1,
            n = this.v2;
        ...
        (L.prototype.getPoint = function (e, t) {
          var r = t || new W.a(),
            ...
            s = a[0 === n ? n : n - 1],
            l = a[n],
            c = a[n > a.length - 2 ? a.length - 1 : n + 1],
        ...
        (L.prototype.fromJSON = function (e) {
          a.prototype.fromJSON.call(this, e), (this.points = []);
          for (var t = 0, r = e.points.length, i; t < r; t++)
            (i = e.points[t]), this.points.push(new W.a().fromArray(i));
          return this;
        }),
        (E.prototype = Object.assign(Object.create(a.prototype), {
          ...
          getPoint: function (e) {
            for (
              var t = e * this.getLength(), r = this.getCurveLengths(), a = 0;
              a < r.length;
          ...
          getCurveLengths: function () {
            ...
            for (var e = [], t = 0, r = 0, a = this.curves.length; r < a; r++)
          ...
          getPoints: function (e) {
            e = e || 12;
            for (var t = [], r = 0, a = this.curves, i; r < a.length; r++)
              for (
                var n = a[r],
                  o =
                    n && n.isEllipseCurve
                      ? 2 * e
                      : n && (n.isLineCurve || n.isLineCurve3)
                      ? 1
                      : n && n.isSplineCurve
                      ? e * n.points.length
                      : e,
                ...
                (d = s[l]), (i && i.equals(d)) || (t.push(d), (i = d));
            return (
              this.autoClose &&
                1 < t.length &&
          ...
          copy: function (e) {
            ...
            for (var t = 0, r = e.curves.length, i; t < r; t++)
              (i = e.curves[t]), this.curves.push(i.clone());
            return (this.autoClose = e.autoClose), this;
          },
          toJSON: function () {
            var e = a.prototype.toJSON.call(this);
            (e.autoClose = this.autoClose), (e.curves = []);
            for (var t = 0, r = this.curves.length, i; t < r; t++)
              (i = this.curves[t]), e.curves.push(i.toJSON());
            return e;
          },
          fromJSON: function (e) {
            a.prototype.fromJSON.call(this, e),
              ...
              (this.curves = []);
            for (var t = 0, r = e.curves.length, i; t < r; t++)
              (i = e.curves[t]), this.curves.push(new H[i.type]().fromJSON(i));
            return this;
          },
        })),
        (T.prototype = Object.assign(Object.create(E.prototype), {
          ...
          fromJSON: function (e) {
            return (
              E.prototype.fromJSON.call(this, e),
        ...
        (w.prototype = Object.assign(Object.create(T.prototype), {
          ...
          getPointsHoles: function (e) {
            for (var t = [], r = 0, a = this.holes.length; r < a; r++)
          ...
          copy: function (e) {
            ...
            for (var t = 0, r = e.holes.length, a; t < r; t++)
              (a = e.holes[t]), this.holes.push(a.clone());
            return this;
          },
          toJSON: function () {
            var e = T.prototype.toJSON.call(this);
            (e.uuid = this.uuid), (e.holes = []);
            for (var t = 0, r = this.holes.length, a; t < r; t++)
              (a = this.holes[t]), e.holes.push(a.toJSON());
            return e;
          },
          fromJSON: function (e) {
            T.prototype.fromJSON.call(this, e),
              ...
              (this.holes = []);
            for (var t = 0, r = e.holes.length, a; t < r; t++)
              (a = e.holes[t]), this.holes.push(new T().fromJSON(a));
            return this;
          },
        }));
      var K = r("IJRe");
      Object.assign(P.prototype, {
        ...
        toShapes: function (e, t) {
          ...
          if (1 === o.length)
            return (
              (c = o[0]), (p = new w()), (p.curves = c.curves), s.push(p), s
            );
          ...
          if (1 < g.length) {
            ...
            for (var _ = 0, b = g.length, M; _ < b; _++) {
              ...
              for (var S = 0; S < M.length; S++) {
                for (var L = M[S], E = !0, T = 0; T < g.length; T++)
                  a(L.p, g[T].p) &&
                    (_ !== T && y.push({ froms: _, tos: T, hole: S }),
        ...
        Object.assign(C.prototype, {
          ...
          generateShapes: function (e, t) {
            void 0 === t && (t = 100);
            for (
              var r = [], a = A(e, t, this.data), i = 0, n = a.length;
              i < n;
              i++
            )
              Array.prototype.push.apply(r, a[i].toShapes());
            return r;
          },
        });
      var $ = r("hwoJ"),
      ...
      Object.assign(R.prototype, {
        load: function (e, t, r, a) {
          ...
          if (void 0 !== te[e])
            return void te[e].push({ onLoad: t, onProgress: r, onError: a });
          var s = /^data:(.*?)(;base64)?,(.*)$/,
            l = e.match(s);
          if (l) {
            var d = l[1],
            ...
            try {
              ...
              switch (u) {
                ...
                case "blob":
                  for (
                    var g = new Uint8Array(p.length), f = 0;
                    f < p.length;
                    f++
                  )
                    g[f] = p.charCodeAt(f);
                  m =
                    "blob" === u ? new Blob([g.buffer], { type: d }) : g.buffer;
                  break;
                case "document":
                  var i = new DOMParser();
            ...
            h.addEventListener(
              ...
              function (t) {
                ...
                if ((delete te[e], 200 === this.status || 0 === this.status)) {
                  ...
                  for (var o = 0, i = a.length, s; o < i; o++)
                    (s = a[o]), s.onLoad && s.onLoad(r);
                  n.manager.itemEnd(e);
                } else {
                  for (var o = 0, i = a.length, s; o < i; o++)
                    (s = a[o]), s.onError && s.onError(t);
            ...
            h.addEventListener(
              "progress",
              function (t) {
                for (var r = te[e], a = 0, i = r.length, n; a < i; a++)
                  (n = r[a]), n.onProgress && n.onProgress(t);
              },
              !1
            ),
            h.addEventListener(
            ...
            h.overrideMimeType &&
              h.overrideMimeType(
                void 0 === this.mimeType ? "text/plain" : this.mimeType
              ),
            this.requestHeader))
              h.setRequestHeader(v, this.requestHeader[v]);
            h.send(null);
          }
    ...
    GuLh: function (e, t, r) {
      "use strict";
      function a(e, t) {
        (this.normal = void 0 === e ? new n.a(1, 0, 0) : e),
          (this.constant = void 0 === t ? 0 : t);
      }
      r.d(t, "a", function () {
        return a;
      });
      ...
      Object.assign(a.prototype, {
        ...
        intersectLine: (function () {
          ...
          return function (r, a) {
            ...
            var i = r.delta(e),
              o = this.normal.dot(i);
            if (0 === o)
              return 0 === this.distanceToPoint(r.start)
                ? a.copy(r.start)
                : void 0;
            var s = -(r.start.dot(this.normal) + this.constant) / o;
            return 0 > s || 1 < s
              ? void 0
              : a.copy(i).multiplyScalar(s).add(r.start);
          };
        })(),
        ...
        applyMatrix4: (function () {
          var e = new n.a(),
            t = new i.a();
          return function (r, a) {
            var i = a || t.getNormalMatrix(r),
              n = this.coplanarPoint(e).applyMatrix4(r),
    ...
    IJRe: function (e, t, r) {
      ...
      function a(e, t, r, a, n) {
        var o, i;
        if (n === 0 < A(e, t, r, a))
          for (o = t; o < r; o += a) i = b(o, e[o], e[o + 1], i);
        else for (o = r - a; o >= t; o -= a) i = b(o, e[o], e[o + 1], i);
      ...
      function n(e, t) {
        ...
        do
          if (
            ((a = !1),
            !r.steiner && (M(r, r.next) || 0 === _(r.prev, r, r.next)))
          ) {
      ...
      function i(e) {
        ...
        for (var i = e.next.next; i !== e.prev; ) {
          if (
            x(t.x, t.y, r.x, r.y, a.x, a.y, i.x, i.y) &&
            0 <= _(i.prev, i, i.next)
          )
            return !1;
          i = i.next;
      ...
      function s(e, t, r, i) {
        ...
        for (
          var s = n.x < a.x ? (n.x < o.x ? n.x : o.x) : a.x < o.x ? a.x : o.x,
            ...
            d = n.x > a.x ? (n.x > o.x ? n.x : o.x) : a.x > o.x ? a.x : o.x,
            c = n.y > a.y ? (n.y > o.y ? n.y : o.y) : a.y > o.y ? a.y : o.y,
            u = h(s, l, t, r, i),
            m = h(d, c, t, r, i),
            g = e.nextZ;
          g && g.z <= m;
          ...
          if (
            g !== e.prev &&
            g !== e.next &&
            x(n.x, n.y, a.x, a.y, o.x, o.y, g.x, g.y) &&
            0 <= _(g.prev, g, g.next)
          )
            return !1;
          g = g.nextZ;
      ...
      function c(e, t, r, o) {
        ...
        for (l = 0, i = t.length; l < i; l++)
          (d = t[l] * o),
            (c = l < i - 1 ? t[l + 1] * o : e.length),
            (m = a(e, d, c, o, !1)),
            m === m.next && (m.steiner = !0),
            s.push(v(m));
        for (s.sort(p), l = 0; l < s.length; l++)
          u(s[l], r), (r = n(r, r.next));
        return r;
      }
      function p(e, t) {
        return e.x - t.x;
      ...
      function m(e, t) {
        ...
        for (r = o.next; r !== l; )
          a >= r.x &&
            r.x >= d &&
            a !== r.x &&
            x(i < c ? a : n, i, d, c, i < c ? n : a, i, r.x, r.y) &&
            ((u = Math.abs(i - r.y) / (a - r.x)),
            (u < p || (u === p && r.x > o.x)) && E(r, e) && ((o = r), (p = u))),
            (r = r.next);
        return o;
      }
      function g(e, t, r, a) {
      ...
      function S(e, t, r, a) {
        return (
          !!((M(e, t) && M(r, a)) || (M(e, a) && M(r, t))) ||
          (0 < _(e, t, r) != 0 < _(e, t, a) && 0 < _(r, a, e) != 0 < _(r, a, t))
        );
      }
      function L(e, t) {
        var r = e;
      ...
      function E(e, t) {
        return 0 > _(e.prev, e, e.next)
          ? 0 <= _(e, t, e.next) && 0 <= _(e, e.prev, t)
          : 0 > _(e, t, e.prev) || 0 > _(e, e.next, t);
      }
      function T(e, t) {
        var r = e,
          a = !1,
      ...
      function b(e, t, r, a) {
        ...
        return (
          a
            ? ((i.next = a.next), (i.prev = a), (a.next.prev = i), (a.next = i))
            : ((i.prev = i), (i.next = i)),
          i
        );
      }
      ...
      function A(e, t, r, a) {
        for (var n = 0, o = t, i = r - a; o < r; o += a)
          (n += (e[i] - e[o]) * (e[o + 1] + e[i + 1])), (i = o);
        return n;
      }
      function D(e) {
        var t = e.length;
      ...
      var I = {
        area: function (e) {
          for (var t = e.length, r = 0, a = t - 1, i = 0; i < t; a = i++)
            r += e[a].x * e[i].y - e[i].x * e[a].y;
          return 0.5 * r;
        },
        ...
        triangulateShape: function (e, t) {
          ...
          for (var s = 0; s < t.length; s++)
            a.push(o), (o += t[s].length), R(r, t[s]);
          for (var i = N.triangulate(r, a), s = 0; s < i.length; s += 3)
            n.push(i.slice(s, s + 3));
          return n;
        },
      };
    },
    IT9u: function (e, t, r) {
      ...
      function a(e, t, r, a, i, n, o, s, l, d, c, p) {
        Je.a.call(this, null, n, o, s, l, d, a, i, c, p),
          (this.image = { data: e, width: t, height: r }),
          (this.magFilter = void 0 === l ? je.Y : l),
          (this.minFilter = void 0 === d ? je.Y : d),
        ...
        function t(t, r) {
          ...
          return (
            a instanceof Float32Array
              ...
              ? (o = 5120)
              : a instanceof Uint8Array && (o = 5121),
            {
              buffer: n,
              type: o,
        ...
        function r(t, r, a) {
          ...
          e.bindBuffer(a, t),
            !1 === r.dynamic
              ...
              : (e.bufferSubData(
                  a,
                  n.offset * i.BYTES_PER_ELEMENT,
                  i.subarray(n.offset, n.offset + n.count)
                ),
                (n.count = -1));
        }
        var a = new WeakMap();
        return {
          ...
          update: function (e, i) {
            ...
            void 0 === n
              ? a.set(e, t(e, i))
              : n.version < e.version &&
                (r(n.buffer, e, i), (n.version = e.version));
          },
        };
      }
      function o(e, t, r, a, i, n) {
        st.a.call(this),
          ...
          this.fromBufferGeometry(new s(e, t, r, a, i, n)),
          this.mergeVertices();
      }
      function s(e, t, r, a, i, n) {
        ...
        var l = [],
          ...
          m = 0,
          g = 0;
        o("z", "y", "x", -1, -1, r, t, e, n, i, 0),
          o("z", "y", "x", 1, -1, r, t, -e, n, i, 1),
          o("x", "z", "y", 1, 1, e, r, t, a, n, 2),
          o("x", "z", "y", 1, -1, e, r, -t, a, n, 3),
          o("x", "y", "z", 1, -1, e, t, r, a, i, 4),
          o("x", "y", "z", -1, -1, e, t, -r, a, i, 5),
          this.setIndex(l),
          this.addAttribute("position", new dt.b(d, 3)),
          this.addAttribute("normal", new dt.b(c, 3)),
          this.addAttribute("uv", new dt.b(p, 2));
      }
      function l(e, t, r, a) {
        function i(t, a, i, m) {
          var g = a.background;
          if (
            (null === g
              ? (n(o, l), (d = null), (c = 0))
              : g && g.isColor && (n(g, 1), (m = !0), (d = null), (c = 0)),
            (e.autoClear || m) &&
              e.clear(e.autoClearColor, e.autoClearDepth, e.autoClearStencil),
            g && (g.isCubeTexture || g.isWebGLRenderTargetCube))
          ) {
            void 0 === u &&
              ((u = new ut.a(
                new s(1, 1, 1),
              ...
              u.geometry.removeAttribute("normal"),
            ...
            (u.material.uniforms.tCube.value = f),
              (u.material.uniforms.tFlip.value = g.isWebGLRenderTargetCube
                ? 1
                : -1),
              (d !== g || c !== f.version) &&
                ((u.material.needsUpdate = !0), (d = g), (c = f.version)),
            ...
            g &&
              ...
              (void 0 === p &&
                ...
                p.geometry.removeAttribute("normal"),
                ...
                r.update(p)),
              (p.material.uniforms.t2D.value = g),
              !0 === g.matrixAutoUpdate && g.updateMatrix(),
              p.material.uniforms.uvTransform.value.copy(g.matrix),
              (d !== g || c !== g.version) &&
                ((p.material.needsUpdate = !0), (d = g), (c = g.version)),
      ...
      function d(e, t, r, a) {
        ...
        function n(i, n, s) {
          var l;
          if (a.isWebGL2) l = e;
          else if (((l = t.get("ANGLE_instanced_arrays")), null === l))
            return void console.error(
              "THREE.WebGLBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays."
            );
          l[a.isWebGL2 ? "drawArraysInstanced" : "drawArraysInstancedANGLE"](
            o,
            n,
            s,
            i.maxInstancedCount
          ),
            r.update(s, o, i.maxInstancedCount);
        }
        var o;
      ...
      function c(e, t, r) {
        ...
        var n =
          ...
          o = void 0 === r.precision ? "highp" : r.precision,
          s = i(o),
          l;
        s !== o &&
          (console.warn(
          ...
          (o = s));
        var d = !0 === r.logarithmicDepthBuffer,
          ...
          h = e.getParameter(36348),
          v = e.getParameter(36349),
          x = 0 < p,
          y = n || !!t.get("OES_texture_float"),
          _ = n ? e.getParameter(36183) : 0;
        return {
          isWebGL2: n,
          getMaxAnisotropy: a,
          getMaxPrecision: i,
      ...
      function p() {
        function e() {
          c.value !== a && ((c.value = a), (c.needsUpdate = 0 < n)),
            (r.numPlanes = n),
            (r.numIntersection = 0);
        }
        function t(e, t, a, n) {
          ...
          if (0 !== o) {
            if (((s = c.value), !0 !== n || null === s)) {
              ...
              d.getNormalMatrix(u),
                (null === s || s.length < p) && (s = new Float32Array(p));
              for (var m = 0, i = a; m !== o; ++m, i += 4)
                l.copy(e[m]).applyMatrix4(u, d),
                  l.normal.toArray(s, i),
                  (s[i + 3] = l.constant);
            }
        ...
        (this.uniform = c),
          ...
          (this.setState = function (r, l, d, p, u, m) {
            if (!o || null === r || 0 === r.length || (s && !d))
              s ? t(null) : e();
            else {
              var g = s ? 0 : n,
                f = 4 * g,
                h = u.clippingState || null;
              (c.value = h), (h = t(r, p, f, m));
              for (var v = 0; v !== f; ++v) h[v] = a[v];
              (u.clippingState = h),
                (this.numIntersection = l ? this.numPlanes : 0),
                (this.numPlanes += g);
            }
          });
      }
      function u(e) {
        ...
        return {
          get: function (r) {
            ...
            return (
              (a =
                "WEBGL_depth_texture" === r
                  ? e.getExtension("WEBGL_depth_texture") ||
                    e.getExtension("MOZ_WEBGL_depth_texture") ||
                    e.getExtension("WEBKIT_WEBGL_depth_texture")
                  : "EXT_texture_filter_anisotropic" === r
                  ? e.getExtension("EXT_texture_filter_anisotropic") ||
                    e.getExtension("MOZ_EXT_texture_filter_anisotropic") ||
                    e.getExtension("WEBKIT_EXT_texture_filter_anisotropic")
                  : "WEBGL_compressed_texture_s3tc" === r
                  ? e.getExtension("WEBGL_compressed_texture_s3tc") ||
                    e.getExtension("MOZ_WEBGL_compressed_texture_s3tc") ||
                    e.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc")
                  : "WEBGL_compressed_texture_pvrtc" === r
      ...
      function m(e, t, r) {
        ...
        return {
                ...
                t.isBufferGeometry
                  ...
                  : t.isGeometry &&
                    (void 0 === t._bufferGeometry &&
                      (t._bufferGeometry = new lt.a().setFromObject(e)),
                    (n = t._bufferGeometry)),
                (i[t.id] = n),
                r.memory.geometries++,
                n);
          ...
          update: function (e) {
            var r = e.index,
              a = e.attributes;
            for (var n in (null !== r && t.update(r, 34963), a))
              t.update(a[n], 34962);
            var o = e.morphAttributes;
            for (var n in o)
              for (var s = o[n], d = 0, i = s.length; d < i; d++)
                t.update(s[d], 34962);
          },
          getWireframeAttribute: function (e) {
            ...
            var o = [],
              ...
              d = e.attributes;
            if (null !== s)
              for (var p = s.array, u = 0, i = p.length; u < i; u += 3) {
                var l = p[u + 0],
                  a = p[u + 1],
                  m = p[u + 2];
                o.push(l, a, a, m, m, l);
              ...
              for (
                var p = d.position.array, u = 0, i = p.length / 3 - 1;
                u < i;
                u += 3
              ) {
                var l = u + 0,
            ...
            return (
              (r = new (65535 < Object(gt.a)(o) ? dt.d : dt.c)(o, 1)),
              t.update(r, 34963),
              (n[e.id] = r),
              r
            );
      ...
      function g(e, t, r, a) {
        ...
        function n(i, n, d) {
          ...
          c[
            a.isWebGL2 ? "drawElementsInstanced" : "drawElementsInstancedANGLE"
          ](o, d, s, n * l, i.maxInstancedCount),
            r.update(d, o, i.maxInstancedCount);
        }
        var o, s, l;
        (this.setMode = function (e) {
          o = e;
      ...
      function v(e) {
        ...
        return {
          update: function (a, n, o, s) {
            ...
            for (
              var i = o.morphTargets && n.morphAttributes.position,
                u = o.morphNormals && n.morphAttributes.normal,
                p = 0,
                m;
              p < d;
              p++
              ...
              (m = c[p]),
                0 !== m[1] &&
                  (i && n.removeAttribute("morphTarget" + p),
            ...
            for (var p = 0, m; 8 > p; p++) {
              if (((m = c[p]), m)) {
                var g = m[0],
                  f = m[1];
                if (f) {
                  i && n.addAttribute("morphTarget" + p, i[g]),
                    u && n.addAttribute("morphNormal" + p, u[g]),
                    (r[p] = f);
                  continue;
                }
              }
      ...
      function x(e, t) {
        function r(r) {
          ...
          return (
            a[o.id] !== i &&
              (n.isGeometry && o.updateFromObject(r),
              e.update(o),
              (a[o.id] = i)),
            o
          );
      ...
      function y(e, t, r, a, i, n, o, s, l, d) {
        (e = void 0 === e ? [] : e),
          (t = void 0 === t ? je.l : t),
          Je.a.call(this, e, t, r, a, i, n, o, s, l, d),
          (this.flipY = !1);
      }
      function _(e, t, r, a) {
        Je.a.call(this, null),
          (this.image = { data: e, width: t, height: r, depth: a }),
          (this.magFilter = je.Y),
          (this.minFilter = je.Y),
          (this.generateMipmaps = !1),
          (this.flipY = !1);
      ...
      function M(e, t, a) {
        ...
        var s = t * a,
          n = xt[s];
        if (
          (void 0 === n && ((n = new Float32Array(s)), (xt[s] = n)), 0 !== t)
        ) {
          o.toArray(n, 0);
      ...
      function I(e, t, r) {
        ...
        a[0] !== i && (e.uniform1i(this.addr, i), (a[0] = i)),
          r.setTexture2D(t || ft, i);
      }
      function z(e, t, r) {
        var a = this.cache,
          i = r.allocTextureUnit();
        a[0] !== i && (e.uniform1i(this.addr, i), (a[0] = i)),
          r.setTexture3D(t || ht, i);
      }
      function U(e, t, r) {
        var a = this.cache,
          i = r.allocTextureUnit();
        a[0] !== i && (e.uniform1i(this.addr, i), (a[0] = i)),
          r.setTextureCube(t || vt, i);
      }
      function F(e, t) {
        var r = this.cache;
      ...
      function ae(e, t, r) {
        ...
        for (var a = e.getProgramParameter(t, 35718), n = 0; n < a; ++n) {
          var i = e.getActiveUniform(t, n),
            o = e.getUniformLocation(t, i.name);
          re(i, o, this);
        }
      }
      function ie(e) {
      ...
      function ne(e, t, r) {
        ...
        return (
          e.shaderSource(a, r),
          e.compileShader(a),
          !1 === e.getShaderParameter(a, 35713) &&
      ...
      function le(e, t) {
        var r = oe(t);
        return (
          "vec4 " + e + "( vec4 value ) { return LinearTo" + r[0] + r[1] + "; }"
        );
      }
      function de(e, t) {
        var r;
      ...
      function ue(e, t) {
        for (
          var r = {}, a = e.getProgramParameter(t, 35721), n = 0;
          n < a;
          n++
        ) {
          var i = e.getActiveAttrib(t, n),
            o = i.name;
      ...
      function xe(e, t, r, a, i, n, o) {
        ...
        n.shadowMapType === je.nb
          ? (p = "SHADOWMAP_TYPE_PCF")
          : n.shadowMapType === je.ob && (p = "SHADOWMAP_TYPE_PCF_SOFT");
        ...
        var f = 0 < e.gammaFactor ? e.gammaFactor : 1,
          h = o.isWebGL2 ? "" : ce(a.extensions, n, t),
          v = pe(l),
          x = s.createProgram(),
          y,
          _;
        if (
          (a.isRawShaderMaterial
            ...
            : ((y = [
                ...
                (o.isWebGL2 || t.get("EXT_frag_depth"))
              ...
              (_ = [
                ...
                (o.isWebGL2 || t.get("EXT_frag_depth"))
                  ? "#define USE_LOGDEPTHBUF_EXT"
                  : "",
                n.envMap && (o.isWebGL2 || t.get("EXT_shader_texture_lod"))
                  ? "#define TEXTURE_LOD_EXT"
                  : "",
                "uniform mat4 viewMatrix;",
                "uniform vec3 cameraPosition;",
                n.toneMapping === je.eb ? "" : "#define TONE_MAPPING",
                n.toneMapping === je.eb ? "" : Ke.tonemapping_pars_fragment,
                n.toneMapping === je.eb ? "" : de("toneMapping", n.toneMapping),
                ...
                n.emissiveMapEncoding
                  ...
                  : "",
                n.mapEncoding ? se("mapTexelToLinear", n.mapEncoding) : "",
                n.matcapEncoding
                  ? se("matcapTexelToLinear", n.matcapEncoding)
                  : "",
                n.envMapEncoding
                  ? se("envMapTexelToLinear", n.envMapEncoding)
                  : "",
                n.emissiveMapEncoding
                  ? se("emissiveMapTexelToLinear", n.emissiveMapEncoding)
                  : "",
                n.outputEncoding
                  ? le("linearToOutputTexel", n.outputEncoding)
                  : "",
                n.depthPacking ? "#define DEPTH_PACKING " + a.depthPacking : "",
                "\n",
              ]
                .filter(me)
                .join("\n"))),
          ...
          (d = ve(d)),
          (c = ve(c)),
          o.isWebGL2 && !a.isRawShaderMaterial)
        ) {
          var b = !1,
          ...
          a.isShaderMaterial &&
            null !== d.match(M) &&
            null !== c.match(M) &&
            ((b = !0), (d = d.replace(M, "")), (c = c.replace(M, ""))),
            (y =
            ...
            (_ =
              [
                "#version 300 es\n",
                "#define varying in",
                b ? "" : "out highp vec4 pc_fragColor;",
                b ? "" : "#define gl_FragColor pc_fragColor",
        ...
        s.attachShader(x, E),
          ...
          void 0 === a.index0AttributeName
            ? !0 === n.morphTargets && s.bindAttribLocation(x, 0, "position")
            : s.bindAttribLocation(x, 0, a.index0AttributeName),
          s.linkProgram(x);
        var w = s.getProgramInfoLog(x).trim(),
          P = s.getShaderInfoLog(E).trim(),
          C = s.getShaderInfoLog(T).trim(),
          A = !0,
          D = !0;
        !1 === s.getProgramParameter(x, 35714)
          ? ((A = !1),
            console.error(
              "THREE.WebGLProgram: shader error: ",
              s.getError(),
              "35715",
              s.getProgramParameter(x, 35715),
      ...
      function ye(e, t, r) {
        ...
        (this.getParameters = function (t, n, s, l, d, c, p) {
          var u = o[t.type],
            m = p.isSkinnedMesh ? a(p) : 0,
            g = r.precision;
          null !== t.precision &&
            ((g = r.getMaxPrecision(t.precision)),
            g !== t.precision &&
              console.warn(
          ...
          var f = e.getRenderTarget(),
            h = {
              ...
              envMapCubeUV:
                !!t.envMap &&
                (t.envMap.mapping === je.n || t.envMap.mapping === je.o),
              lightMap: !!t.lightMap,
              aoMap: !!t.aoMap,
              ...
              shadowMapEnabled:
                e.shadowMap.enabled && p.receiveShadow && 0 < s.length,
          ...
          (this.getProgramCode = function (t, r) {
            ...
            if (
              (r.shaderID
                ? a.push(r.shaderID)
                : (a.push(t.fragmentShader), a.push(t.vertexShader)),
              void 0 !== t.defines)
            )
              for (var n in t.defines) a.push(n), a.push(t.defines[n]);
            for (var o = 0; o < s.length; o++) a.push(r[s[o]]);
            return (
              a.push(t.onBeforeCompile.toString()),
              a.push(e.gammaOutput),
              a.push(e.gammaFactor),
              a.join()
            );
          }),
          (this.acquireProgram = function (a, i, o, s) {
            for (var l = 0, d = n.length, c, p; l < d; l++)
              if (((p = n[l]), p.code === s)) {
                (c = p), ++c.usedTimes;
                break;
              }
            return (
              void 0 === c && ((c = new xe(e, t, s, a, i, o, r)), n.push(c)), c
            );
          }),
        ...
        return {
          setup: function (n, o, s) {
            for (
              ...
              if (l.isAmbientLight)
                (d += _.r * b), (c += _.g * b), (p += _.b * b);
              else if (l.isDirectionalLight) {
                var L = e.get(l);
                if (
                  (L.color.copy(l.color).multiplyScalar(l.intensity),
                  L.direction.setFromMatrixPosition(l.matrixWorld),
                  r.setFromMatrixPosition(l.target.matrixWorld),
                  L.direction.sub(r),
                  L.direction.transformDirection(v),
                  (L.shadow = l.castShadow),
                  l.castShadow)
                ) {
                  var E = l.shadow;
                  (L.shadowBias = E.bias),
                    (L.shadowRadius = E.radius),
                    (L.shadowMapSize = E.mapSize);
                }
                (t.directionalShadowMap[u] = S),
                  (t.directionalShadowMatrix[u] = l.shadow.matrix),
                  (t.directional[u] = L),
                  u++;
              } else if (l.isSpotLight) {
                var L = e.get(l);
                if (
                  (L.position.setFromMatrixPosition(l.matrixWorld),
                  L.position.applyMatrix4(v),
                  L.color.copy(_).multiplyScalar(b),
                  (L.distance = M),
                  L.direction.setFromMatrixPosition(l.matrixWorld),
                  r.setFromMatrixPosition(l.target.matrixWorld),
                  L.direction.sub(r),
                  L.direction.transformDirection(v),
                  (L.coneCos = ke(l.angle)),
                  (L.penumbraCos = ke(l.angle * (1 - l.penumbra))),
                  (L.decay = l.decay),
                  (L.shadow = l.castShadow),
                  l.castShadow)
                ) {
                ...
                (t.spotShadowMap[g] = S),
                  (t.spotShadowMatrix[g] = l.shadow.matrix),
                  (t.spot[g] = L),
                  g++;
                ...
                L.color.copy(_).multiplyScalar(b),
                  ...
                  a.premultiply(v),
                  i.extractRotation(a),
                  L.halfWidth.set(0.5 * l.width, 0, 0),
                  L.halfHeight.set(0, 0.5 * l.height, 0),
                  L.halfWidth.applyMatrix4(i),
                  L.halfHeight.applyMatrix4(i),
                  (t.rectArea[f] = L),
                  f++;
                ...
                if (
                  ...
                  (L.shadowBias = E.bias),
                    (L.shadowRadius = E.radius),
                    (L.shadowMapSize = E.mapSize),
                    (L.shadowCameraNear = E.camera.near),
                    (L.shadowCameraFar = E.camera.far);
                }
                (t.pointShadowMap[m] = S),
                  (t.pointShadowMatrix[m] = l.shadow.matrix),
                  (t.point[m] = L),
                  m++;
                ...
                L.direction.setFromMatrixPosition(l.matrixWorld),
                  ...
                  L.skyColor.copy(l.color).multiplyScalar(b),
                  L.groundColor.copy(l.groundColor).multiplyScalar(b),
                  (t.hemi[h] = L),
                  h++;
              }
            }
      ...
      function Ce(e, t, r) {
        (this.width = e),
          (this.height = t),
          (this.scissor = new ot.a(0, 0, e, t)),
          (this.scissorTest = !1),
          (this.viewport = new ot.a(0, 0, e, t)),
          (r = r || {}),
          (this.texture = new Je.a(
            void 0,
            void 0,
            r.wrapS,
            r.wrapT,
      ...
      function De(e) {
        wt.a.call(this),
          ...
          (this.referencePosition = new et.a()),
          (this.nearDistance = 1),
      ...
      function Re(e, t, r) {
        function a(t, r, a, i, n, o) {
          ...
          if ((a && ((d = f), (c = t.customDistanceMaterial)), !c)) {
            ...
            r.morphTargets &&
              (s && s.isBufferGeometry
                ...
                : s &&
                  s.isGeometry &&
                  (p = s.morphTargets && 0 < s.morphTargets.length)),
              t.isSkinnedMesh &&
                !1 === r.skinning &&
                console.warn(
            ...
            var x = t.isSkinnedMesh && r.skinning,
              y = 0;
            p && (y |= u), x && (y |= m), (l = d[y]);
          } else l = c;
          if (
          ...
          return (
            ...
            (l.side = null == r.shadowSide ? v[r.side] : r.shadowSide),
        ...
        function n(r, s, d, c) {
          if (!1 !== r.visible) {
            ...
            if (
              ...
              r.castShadow &&
              (!r.frustumCulled || o.intersectsObject(r))
            ) {
              ...
              var m = t.update(r),
                g = r.material;
              if (Array.isArray(g))
                for (var f = m.groups, h = 0, v = f.length; h < v; h++) {
                  var x = f[h],
                    y = g[x.materialIndex];
                  if (y && y.visible) {
            ...
            for (var b = r.children, M = 0, i = b.length; M < i; M++)
              n(b[M], s, d, c);
          }
        }
        for (
          ...
          var i = 0 != (b & u),
            M = 0 != (b & m),
            S = new Ae({ depthPacking: je.qb, morphTargets: i, skinning: M });
          g[b] = S;
            ...
            if (
              ...
              for (var m = 0, i = t.length, g; m < i; m++) {
                ...
                p.setFromMatrixPosition(f.matrixWorld),
                  b.position.copy(p),
                  v
                    ? ((g = 6), w.makeTranslation(-p.x, -p.y, -p.z))
                    : ((g = 1),
                      c.setFromMatrixPosition(f.target.matrixWorld),
                      b.lookAt(c),
                      b.updateMatrixWorld(),
                      w.set(
                        0.5,
                ...
                for (var P = 0; P < g; P++) {
                  ...
                  s.multiplyMatrices(b.projectionMatrix, b.matrixWorldInverse),
                    o.setFromMatrix(s),
                    n(r, a, b, v);
                }
              }
      ...
      function Ne(e, t, r, a) {
        function i(t, r, a) {
          ...
          for (var s = 0; s < a; s++)
            e.texImage2D(r + s, 0, 6408, 1, 1, 0, 6408, 5121, n);
          return o;
        }
        function n(r, i) {
          if (
            ((S[r] = 1),
            0 === L[r] && (e.enableVertexAttribArray(r), (L[r] = 1)),
            E[r] !== i)
          ) {
            var n = a.isWebGL2 ? e : t.get("ANGLE_instanced_arrays");
            n[a.isWebGL2 ? "vertexAttribDivisor" : "vertexAttribDivisorANGLE"](
              r,
              i
            ),
              (E[r] = i);
        ...
        function l() {
          if (
            ...
            for (var r = e.getParameter(34467), a = 0; a < r.length; a++)
              w.push(r[a]);
          return w;
        }
        function d(t) {
            ...
            : (C || (o(3042), (C = !0)),
              t === je.s
                ? void ((l = l || a),
                  ...
                  (c = c || n),
                  (a !== D || l !== I) &&
                    (e.blendEquationSeparate(r.convert(a), r.convert(l)),
                    (D = a),
                    (I = l)),
                  (i !== R || n !== N || d !== z || c !== U) &&
                    (e.blendFuncSeparate(
                ...
                : void (
                    (t !== A || p !== F) &&
                    ((D !== je.b || I !== je.b) &&
                      (e.blendEquation(32774), (D = je.b), (I = je.b)),
                    p
                      ? t === je.fb
        ...
        function g(t, r, a) {
          t
            ? (o(32823),
              (V !== r || H !== a) && (e.polygonOffset(r, a), (V = r), (H = a)))
            : s(32823);
        }
        function f(t) {
          void 0 === t && (t = 33984 + k - 1),
            j !== t && (e.activeTexture(t), (j = t));
        }
        function h(t, r) {
          null === j && f();
          var a = Y[j];
          void 0 === a && ((a = { type: void 0, texture: void 0 }), (Y[j] = a)),
            (a.type !== t || a.texture !== r) &&
              (e.bindTexture(t, r || Q[t]), (a.type = t), (a.texture = r));
        }
        function v(t) {
        ...
        var y = new (function () {
            ...
            return {
              ...
              setClear: function (t, r, o, s, a) {
                !0 === a && ((t *= s), (r *= s), (o *= s)),
                  i.set(t, r, o, s),
                  !1 === n.equals(i) && (e.clearColor(t, r, o, s), n.copy(i));
              },
              reset: function () {
          ...
          b = new (function () {
            ...
            return {
              ...
              setFunc: function (t, r, o) {
                (a !== t || i !== r || n !== o) &&
                  (e.stencilFunc(t, r, o), (a = t), (i = r), (n = o));
              },
              setOp: function (t, r, a) {
                (l !== t || d !== r || c !== a) &&
                  (e.stencilOp(t, r, a), (l = t), (d = r), (c = a));
              },
              setLocked: function (e) {
                t = e;
              },
        ...
        -1 === X.indexOf("WebGL")
          ? -1 !== X.indexOf("OpenGL ES") &&
            ((q = parseFloat(/^OpenGL\ ES\ ([0-9])/.exec(X)[1])), (W = 2 <= q))
          : ((q = parseFloat(/^WebGL\ ([0-9])/.exec(X)[1])), (W = 1 <= q));
        var j = null,
          Y = {},
          J = new ot.a(),
          Z = new ot.a(),
          Q = {};
        return (
          (Q[3553] = i(3553, 3553, 1)),
          (Q[34067] = i(34067, 34069, 6)),
          y.setClear(0, 0, 0, 1),
          _.setClear(1),
          b.setClear(0),
          o(2929),
          ...
          c(je.cb),
          {
            ...
            disableUnusedAttributes: function () {
              for (var t = 0, r = L.length; t !== r; ++t)
                L[t] !== S[t] && (e.disableVertexAttribArray(t), (L[t] = 0));
            },
            enable: o,
            disable: s,
            ...
            setMaterial: function (e, t) {
              ...
              t && (r = !r),
                p(r),
                e.blending === je.fb && !1 === e.transparent
                  ? c(je.cb)
                  : c(
                      e.blending,
                      e.blendEquation,
                ...
                _.setFunc(e.depthFunc),
                _.setTest(e.depthTest),
                _.setMask(e.depthWrite),
                y.setMask(e.colorWrite),
            ...
            reset: function () {
              for (var t = 0; t < L.length; t++)
                1 === L[t] && (e.disableVertexAttribArray(t), (L[t] = 0));
              (T = {}),
                (w = null),
                (j = null),
                (Y = {}),
      ...
      function Ie(e, t, r, a, n, o, s) {
        function l(e, t, r, a) {
          var i = 1;
          if (
            ((e.width > a || e.height > a) && (i = a / qe(e.width, e.height)),
            1 > i || !0 === t)
          ) {
            if (
        ...
        function c(e) {
          return (
            ...
            (e.wrapS !== je.k ||
              e.wrapT !== je.k ||
              (e.minFilter !== je.Y && e.minFilter !== je.M))
          );
        }
        function p(e, t) {
          return (
        ...
        function g(e) {
          ...
          t.removeEventListener("dispose", g),
            h(t),
            t.isVideoTexture && delete w[t.id],
            s.memory.textures--;
        }
        function f(e) {
          var t = e.target;
        ...
        function y(r, s, l) {
          ...
          if (
            (l
              ? (e.texParameteri(r, 10242, o.convert(s.wrapS)),
                e.texParameteri(r, 10243, o.convert(s.wrapT)),
                e.texParameteri(r, 10240, o.convert(s.magFilter)),
                e.texParameteri(r, 10241, o.convert(s.minFilter)))
              : (e.texParameteri(r, 10242, 33071),
                e.texParameteri(r, 10243, 33071),
                (s.wrapS !== je.k || s.wrapT !== je.k) &&
                  console.warn(
                    "THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."
                  ),
                e.texParameteri(r, 10240, i(s.magFilter)),
                e.texParameteri(r, 10241, i(s.minFilter)),
                s.minFilter !== je.Y &&
                  s.minFilter !== je.M &&
                  console.warn(
                    "THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter."
                  )),
            (d = t.get("EXT_texture_filter_anisotropic")),
            d)
          ) {
            if (s.type === je.C && null === t.get("OES_texture_float_linear"))
              return;
            if (
              s.type === je.H &&
              null === (n.isWebGL2 || t.get("OES_texture_half_float_linear"))
            )
              return;
            (1 < s.anisotropy || a.get(s).__currentAnisotropy) &&
              (e.texParameterf(
                r,
                d.TEXTURE_MAX_ANISOTROPY_EXT,
                Xe(s.anisotropy, n.getMaxAnisotropy())
              ),
              (a.get(s).__currentAnisotropy = s.anisotropy));
          }
        }
        function _(t, a, f) {
          var h;
          (h = a.isDataTexture3D ? 32879 : 3553),
            void 0 === t.__webglInit &&
              ((t.__webglInit = !0),
              a.addEventListener("dispose", g),
              (t.__webglTexture = e.createTexture()),
              s.memory.textures++),
            r.activeTexture(33984 + f),
            r.bindTexture(h, t.__webglTexture),
            e.pixelStorei(37440, a.flipY),
            e.pixelStorei(37441, a.premultiplyAlpha),
            e.pixelStorei(3317, a.unpackAlignment);
          var v = c(a) && !1 === d(a.image),
            x = l(a.image, v, !1, n.maxTextureSize),
            _ = d(x) || n.isWebGL2,
            b = o.convert(a.format),
            M = o.convert(a.type),
            S = m(b, M);
          y(h, a, _);
          var L = a.mipmaps,
          ...
          if (a.isDepthTexture) {
            ...
            a.format === je.t &&
              ...
              a.format === je.u &&
                ...
                a.type !== je.lc &&
                  ...
                  (a.type = je.lc),
                  (M = o.convert(a.type)))),
              r.texImage2D(3553, 0, S, x.width, x.height, 0, b, M, null);
          } else if (a.isDataTexture) {
            if (0 < L.length && _) {
              for (var T = 0, i = L.length; T < i; T++)
                (E = L[T]),
                  r.texImage2D(3553, T, S, E.width, E.height, 0, b, M, E.data);
              (a.generateMipmaps = !1), (t.__maxMipLevel = L.length - 1);
            } else
              r.texImage2D(3553, 0, S, x.width, x.height, 0, b, M, x.data),
                (t.__maxMipLevel = 0);
          } else if (a.isCompressedTexture) {
            for (var T = 0, i = L.length; T < i; T++)
              (E = L[T]),
                a.format !== je.rb && a.format !== je.Nb
                  ? -1 < r.getCompressedTextureFormats().indexOf(b)
            ...
            r.texImage3D(
              ...
              (t.__maxMipLevel = 0);
          else if (0 < L.length && _) {
            for (var T = 0, i = L.length; T < i; T++)
              (E = L[T]), r.texImage2D(3553, T, S, b, M, E);
            (a.generateMipmaps = !1), (t.__maxMipLevel = L.length - 1);
          } else r.texImage2D(3553, 0, S, b, M, x), (t.__maxMipLevel = 0);
          p(a, _) && u(3553, a, x.width, x.height),
            (t.__version = a.version),
            a.onUpdate && a.onUpdate(a);
        }
        function b(t, i, n, s) {
          var l = o.convert(i.texture.format),
            d = o.convert(i.texture.type),
            c = m(l, d);
          r.texImage2D(s, 0, c, i.width, i.height, 0, l, d, null),
        ...
        function M(t, r, a) {
          if (
            (e.bindRenderbuffer(36161, t), r.depthBuffer && !r.stencilBuffer)
          ) {
            if (a) {
              var i = E(r);
            ...
            var n = o.convert(r.texture.format),
              s = o.convert(r.texture.type),
              l = m(n, s);
            if (a) {
              var i = E(r);
        ...
        function S(t, r) {
          ...
          if (r.depthTexture.format === je.t)
            e.framebufferTexture2D(36160, 36096, 3553, n, 0);
          else if (r.depthTexture.format === je.u)
        ...
        function E(e) {
          return n.isWebGL2 && e.isWebGLMultisampleRenderTarget
            ? Xe(n.maxSamples, e.samples)
            : 0;
        }
        function T(e) {
          var t = e.id,
        ...
        (this.setTexture2D = x),
          (this.setTexture3D = function (e, t) {
            var i = a.get(e);
            return 0 < e.version && i.__version !== e.version
              ? void _(i, e, t)
              : void (r.activeTexture(33984 + t),
                r.bindTexture(32879, i.__webglTexture));
          }),
          (this.setTextureCube = function (t, c) {
            var f = a.get(t);
            if (6 === t.image.length)
              if (0 < t.version && f.__version !== t.version) {
                f.__image__webglTextureCube ||
                  (t.addEventListener("dispose", g),
                  (f.__image__webglTextureCube = e.createTexture()),
                  s.memory.textures++),
                  r.activeTexture(33984 + c),
                  r.bindTexture(34067, f.__image__webglTextureCube),
                  e.pixelStorei(37440, t.flipY);
                for (
                  var h = t && t.isCompressedTexture,
                  ...
                  x[_] =
                    h || v
                      ? v
                        ? t.image[_].image
                        : t.image[_]
                      : l(t.image[_], !1, !0, n.maxCubemapSize);
                var i = x[0],
                  b = d(i) || n.isWebGL2,
                  M = o.convert(t.format),
                  S = o.convert(t.type),
                  L = m(M, S);
                y(34067, t, b);
                for (var _ = 0; 6 > _; _++)
                  if (!h)
                    v
                      ...
                      : r.texImage2D(34069 + _, 0, L, M, S, x[_]);
                  else
                    for (
                      var E = x[_].mipmaps, T = 0, w = E.length, P;
                      T < w;
                      T++
                    )
                      (P = E[T]),
                        t.format !== je.rb && t.format !== je.Nb
                          ? -1 < r.getCompressedTextureFormats().indexOf(M)
                            ? r.compressedTexImage2D(
                                34069 + _,
                                T,
                                L,
                ...
                (f.__maxMipLevel = h ? E.length - 1 : 0),
                  p(t, b) && u(34067, t, i.width, i.height),
          ...
          (this.setTextureCubeDynamic = function (e, t) {
            r.activeTexture(33984 + t),
              r.bindTexture(34067, a.get(e).__webglTexture);
          }),
          (this.setupRenderTarget = function (t) {
            ...
            t.addEventListener("dispose", f),
              ...
              s.memory.textures++;
            var g = !0 === t.isWebGLRenderTargetCube,
              h = !0 === t.isWebGLMultisampleRenderTarget,
              v = d(t) || n.isWebGL2;
            if (g) {
              l.__webglFramebuffer = [];
              for (var x = 0; 6 > x; x++)
                l.__webglFramebuffer[x] = e.createFramebuffer();
              ...
              if (n.isWebGL2) {
                ...
                var i = o.convert(t.texture.format),
                ...
                e.renderbufferStorageMultisample(
                  ...
                  t.depthBuffer &&
                    ...
                    M(l.__webglDepthRenderbuffer, t, !0)),
                  e.bindFramebuffer(36160, null);
              } else
                console.warn(
            ...
            if (g) {
              ...
              for (var x = 0; 6 > x; x++)
                b(l.__webglFramebuffer[x], t, 36064, 34069 + x);
              p(t.texture, v) && u(34067, t.texture, t.width, t.height),
                r.bindTexture(34067, null);
            } else
              r.bindTexture(3553, c.__webglTexture),
                y(3553, t.texture, v),
                b(l.__webglFramebuffer, t, 36064, 3553),
                p(t.texture, v) && u(3553, t.texture, t.width, t.height),
          ...
          (this.updateRenderTargetMipmap = function (e) {
            ...
            if (p(t, i)) {
              var o = e.isWebGLRenderTargetCube ? 34067 : 3553,
                s = a.get(t).__webglTexture;
              r.bindTexture(o, s),
                u(o, t, e.width, e.height),
            ...
            if (t.isWebGLMultisampleRenderTarget)
              if (n.isWebGL2) {
                ...
                t.depthBuffer && (s |= 256),
                  ...
                  e.blitFramebuffer(0, 0, i, o, 0, 0, i, o, s, 9728);
              } else
                console.warn(
                  "THREE.WebGLRenderer: WebGLMultisampleRenderTarget can only be used with WebGL2."
                );
        ...
        return {
          convert: function (e) {
            ...
            if (e === je.H) {
              ...
              if (((a = t.get("OES_texture_half_float")), null !== a))
            ...
            if (
              (e === je.Tb || e === je.Ib || e === je.Jb || e === je.Kb) &&
              ((a = t.get("WEBGL_compressed_texture_s3tc")), null !== a)
            ) {
            ...
            if (
              (e === je.Sb || e === je.Rb || e === je.Hb || e === je.Gb) &&
              ((a = t.get("WEBGL_compressed_texture_pvrtc")), null !== a)
            ) {
            ...
            if (
              e === je.Qb &&
              ((a = t.get("WEBGL_compressed_texture_etc1")), null !== a)
            )
            ...
            if (
              (e === je.yb ||
                ...
                e === je.wb ||
                e === je.xb) &&
              ((a = t.get("WEBGL_compressed_texture_astc")), null !== a)
            )
              return e;
            if (e === je.T || e === je.S) {
              if (r.isWebGL2) {
            ...
            if (e === je.lc) {
              ...
              if (((a = t.get("WEBGL_depth_texture")), null !== a))
      ...
      function Fe(e, t, r) {
        Dt.setFromMatrixPosition(t.matrixWorld),
          Rt.setFromMatrixPosition(r.matrixWorld);
        var a = Dt.distanceTo(Rt),
      ...
      function Ge(e) {
        ...
        function r() {
          if (t()) {
            ...
            (S = e.getPixelRatio()),
              (M = e.getSize()),
              e.setDrawingBufferSize(2 * a, i, 1),
              L.start();
          } else
            o.enabled && e.setDrawingBufferSize(M.width, M.height, S), L.stop();
        }
        function a(e) {
          for (
        ...
        var f = new Qe.a(),
          ...
          v = new et.a(),
          x = new At.a();
        (x.bounds = new ot.a(0, 0, 0.5, 1)), x.layers.enable(1);
        var y = new At.a();
        (y.bounds = new ot.a(0.5, 0, 0.5, 1)), y.layers.enable(2);
        var _ = new Ue([x, y]);
        ...
        (this.enabled = !1),
          ...
          (this.getCamera = function (e) {
            ...
            if (
              ...
              r
                ? p.fromArray(r.sittingToStandingTransform)
                : p.makeTranslation(0, t, 0);
            }
            var a = l.pose,
              i = null === d ? e : d;
            if (
              ...
              null !== a.orientation &&
                (h.fromArray(a.orientation), i.quaternion.multiply(h)),
              null !== a.position &&
                (h.setFromRotationMatrix(p),
                v.fromArray(a.position),
                v.applyQuaternion(h),
                i.position.add(v)),
              i.updateMatrixWorld(),
              !1 === s.isPresenting)
            ...
            var o = i.parent;
            null !== o &&
              (f.getInverse(o.matrixWorld),
              x.matrixWorldInverse.multiply(f),
              y.matrixWorldInverse.multiply(f)),
            ...
            if (c.length) {
              ...
              null !== m.leftBounds &&
                ...
                x.bounds.fromArray(m.leftBounds),
                null !== m.rightBounds &&
                  4 === m.rightBounds.length &&
                  y.bounds.fromArray(m.rightBounds);
            }
            return n(), _;
          }),
        ...
        (this.setAnimationLoop = function (e) {
          ...
          (this.dispose = function () {
            "undefined" != typeof window &&
              window.removeEventListener("vrdisplaypresentchange", r);
          });
      }
      function Oe(e) {
        function t() {
        ...
        function o(e, t) {
          if (((m = t.getDevicePose(p)), null !== m))
            for (var r = d.baseLayer, a = t.views, n = 0; n < a.length; n++) {
              var i = a[n],
                o = r.getViewport(i),
                s = m.getViewMatrix(i),
                l = x.cameras[n];
              l.matrix.fromArray(s).getInverse(l.matrix),
                l.projectionMatrix.fromArray(i.projectionMatrix),
                l.viewport.set(o.x, o.y, o.width, o.height),
                0 === n && x.matrix.copy(l.matrix);
            }
          for (var n = 0; n < g.length; n++) {
            ...
            if (u) {
              ...
              if (null !== h) {
                "targetRay" in h
                  ? (c.matrix.elements = h.targetRay.transformMatrix)
                  : "pointerMatrix" in h &&
                    (c.matrix.elements = h.pointerMatrix),
        ...
        x.layers.enable(1),
          ...
          (this.setDevice = function (e) {
            void 0 !== e && (l = e),
              e instanceof XRDevice && s.setCompatibleXRDevice(e);
          }),
          (this.setFramebufferScaleFactor = function (e) {
            c = e;
          }),
          ...
          (this.setSession = function (t) {
            (d = t),
              null !== d &&
                ...
                d.addEventListener("selectstart", r),
                d.addEventListener("selectend", r),
                d.addEventListener("end", a),
                (d.baseLayer = new XRWebGLLayer(d, s, {
                  framebufferScaleFactor: c,
                })),
                d.requestFrameOfReference(u).then(function (t) {
                  (p = t),
                    e.setFramebuffer(d.baseLayer.framebuffer),
                    _.setContext(d),
                    _.start();
                }),
                (f = d.getInputSources()),
                d.addEventListener("inputsourceschange", function () {
                  (f = d.getInputSources()), console.log(f);
                  for (var e = 0, t; e < g.length; e++)
                    (t = g[e]), (t.userData.inputSource = f[e]);
                }));
          }),
          (this.getCamera = function (e) {
            if (t()) {
      ...
      function Be(e) {
        ...
        function r() {
          (He = new u(Fe)),
            (ke = new c(Fe, He, e)),
            ke.isWebGL2 ||
              (He.get("WEBGL_depth_texture"),
              He.get("OES_texture_float"),
              He.get("OES_texture_half_float"),
              He.get("OES_texture_half_float_linear"),
              He.get("OES_standard_derivatives"),
              He.get("OES_element_index_uint"),
              He.get("ANGLE_instanced_arrays")),
            He.get("OES_texture_float_linear"),
            (ft = new ze(Fe, He, ke)),
            (We = new Ne(Fe, He, ft, ke)),
            We.scissor(ge.copy(Se).multiplyScalar(be)),
            We.viewport(me.copy(Me).multiplyScalar(be)),
            (Je = new f(Fe)),
            (Ke = new _e()),
            (tt = new Ie(Fe, He, We, Ke, ke, ft, Je)),
            (rt = new n(Fe)),
            (at = new m(Fe, rt, Je)),
            (st = new x(at, Je)),
            (ut = new v(Fe)),
            ...
            (ct = new Pe()),
            (pt = new l(ie, We, st, K)),
            (mt = new d(Fe, He, Je, ke)),
            (gt = new g(Fe, He, Je, ke)),
            (Je.programs = lt.programs),
            (ie.context = Fe),
            (ie.capabilities = ke),
            (ie.extensions = He),
            (ie.properties = Ke),
        ...
        function M(e, t, r) {
          if (
            r &&
            r.isInstancedBufferGeometry & !ke.isWebGL2 &&
            null === He.get("ANGLE_instanced_arrays")
          )
            return void console.error(
              ...
              if (void 0 !== l) {
                ...
                if (l.isInterleavedBufferAttribute) {
                  ...
                  f && f.isInstancedInterleavedBuffer
                    ? (We.enableAttributeAndDivisor(s, f.meshPerAttribute),
                      void 0 === r.maxInstancedCount &&
                        (r.maxInstancedCount = f.meshPerAttribute * f.count))
                    : We.enableAttribute(s),
                    Fe.bindBuffer(34962, u),
                    Fe.vertexAttribPointer(s, c, m, d, h * g, v * g);
                } else
                  l.isInstancedBufferAttribute
                    ? (We.enableAttributeAndDivisor(s, l.meshPerAttribute),
                      void 0 === r.maxInstancedCount &&
                        (r.maxInstancedCount = l.meshPerAttribute * l.count))
                    : We.enableAttribute(s),
                    Fe.bindBuffer(34962, u),
                    Fe.vertexAttribPointer(s, c, m, d, 0, 0);
              } else if (void 0 !== n) {
                var x = n[o];
                if (void 0 !== x)
                  switch (x.length) {
          ...
          if (!1 !== e.visible) {
            ...
            if (n)
              if (e.isGroup) r = e.renderOrder;
                ...
                re.pushLight(e), e.castShadow && re.pushShadow(e);
              else if (e.isSprite) {
                ...
                a && Ue.setFromMatrixPosition(e.matrixWorld).applyMatrix4(De),
                  te.push(e, null, e.material, r, Ue.z, null);
              else if (
                ...
                var o = st.update(e),
                  s = e.material;
                if (Array.isArray(s))
                  for (var d = o.groups, c = 0, i = d.length; c < i; c++) {
                    var l = d[c],
                      p = s[l.materialIndex];
            ...
            for (var u = e.children, c = 0, i = u.length; c < i; c++)
              L(u[c], t, r, a);
          }
        }
        function E(e, t, r, a) {
          for (var n = 0, i = e.length; n < i; n++) {
            var o = e[n],
              s = o.object,
              l = o.geometry,
              d = void 0 === a ? o.material : a,
              c = o.group;
            if (r.isArrayCamera) {
              ue = r;
              for (var p = r.cameras, u = 0, m = p.length, g; u < m; u++)
                if (((g = p[u]), s.layers.test(g.layers))) {
                  if ("viewport" in g) We.viewport(me.copy(g.viewport));
                  else {
                    var f = g.bounds,
                      h = f.x * ve,
                      v = f.y * xe,
        ...
        function w(e, t, r) {
          var a = Ke.get(e),
            ...
            c = lt.getProgramCode(e, d),
            p = a.program,
            u = !0;
          if (void 0 === p) e.addEventListener("dispose", h);
          else if (p.code !== c) _(e);
          else if (
            s.stateID !== l.stateID ||
            s.directionalLength !== l.directionalLength ||
            s.pointLength !== l.pointLength ||
            s.spotLength !== l.spotLength ||
            s.rectAreaLength !== l.rectAreaLength ||
            s.hemiLength !== l.hemiLength ||
            s.shadowsLength !== l.shadowsLength
          )
            (s.stateID = l.stateID),
              (s.directionalLength = l.directionalLength),
              (s.pointLength = l.pointLength),
          ...
          if (u) {
            ...
            e.onBeforeCompile(a.shader, ie),
              (c = lt.getProgramCode(e, d)),
              (p = lt.acquireProgram(e, a.shader, d, c)),
              (a.program = p),
              (e.program = p);
          }
          ...
          if (e.morphTargets) {
            ...
            for (var f = 0; f < ie.maxMorphTargets; f++)
              0 <= g["morphTarget" + f] && e.numSupportedMorphTargets++;
          }
          if (e.morphNormals) {
            e.numSupportedMorphNormals = 0;
            for (var f = 0; f < ie.maxMorphNormals; f++)
              0 <= g["morphNormal" + f] && e.numSupportedMorphNormals++;
          }
          var i = a.shader.uniforms;
          ((e.isShaderMaterial || e.isRawShaderMaterial) &&
            !0 !== e.clipping) ||
            ((a.numClippingPlanes = we.numPlanes),
            (a.numIntersection = we.numIntersection),
            (i.clippingPlanes = we.uniform)),
            (a.fog = t),
            void 0 === s && (a.lightsHash = s = {}),
            (s.stateID = l.stateID),
            (s.directionalLength = l.directionalLength),
            (s.pointLength = l.pointLength),
            (s.spotLength = l.spotLength),
            ...
            (s.shadowsLength = l.shadowsLength),
            e.lights &&
              ((i.ambientLightColor.value = n.state.ambient),
              (i.directionalLights.value = n.state.directional),
              (i.spotLights.value = n.state.spot),
              (i.rectAreaLights.value = n.state.rectArea),
              (i.pointLights.value = n.state.point),
              (i.hemisphereLights.value = n.state.hemi),
              (i.directionalShadowMap.value = n.state.directionalShadowMap),
              (i.directionalShadowMatrix.value =
                n.state.directionalShadowMatrix),
              (i.spotShadowMap.value = n.state.spotShadowMap),
              (i.spotShadowMatrix.value = n.state.spotShadowMatrix),
              (i.pointShadowMap.value = n.state.pointShadowMap),
              (i.pointShadowMatrix.value = n.state.pointShadowMatrix));
          var v = a.program.getUniforms(),
            x = ae.seqWithValue(v.seq, i);
          a.uniformsList = x;
        }
        function P(e, t, r, i) {
          he = 0;
          ...
          !1 === r.needsUpdate &&
            (void 0 === n.program
              ...
              : void 0 !== n.numClippingPlanes &&
                (n.numClippingPlanes !== we.numPlanes ||
                  n.numIntersection !== we.numIntersection) &&
                (r.needsUpdate = !0)),
            r.needsUpdate && (w(r, t, i), (r.needsUpdate = !1));
          var c = !1,
            p = !1,
            u = !1,
            m = n.program,
            ...
            f = n.shader.uniforms;
          if (
            (We.useProgram(m.program) && ((c = !0), (p = !0), (u = !0)),
            r.id !== de && ((de = r.id), (p = !0)),
            c || pe !== e)
          ) {
            if (
              (g.setValue(Fe, "projectionMatrix", e.projectionMatrix),
              ke.logarithmicDepthBuffer &&
                g.setValue(Fe, "logDepthBufFC", 2 / (Ve(e.far + 1) / Math.LN2)),
              pe !== e && ((pe = e), (p = !0), (u = !0)),
              r.isShaderMaterial ||
              ...
              void 0 !== h &&
                h.setValue(Fe, Ue.setFromMatrixPosition(e.matrixWorld));
            }
            (r.isMeshPhongMaterial ||
              ...
              r.isShaderMaterial ||
              r.skinning) &&
              g.setValue(Fe, "viewMatrix", e.matrixWorldInverse);
          }
          if (r.skinning) {
            g.setOptional(Fe, i, "bindMatrix"),
              g.setOptional(Fe, i, "bindMatrixInverse");
            var v = i.skeleton;
            if (v) {
              var x = v.bones;
              if (ke.floatVertexTextures) {
                ...
                g.setValue(Fe, "boneTexture", v.boneTexture),
                  g.setValue(Fe, "boneTextureSize", v.boneTextureSize);
              } else g.setOptional(Fe, v, "boneMatrices");
            }
          }
          return (
            p &&
              (g.setValue(Fe, "toneMappingExposure", ie.toneMappingExposure),
              g.setValue(Fe, "toneMappingWhitePoint", ie.toneMappingWhitePoint),
              r.lights && W(f, u),
              t && r.fog && I(f, t),
              r.isMeshBasicMaterial
                ? C(f, r)
                ...
                ? (C(f, r), z(f, r))
                : r.isMeshPhongMaterial
                ? (C(f, r), r.isMeshToonMaterial ? F(f, r) : U(f, r))
                : r.isMeshStandardMaterial
                ? (C(f, r), r.isMeshPhysicalMaterial ? O(f, r) : G(f, r))
                ...
                ? (A(f, r), r.isLineDashedMaterial && D(f, r))
                : r.isPointsMaterial
                ? R(f, r)
                : r.isSpriteMaterial
                ? N(f, r)
              ...
              void 0 !== f.ltc_1 && (f.ltc_1.value = it.LTC_1),
              void 0 !== f.ltc_2 && (f.ltc_2.value = it.LTC_2),
              ae.upload(Fe, n.uniformsList, f, ie)),
            r.isShaderMaterial &&
              !0 === r.uniformsNeedUpdate &&
              (ae.upload(Fe, n.uniformsList, f, ie),
              (r.uniformsNeedUpdate = !1)),
            r.isSpriteMaterial && g.setValue(Fe, "center", i.center),
            g.setValue(Fe, "modelViewMatrix", i.modelViewMatrix),
            g.setValue(Fe, "normalMatrix", i.normalMatrix),
            g.setValue(Fe, "modelMatrix", i.matrixWorld),
            m
          );
        }
        function C(e, t) {
          (e.opacity.value = t.opacity),
            ...
            t.envMap &&
              ...
              (e.maxMipLevel.value = Ke.get(t.envMap).__maxMipLevel)),
            t.lightMap &&
        ...
        function U(e, t) {
          (e.specular.value = t.specular),
            (e.shininess.value = qe(t.shininess, 1e-4)),
            t.emissiveMap && (e.emissiveMap.value = t.emissiveMap),
            t.bumpMap &&
              ((e.bumpMap.value = t.bumpMap),
              (e.bumpScale.value = t.bumpScale),
              t.side === je.g && (e.bumpScale.value *= -1)),
            t.normalMap &&
              ((e.normalMap.value = t.normalMap),
              e.normalScale.value.copy(t.normalScale),
              t.side === je.g && e.normalScale.value.negate()),
            t.displacementMap &&
        ...
        var X =
            void 0 === e.canvas
              ...
              : e.canvas,
          j = void 0 === e.context ? null : e.context,
          ...
          ee = void 0 === e.powerPreference ? "default" : e.powerPreference,
          te = null,
          re = null;
        (this.domElement = X),
          (this.context = null),
        ...
        var ie = this,
          ...
          le = null,
          de = -1,
          ce = { geometry: null, program: null, wireframe: !1 },
          pe = null,
          ue = null,
          me = new ot.a(),
          ge = new ot.a(),
          ...
          xe = X.height,
          be = 1,
          Me = new ot.a(0, 0, ve, xe),
          Se = new ot.a(0, 0, ve, xe),
          Ee = !1,
          Te = new Ze.a(),
          we = new p(),
          Ce = !1,
        ...
        try {
          ...
          if (
            ...
            X.addEventListener("webglcontextrestored", s, !1),
            (Fe =
              j ||
              X.getContext("webgl", Be) ||
              X.getContext("experimental-webgl", Be)),
            null === Fe)
          )
        ...
        "undefined" != typeof navigator &&
          (ht = "xr" in navigator ? new Oe(ie) : new Ge(ie)),
          (this.vr = ht);
        ...
        (this.shadowMap = vt),
          ...
          (this.setSize = function (e, t, r) {
            return ht.isPresenting()
              ...
              : void ((ve = e),
                ...
                (X.height = t * be),
                !1 !== r &&
                  ((X.style.width = e + "px"), (X.style.height = t + "px")),
          ...
          (this.dispose = function () {
            X.removeEventListener("webglcontextlost", o, !1),
              X.removeEventListener("webglcontextrestored", s, !1),
              dt.dispose(),
              ct.dispose(),
              Ke.dispose(),
              st.dispose(),
          ...
          (this.renderBufferImmediate = function (e, t) {
            We.initAttributes();
            var r = Ke.get(e);
            e.hasPositions && !r.position && (r.position = Fe.createBuffer()),
              e.hasNormals && !r.normal && (r.normal = Fe.createBuffer()),
              e.hasUvs && !r.uv && (r.uv = Fe.createBuffer()),
              e.hasColors && !r.color && (r.color = Fe.createBuffer());
            var a = t.getAttributes();
            e.hasPositions &&
              (Fe.bindBuffer(34962, r.position),
              Fe.bufferData(34962, e.positionArray, 35048),
              We.enableAttribute(a.position),
              Fe.vertexAttribPointer(a.position, 3, 5126, !1, 0, 0)),
              e.hasNormals &&
                (Fe.bindBuffer(34962, r.normal),
                Fe.bufferData(34962, e.normalArray, 35048),
                We.enableAttribute(a.normal),
                Fe.vertexAttribPointer(a.normal, 3, 5126, !1, 0, 0)),
              e.hasUvs &&
                (Fe.bindBuffer(34962, r.uv),
                Fe.bufferData(34962, e.uvArray, 35048),
                We.enableAttribute(a.uv),
                Fe.vertexAttribPointer(a.uv, 2, 5126, !1, 0, 0)),
              e.hasColors &&
                (Fe.bindBuffer(34962, r.color),
                Fe.bufferData(34962, e.colorArray, 35048),
                We.enableAttribute(a.color),
                Fe.vertexAttribPointer(a.color, 3, 5126, !1, 0, 0)),
              We.disableUnusedAttributes(),
              Fe.drawArrays(4, 0, e.count),
              (e.count = 0);
          }),
          (this.renderBufferDirect = function (e, r, a, i, n, o) {
            ...
            (ce.geometry !== a.id ||
              ce.program !== l.id ||
              ce.wireframe !== (!0 === i.wireframe)) &&
              ((ce.geometry = a.id),
              (ce.program = l.id),
              (ce.wireframe = !0 === i.wireframe),
              (d = !0)),
              n.morphTargetInfluences && (ut.update(n, a, i, l), (d = !0));
            var c = a.index,
            ...
            var m = mt,
              g;
            null !== c && ((g = rt.get(c)), (m = gt), m.setIndex(g)),
              d && (M(i, l, a), null !== c && Fe.bindBuffer(34963, g.buffer));
            var f = Infinity;
            null === c ? void 0 !== p && (f = p.count) : (f = c.count);
            var h = a.drawRange.start * u,
              v = a.drawRange.count * u,
              x = null === o ? 0 : o.start * u,
              y = null === o ? Infinity : o.count * u,
              _ = qe(h, x),
              b = Xe(f, h + v, x + y) - 1,
              S = qe(0, b - _ + 1);
            if (0 !== S) {
              if (n.isMesh) {
                if (!0 === i.wireframe)
                  We.setLineWidth(i.wireframeLinewidth * t()), m.setMode(1);
                else
                  switch (n.drawMode) {
                    case je.hc:
                      m.setMode(4);
              ...
              a && a.isInstancedBufferGeometry
                ? 0 < a.maxInstancedCount && m.renderInstances(a, _, S)
                : m.render(_, S);
            }
          }),
                ...
                if (t.material)
                  if (Array.isArray(t.material))
                    for (var r = 0; r < t.material.length; r++)
                      w(t.material[r], e.fog, t);
                  else w(t.material, e.fog, t);
              });
          });
        var xt = null,
          yt = new i();
        yt.setAnimationLoop(S),
          ...
          (this.render = function (e, t, r, a) {
            ...
            if (!ne) {
              (ce.geometry = null),
                ...
                ht.enabled && (t = ht.getCamera(t)),
                (re = ct.get(e, t)),
                re.init(),
                e.onBeforeRender(ie, e, t, r),
                De.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
                Te.setFromMatrix(De),
                (Ae = this.localClippingEnabled),
                (Ce = we.init(this.clippingPlanes, Ae, t)),
                (te = dt.get(e, t)),
                te.init(),
                L(e, t, 0, ie.sortObjects),
                !0 === ie.sortObjects && te.sort(),
                Ce && we.beginShadows();
              ...
              r &&
                ...
                e.onAfterRender(ie, e, t),
                ht.enabled && ht.submitFrame(),
                (te = null),
                (re = null);
            }
          }),
          (this.allocTextureUnit = q),
            ...
            return function (t, r) {
              t &&
                ...
                (Array.isArray(t.image) && 6 === t.image.length)
                  ? tt.setTextureCube(t, r)
                  : tt.setTextureCubeDynamic(t, r);
            };
          })()),
          ...
          (this.setRenderTarget = function (e) {
            (se = e),
              e &&
                void 0 === Ke.get(e).__webglFramebuffer &&
                tt.setupRenderTarget(e);
            var t = oe,
              r = !1;
            if (e) {
              var a = Ke.get(e).__webglFramebuffer;
              e.isWebGLRenderTargetCube
                ? ((t = a[e.activeCubeFace]), (r = !0))
                : e.isWebGLMultisampleRenderTarget
                ? (t = Ke.get(e).__webglMultisampledFramebuffer)
                : (t = a),
                me.copy(e.viewport),
                ge.copy(e.scissor),
                (fe = e.scissorTest);
            } else
              me.copy(Me).multiplyScalar(be),
                ge.copy(Se).multiplyScalar(be),
                (fe = Ee);
            if (
              (le !== t && (Fe.bindFramebuffer(36160, t), (le = t)),
              We.viewport(me),
              We.scissor(ge),
              We.setScissorTest(fe),
              r)
            ) {
            ...
            if (o) {
              ...
              try {
                var l = e.texture,
                  d = l.format,
                  c = l.type;
                if (d !== je.rb && ft.convert(d) !== Fe.getParameter(35739))
                  return void console.error(
                    "THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format."
                  );
                if (
                  c !== je.kc &&
                  ft.convert(c) !== Fe.getParameter(35738) &&
                  !(
                    c === je.C &&
                    (ke.isWebGL2 ||
                      He.get("OES_texture_float") ||
                      He.get("WEBGL_color_buffer_float"))
                  ) &&
                  !(
                    c === je.H &&
                    (ke.isWebGL2
                      ? He.get("EXT_color_buffer_float")
                      : He.get("EXT_color_buffer_half_float"))
                  )
                )
                  return void console.error(
                    "THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type."
                  );
                36053 === Fe.checkFramebufferStatus(36160)
                  ? 0 <= t &&
                    t <= e.width - a &&
                    0 <= r &&
                    r <= e.height - i &&
                    Fe.readPixels(t, r, a, i, ft.convert(d), ft.convert(c), n)
                  : console.error(
          ...
          (this.copyFramebufferToTexture = function (e, t, r) {
            var a = t.image.width,
              i = t.image.height,
              n = ft.convert(t.format);
            this.setTexture2D(t, 0),
              Fe.copyTexImage2D(3553, r || 0, n, e.x, e.y, a, i, 0);
          }),
          (this.copyTextureToTexture = function (e, t, r, a) {
            var i = t.image.width,
              n = t.image.height,
              o = ft.convert(r.format),
              s = ft.convert(r.type);
            this.setTexture2D(r, 0),
              t.isDataTexture
                ...
                : Fe.texSubImage2D(3553, a || 0, e.x, e.y, o, s, t.image);
          });
      }
      var Ve = Math.log,
        He = Math.floor,
        ...
        Ye = r("MnML"),
        Je = r("xvF/");
      (a.prototype = Object.create(Je.a.prototype)),
        (a.prototype.constructor = a),
        (a.prototype.isDataTexture = !0);
      var Ze = r("LxkE"),
        Qe = r("3+m9"),
        Ke = {
          alphamap_fragment:
        ...
        it = {
          ...
          normalmap: {
            ...
            normalScale: { value: new rt.a(1, 1) },
          },
          displacementmap: {
        ...
        nt = {
          ...
          shadow: {
            uniforms: Object($e.b)([
              it.lights,
              it.fog,
              { color: { value: new tt.a(0) }, opacity: { value: 1 } },
            ]),
      ...
      var ot = r("CNRw"),
        ...
        lt = r("zfxg"),
        dt = r("nKeq");
      (o.prototype = Object.create(st.a.prototype)),
        (o.prototype.constructor = o),
        (s.prototype = Object.create(lt.a.prototype)),
        (s.prototype.constructor = s);
      var ct = r("XPv6"),
        pt = r("dt5g"),
        ut = r("Ncdj"),
        mt = r("GuLh"),
        gt = r("Qeq/");
      (y.prototype = Object.create(Je.a.prototype)),
        (y.prototype.constructor = y),
        (y.prototype.isCubeTexture = !0),
        Object.defineProperty(y.prototype, "images", {
          get: function () {
            return this.image;
          },
          set: function (e) {
        ...
        (_.prototype = Object.create(Je.a.prototype)),
        (_.prototype.constructor = _),
        (_.prototype.isDataTexture3D = !0);
      var ft = new Je.a(),
        ht = new _(),
        vt = new y(),
        xt = [],
      ...
      ($.prototype.updateCache = function (e) {
        ...
        (ee.prototype.setValue = function (e, t, r) {
          for (var a = this.seq, o = 0, i = a.length, n; o !== i; ++o)
            (n = a[o]), n.setValue(e, t[n.id], r);
        });
      var St = /([\w\d_]+)(\])?(\[|\.)?/g;
      (ae.prototype.setValue = function (e, t, r) {
        ...
        (ae.seqWithValue = function (e, t) {
          for (var a = [], r = 0, i = e.length, n; r !== i; ++r)
            (n = e[r]), n.id in t && a.push(n);
          return a;
        });
      var Lt = 0,
        Et = 0,
      ...
      var wt = r("9eRv");
      (Ae.prototype = Object.create(wt.a.prototype)),
        (Ae.prototype.constructor = Ae),
        (Ae.prototype.isMeshDepthMaterial = !0),
        (Ae.prototype.copy = function (e) {
          return (
            wt.a.prototype.copy.call(this, e),
        ...
        (De.prototype = Object.create(wt.a.prototype)),
        (De.prototype.constructor = De),
        (De.prototype.isMeshDistanceMaterial = !0),
      ...
      var Pt = r("qdxW"),
        Ct = r("breI"),
        At = r("+8Os");
      Ue.prototype = Object.assign(Object.create(At.a.prototype), {
        constructor: Ue,
        isArrayCamera: !0,
      });
      var Dt = new et.a(),
      ...
      Object.assign(a.prototype, {
        ...
        setFromMatrix: function (e) {
          var t = this.planes,
            ...
            x = r[15];
          return (
            t[0].setComponents(o - a, c - s, g - p, x - f).normalize(),
            t[1].setComponents(o + a, c + s, g + p, x + f).normalize(),
            t[2].setComponents(o + i, c + l, g + u, x + h).normalize(),
            t[3].setComponents(o - i, c - l, g - u, x - h).normalize(),
            t[4].setComponents(o - n, c - d, g - m, x - v).normalize(),
            t[5].setComponents(o + n, c + d, g + m, x + v).normalize(),
            this
          );
        },
        ...
        intersectsSphere: function (e) {
          for (
            var t = this.planes, r = e.center, a = -e.radius, n = 0, i;
            6 > n;
            n++
          )
            if (((i = t[n].distanceToPoint(r)), i < a)) return !1;
          return !0;
        },
        intersectsBox: (function () {
          var e = new i.a();
          return function (t) {
            for (var r = this.planes, a = 0, i; 6 > a; a++)
              if (
                ((i = r[a]),
                (e.x = 0 < i.normal.x ? t.max.x : t.min.x),
                (e.y = 0 < i.normal.y ? t.max.y : t.min.y),
                (e.z = 0 < i.normal.z ? t.max.z : t.min.z),
                0 > i.distanceToPoint(e))
              )
                return !1;
            return !0;
          };
      ...
      var l = {
        ...
        generateUUID: (function () {
          for (var e = [], t = 0; 256 > t; t++)
            e[t] = (16 > t ? "0" : "") + t.toString(16);
          return function () {
            var t = 0 | (4294967295 * Math.random()),
              r = 0 | (4294967295 * Math.random()),
    ...
    Ncdj: function (e, t, r) {
      "use strict";
      function i(e, t, r) {
        (this.a = void 0 === e ? new l.a() : e),
          (this.b = void 0 === t ? new l.a() : t),
          (this.c = void 0 === r ? new l.a() : r);
      }
      function a(e, t) {
        m.a.call(this),
          (this.type = "Mesh"),
          (this.geometry = void 0 === e ? new v.a() : e),
          (this.material =
            void 0 === t ? new h.a({ color: 16777215 * Math.random() }) : t),
          (this.drawMode = f.hc),
      ...
      Object.assign(i, {
        ...
        getUV: (function () {
          ...
          return function (t, r, a, i, n, o, s, l) {
            return (
              this.getBarycoord(t, r, a, i, e),
              l.set(0, 0),
              l.addScaledVector(n, e.x),
              l.addScaledVector(o, e.y),
              l.addScaledVector(s, e.z),
              l
            );
          };
        })(),
        ...
        Object.assign(i.prototype, {
          ...
          setFromPointsAndIndices: function (e, t, r, a) {
            return (
              this.a.copy(e[t]), this.b.copy(e[r]), this.c.copy(e[a]), this
            );
          },
          clone: function () {
            return new this.constructor().copy(this);
          ...
          closestPointToPoint: (function () {
            ...
            return function (s, d) {
              ...
              var x = g * v - h * f;
              if (0 >= x && 0 <= g && 0 >= h)
                return (c = g / (g - h)), d.copy(p).addScaledVector(e, c);
              o.subVectors(s, u);
              var y = e.dot(o),
                _ = t.dot(o);
              ...
              var b = y * f - g * _;
              if (0 >= b && 0 <= f && 0 >= _)
                return (m = f / (f - _)), d.copy(p).addScaledVector(t, m);
              var M = h * _ - y * v;
              if (0 >= M && 0 <= v - h && 0 <= y - _)
                return (
                  r.subVectors(u, a),
                  (m = (v - h) / (v - h + (y - _))),
                  d.copy(a).addScaledVector(r, m)
                );
              var S = 1 / (M + b + x);
              return (
                (c = b * S),
                (m = x * S),
                d.copy(p).addScaledVector(e, c).addScaledVector(t, m)
              );
            };
          })(),
          equals: function (e) {
      ...
      r.d(t, "a", function () {
        ...
        (a.prototype = Object.assign(Object.create(m.a.prototype), {
          ...
          copy: function (e) {
            return (
              m.a.prototype.copy.call(this, e),
                ...
                if (void 0 !== o)
                  for (
                    ...
                    (a = o[t].name || t + ""),
                      ...
                      (this.morphTargetDictionary[a] = t);
              }
            } else {
          ...
          raycast: (function () {
            function e(e, t, r, a, i, n, o, s) {
              ...
              if (
                ((l =
                  t.side === f.g
                    ? a.intersectTriangle(o, n, i, !0, s)
                    : a.intersectTriangle(i, n, o, t.side !== f.v, s)),
                null === l)
              )
                return null;
              ...
              return d < r.near || d > r.far
                ? null
                : { distance: d, point: T.clone(), object: e };
            }
            function t(t, r, n, o, s, l, p, a, u) {
              v.fromBufferAttribute(s, p),
                x.fromBufferAttribute(s, a),
                y.fromBufferAttribute(s, u);
              var c = e(t, r, n, o, v, x, y, E);
              if (c) {
                l &&
                  (M.fromBufferAttribute(l, p),
                  S.fromBufferAttribute(l, a),
                  L.fromBufferAttribute(l, u),
                  (c.uv = i.getUV(E, v, x, y, M, S, L, new d.a())));
                var m = new g.a(p, a, u);
            ...
            return function (l, p) {
              ...
              if (
                ...
                h.copy(u.boundingSphere),
                h.applyMatrix4(T),
                !1 !== l.ray.intersectsSphere(h)) &&
                (r.getInverse(T),
                m.copy(l.ray).applyMatrix4(r),
                null === u.boundingBox || !1 !== m.intersectsBox(u.boundingBox))
              ) {
                var w;
                      ...
                      for (c = 0, F = D.length; c < F; c++)
                        for (
                          O = D[c],
                            B = g[O.materialIndex],
                            V = o(O.start, R.start),
                            H = s(O.start + O.count, R.start + R.count),
                            ((U = V), (G = H));
                          U < G;
                          U += 3
                        )
                          (N = P.getX(U)),
                            (I = P.getX(U + 1)),
                            (z = P.getX(U + 2)),
                            (w = t(this, B, l, m, C, A, N, I, z)),
                            w &&
                              ((w.faceIndex = n(U / 3)),
                              (w.face.materialIndex = O.materialIndex),
                              p.push(w));
                    else
                      for (
                        V = o(0, R.start),
                          H = s(P.count, R.start + R.count),
                          ((c = V), (F = H));
                        c < F;
                        c += 3
                      )
                        (N = P.getX(c)),
                          (I = P.getX(c + 1)),
                          (z = P.getX(c + 2)),
                          (w = t(this, g, l, m, C, A, N, I, z)),
                          w && ((w.faceIndex = n(c / 3)), p.push(w));
                  } else if (void 0 !== C)
                    if (Array.isArray(g))
                      for (c = 0, F = D.length; c < F; c++)
                        for (
                  ...
                  for (var Q = 0, f = q.length; Q < f; Q++) {
                    ...
                    if (void 0 !== $) {
                      if (
                        ...
                        var ee = u.morphTargets,
                          te = this.morphTargetInfluences;
                        v.set(0, 0, 0), x.set(0, 0, 0), y.set(0, 0, 0);
                        for (var re = 0, ae = ee.length, ie; re < ae; re++)
                          if (((ie = te[re]), 0 !== ie)) {
                            var ne = ee[re].vertices;
                            v.addScaledVector(a.subVectors(ne[K.a], j), ie),
                              x.addScaledVector(_.subVectors(ne[K.b], Y), ie),
                              y.addScaledVector(b.subVectors(ne[K.c], J), ie);
                          }
                      ...
                      if (((w = e(this, $, l, m, j, Y, J, E)), w)) {
                        if (Z && Z[Q]) {
                          ...
                          M.copy(oe[0]),
                            S.copy(oe[1]),
                            L.copy(oe[2]),
                            (w.uv = i.getUV(E, j, Y, J, M, S, L, new d.a()));
                        }
    ...
    "Qeq/": function (e, t, r) {
      ...
      function a(e) {
        ...
        for (var t = e[0], r = 1, a = e.length; r < a; ++r)
          e[r] > t && (t = e[r]);
        return t;
      }
      r.d(t, "a", function () {
        ...
        Object.assign(a.prototype, {
          ...
          applyMatrix3: function (t) {
            var r = this.x,
              ...
              i = t.elements;
            return (
              (this.x = i[0] * r + i[3] * a + i[6]),
              (this.y = i[1] * r + i[4] * a + i[7]),
              this
            );
          },
          min: function (e) {
          ...
          clamp: function (e, t) {
            return (
              (this.x = d(e.x, c(t.x, this.x))),
              (this.y = d(e.y, c(t.y, this.y))),
              this
            );
          },
          clampScalar: (function () {
    ...
    UKne: function (e, t, r) {
      "use strict";
      function a() {
        Object.defineProperty(this, "id", { value: (h += 2) }),
      ...
      a.prototype = Object.assign(Object.create(i.a.prototype), {
        ...
        applyMatrix: function (e) {
          for (
            var t = new s.a().getNormalMatrix(e),
              r = 0,
            ...
            var n =
              ...
              s =
                void 0 === l
                  ? []
                  : [
                      new p.a().fromArray(l, 3 * e),
                      new p.a().fromArray(l, 3 * t),
                      new p.a().fromArray(l, 3 * a),
                    ],
              c = new o.a(e, t, a, s, n, i);
            r.faces.push(c),
              void 0 !== g &&
                r.faceVertexUvs[0].push([
                  new u.a().fromArray(g, 2 * e),
                  new u.a().fromArray(g, 2 * t),
                  new u.a().fromArray(g, 2 * a),
                ]),
              void 0 !== f &&
                r.faceVertexUvs[1].push([
                  new u.a().fromArray(f, 2 * e),
                  new u.a().fromArray(f, 2 * t),
                  new u.a().fromArray(f, 2 * a),
                ]);
          }
          var r = this,
            a = null === e.index ? void 0 : e.index.array,
            n = e.attributes,
            s = n.position.array,
            l = void 0 === n.normal ? void 0 : n.normal.array,
            d = void 0 === n.color ? void 0 : n.color.array,
            g = void 0 === n.uv ? void 0 : n.uv.array,
            f = void 0 === n.uv2 ? void 0 : n.uv2.array;
          void 0 !== f && (this.faceVertexUvs[1] = []);
          for (var c = 0, i = 0; c < s.length; c += 3, i += 2)
            r.vertices.push(new p.a().fromArray(s, c)),
              void 0 !== d && r.colors.push(new m.a().fromArray(d, c));
          var h = e.groups;
          if (0 < h.length)
            for (var c = 0; c < h.length; c++)
              for (
                var v = h[c], x = v.start, y = v.count, i = x;
                i < x + y;
                i += 3
              )
                void 0 === a
                  ? t(i, i + 1, i + 2, v.materialIndex)
                  : t(a[i], a[i + 1], a[i + 2], v.materialIndex);
          else if (void 0 !== a)
            for (var c = 0; c < a.length; c += 3) t(a[c], a[c + 1], a[c + 2]);
          else for (var c = 0; c < s.length / 3; c += 3) t(c, c + 1, c + 2);
          return (
        ...
        computeFaceNormals: function () {
          for (
            var e = new p.a(), t = new p.a(), r = 0, a = this.faces.length;
            r < a;
            r++
          ) {
            var i = this.faces[r],
        ...
        computeVertexNormals: function (e) {
          ...
          var t, r, a, i, n, o;
          for (
            o = Array(this.vertices.length), t = 0, r = this.vertices.length;
            t < r;
            t++
          )
            o[t] = new p.a();
          if (e) {
            ...
            for (
              this.computeFaceNormals(), a = 0, i = this.faces.length;
              a < i;
              a++
            )
              (n = this.faces[a]),
          ...
          for (a = 0, i = this.faces.length; a < i; a++) {
            ...
            3 === m.length
              ? (m[0].copy(o[n.a]), m[1].copy(o[n.b]), m[2].copy(o[n.c]))
              : ((m[0] = o[n.a].clone()),
                (m[1] = o[n.b].clone()),
                (m[2] = o[n.c].clone()));
          }
        ...
        computeFlatVertexNormals: function () {
          ...
          for (
            ...
            3 === a.length
              ? (a[0].copy(r.normal), a[1].copy(r.normal), a[2].copy(r.normal))
              : ((a[0] = r.normal.clone()),
                (a[1] = r.normal.clone()),
                (a[2] = r.normal.clone()));
          }
        ...
        computeMorphNormals: function () {
          ...
          for (
            ...
            if (!this.morphNormals[e]) {
              ...
              for (r = 0, i = this.faces.length; r < i; r++)
                (d = new p.a()),
                  (c = { a: new p.a(), b: new p.a(), c: new p.a() }),
                  s.push(d),
                  l.push(c);
            }
        ...
        computeBoundingBox: function () {
          null === this.boundingBox && (this.boundingBox = new d.a()),
        ...
        merge: function (e, t, r) {
          ...
          var a = this.vertices.length,
            ...
            f;
          void 0 === r && (r = 0),
            void 0 !== t && (f = new s.a().getNormalMatrix(t));
          ...
          for (h = 0, i = c.length; h < i; h++) {
            var y = c[h],
              ...
              S,
              L;
            (M = new o.a(y.a + a, y.b + a, y.c + a)),
              M.normal.copy(y.normal),
              void 0 !== f && M.normal.applyMatrix3(f).normalize();
            for (var E = 0, T = _.length; E < T; E++)
              (S = _[E].clone()),
                void 0 !== f && S.applyMatrix3(f).normalize(),
                M.vertexNormals.push(S);
            M.color.copy(y.color);
            for (var E = 0, T = b.length; E < T; E++)
              (L = b[E]), M.vertexColors.push(L.clone());
        ...
        mergeMesh: function (e) {
          return e && e.isMesh
            ? void (e.matrixAutoUpdate && e.updateMatrix(),
        ...
        mergeVertices: function () {
          var e = {},
            ...
            p,
            u;
          for (l = 0, i = this.vertices.length; l < i; l++)
            (o = this.vertices[l]),
              (s = n(o.x * a) + "_" + n(o.y * a) + "_" + n(o.z * a)),
              void 0 === e[s]
                ? ((e[s] = l), t.push(this.vertices[l]), (r[l] = t.length - 1))
                : (r[l] = r[e[s]]);
          var m = [];
          ...
          for (l = m.length - 1; 0 <= l; l--) {
            var f = m[l];
            for (
              this.faces.splice(f, 1), p = 0, u = this.faceVertexUvs.length;
              p < u;
              p++
            )
              this.faceVertexUvs[p].splice(f, 1);
          }
        ...
        setFromPoints: function (e) {
          ...
          for (var t = 0, r = e.length, a; t < r; t++)
            (a = e[t]), this.vertices.push(new p.a(a.x, a.y, a.z || 0));
          return this;
        },
        sortFacesByMaterialIndex: function () {
          ...
          for (var r = 0, s; r < t; r++)
            (s = e[r]._id), n && n.push(a[s]), o && o.push(i[s]);
        ...
        toJSON: function () {
          ...
          function t(e) {
            ...
            return void 0 === u[t]
              ? ((u[t] = p.length / 3), p.push(e.x, e.y, e.z), u[t])
              : u[t];
          }
          function r(e) {
            var t = e.r.toString() + e.g.toString() + e.b.toString();
            return void 0 === g[t]
              ? ((g[t] = m.length), m.push(e.getHex()), g[t])
              : g[t];
          }
          function a(e) {
            var t = e.x.toString() + e.y.toString();
            return void 0 === h[t]
              ? ((h[t] = f.length / 2), f.push(e.x, e.y), h[t])
              : h[t];
          }
          var n = {
            metadata: {
          ...
          for (var l = [], d = 0, i; d < this.vertices.length; d++)
            (i = this.vertices[d]), l.push(i.x, i.y, i.z);
          for (
            var c = [], p = [], u = {}, m = [], g = {}, f = [], h = {}, d = 0;
            d < this.faces.length;
            d++
          ) {
            var v = this.faces[d],
          ...
          return (
            ...
            (n.data.vertices = l),
            (n.data.normals = p),
            0 < m.length && (n.data.colors = m),
            0 < f.length && (n.data.uvs = [f]),
            (n.data.faces = c),
            n
          );
        },
        ...
        copy: function (e) {
          ...
          for (t = 0, r = g.length; t < r; t++) {
            var f = { name: g[t].name };
            if (void 0 !== g[t].vertices)
              for (f.vertices = [], a = 0, i = g[t].vertices.length; a < i; a++)
                f.vertices.push(g[t].vertices[a].clone());
            if (void 0 !== g[t].normals)
              for (f.normals = [], a = 0, i = g[t].normals.length; a < i; a++)
                f.normals.push(g[t].normals[a].clone());
            this.morphTargets.push(f);
          }
          var h = e.morphNormals;
          for (t = 0, r = h.length; t < r; t++) {
            var v = {};
            if (void 0 !== h[t].vertexNormals)
              for (
                v.vertexNormals = [], a = 0, i = h[t].vertexNormals.length;
                a < i;
                a++
              ) {
                var x = h[t].vertexNormals[a],
                  y = {};
                (y.a = x.a.clone()),
                  (y.b = x.b.clone()),
                  (y.c = x.c.clone()),
            ...
            if (void 0 !== h[t].faceNormals)
              for (
                v.faceNormals = [], a = 0, i = h[t].faceNormals.length;
                a < i;
                a++
              )
                v.faceNormals.push(h[t].faceNormals[a].clone());
    ...
    XPv6: function (e, t, r) {
      ...
      function a(e, t, r, a) {
        o.a.call(this),
          ...
          this.fromBufferGeometry(new i(e, t, r, a)),
          this.mergeVertices();
      }
      function i(e, t, r, i) {
        s.a.call(this),
        ...
        this.setIndex(v),
          this.addAttribute("position", new l.b(_, 3)),
          this.addAttribute("normal", new l.b(M, 3)),
          this.addAttribute("uv", new l.b(S, 2));
      }
      var n = Math.floor;
      r.d(t, "b", function () {
        return a;
      ...
      (a.prototype = Object.create(o.a.prototype)),
        (a.prototype.constructor = a),
        (i.prototype = Object.create(s.a.prototype)),
        (i.prototype.constructor = i);
    },
    breI: function (e, t, r) {
      "use strict";
        ...
        Object.assign(a.prototype, {
          ...
          setFromUnitVectors: (function () {
            ...
            return function (r, a) {
              return (
                ...
                t < 1e-6
                  ? ((t = 0),
                    s(r.x) > s(r.z) ? e.set(-r.y, r.x, 0) : e.set(0, -r.z, r.y))
                  : e.crossVectors(r, a),
                (this._x = e.x),
                (this._y = e.y),
                (this._z = e.z),
          ...
          multiplyQuaternions: function (e, t) {
            var r = e._x,
              ...
              d = t._w;
            return (
              (this._x = r * d + n * o + a * l - i * s),
              (this._y = a * d + n * s + i * o - r * l),
              (this._z = i * d + n * l + r * s - a * o),
              (this._w = n * d - r * o - a * s - i * l),
              this.onChangeCallback(),
              this
            );
          },
          slerp: function (e, r) {
            ...
            if (
              ...
              return (
                (this._w = c), (this._x = t), (this._y = a), (this._z = d), this
              );
            var u = 1 - p * p;
            if (u <= n) {
              var m = 1 - r;
              return (
                (this._w = m * c + r * this._w),
                (this._x = m * t + r * this._x),
                (this._y = m * a + r * this._y),
                (this._z = m * d + r * this._z),
                this.normalize()
              );
            }
            var s = o(u),
              ...
              h = l(r * g) / s;
            return (
              (this._w = c * f + this._w * h),
              (this._x = t * f + this._x * h),
              (this._y = a * f + this._y * h),
              (this._z = d * f + this._z * h),
              this.onChangeCallback(),
              this
            );
          },
    ...
    brnI: function (e, t, r) {
      ...
      function a(e, t) {
        g.a.call(this),
          ...
          this.fromBufferGeometry(new i(e, t)),
          this.mergeVertices();
      }
      function i(e, r) {
        function t(e) {
          ...
          function M() {
            ...
            if (I) {
              var t = 0,
                r = ae * t;
              for (oe = 0; oe < ie; oe++)
                (ce = te[oe]), T(ce[2] + r, ce[1] + r, ce[0] + r);
              for (t = R + 2 * G, r = ae * t, oe = 0; oe < ie; oe++)
                (ce = te[oe]), T(ce[0] + r, ce[1] + r, ce[2] + r);
            } else {
              for (oe = 0; oe < ie; oe++) (ce = te[oe]), T(ce[2], ce[1], ce[0]);
              for (oe = 0; oe < ie; oe++)
                (ce = te[oe]),
                  T(ce[0] + ae * R, ce[1] + ae * R, ce[2] + ae * R);
            }
          ...
          function S() {
            var e = o.length / 3,
              t = 0;
            for (
              L(re, t), t += re.length, ((ee = 0), (h = Q.length));
              ee < h;
              ee++
            )
              ($ = Q[ee]), L($, t), (t += $.length);
          ...
          function T(e, t, r) {
            P(e), P(t), P(r);
            var a = o.length / 3,
              i = B.generateTopUV(n, o, a - 3, a - 2, a - 1);
            C(i[0]), C(i[1]), C(i[2]);
          }
          function w(e, t, r, a) {
            P(e), P(t), P(a), P(t), P(r), P(a);
            var i = o.length / 3,
              s = B.generateSideWallUV(n, o, i - 6, i - 3, i - 2, i - 1);
          ...
          var A = [],
            D = void 0 === r.curveSegments ? 12 : r.curveSegments,
            R = void 0 === r.steps ? 1 : r.steps,
            N = void 0 === r.depth ? 100 : r.depth,
            I = void 0 === r.bevelEnabled || r.bevelEnabled,
            U = void 0 === r.bevelThickness ? 6 : r.bevelThickness,
            F = void 0 === r.bevelSize ? U - 2 : r.bevelSize,
            G = void 0 === r.bevelSegments ? 3 : r.bevelSegments,
            O = r.extrudePath,
          ...
          var V = !1,
            ...
            Y;
          O &&
            ((H = O.getSpacedPoints(R)),
            (V = !0),
            (I = !1),
            (W = O.computeFrenetFrames(R, !1)),
            (q = new x.a()),
            (X = new x.a()),
            (Y = new x.a())),
            I || ((G = 0), (U = 0), (F = 0));
          var J = e.extractPoints(D),
            Z = J.shape,
            Q = J.holes,
            K = !y.a.isClockWise(Z),
            $,
            ...
            h;
          if (K)
            for (Z = Z.reverse(), ee = 0, h = Q.length; ee < h; ee++)
              ($ = Q[ee]), y.a.isClockWise($) && (Q[ee] = $.reverse());
          var te = y.a.triangulateShape(Z, Q),
            re = Z;
          ...
          for (k = 0; k < G; k++) {
            for (
              ...
              (de = g(re[oe], ne[oe], b)), E(de.x, de.y, -t);
            for (ee = 0, h = Q.length; ee < h; ee++)
              for (
                $ = Q[ee], me = pe[ee], ((oe = 0), (i = $.length));
                oe < i;
                oe++
              )
                (de = g($[oe], me[oe], b)), E(de.x, de.y, -t);
          }
          for (b = F, oe = 0; oe < ae; oe++)
            (de = I ? g(Z[oe], ue[oe], b) : Z[oe]),
              V
                ? (X.copy(W.normals[0]).multiplyScalar(de.x),
                  q.copy(W.binormals[0]).multiplyScalar(de.y),
                  Y.copy(H[0]).add(X).add(q),
                  E(Y.x, Y.y, Y.z))
                : E(de.x, de.y, 0);
          var ge;
          for (ge = 1; ge <= R; ge++)
            for (oe = 0; oe < ae; oe++)
              (de = I ? g(Z[oe], ue[oe], b) : Z[oe]),
                V
                  ? (X.copy(W.normals[ge]).multiplyScalar(de.x),
                    q.copy(W.binormals[ge]).multiplyScalar(de.y),
                    Y.copy(H[ge]).add(X).add(q),
                    E(Y.x, Y.y, Y.z))
                  : E(de.x, de.y, (N / R) * ge);
          for (k = G - 1; 0 <= k; k--) {
            for (
              ...
              (de = g(re[oe], ne[oe], b)), E(de.x, de.y, N + t);
            for (ee = 0, h = Q.length; ee < h; ee++)
              for (
                $ = Q[ee], me = pe[ee], ((oe = 0), (i = $.length));
                oe < i;
        ...
        f.a.call(this),
          ...
          (this.parameters = { shapes: e, options: r }),
          (e = Array.isArray(e) ? e : [e]);
        for (var n = this, o = [], a = [], s = 0, i = e.length, g; s < i; s++)
          (g = e[s]), t(g);
        this.addAttribute("position", new h.b(o, 3)),
          this.addAttribute("uv", new h.b(a, 2)),
          this.computeVertexNormals();
      }
      function n(e, t, r) {
        if (((r.shapes = []), Array.isArray(e)))
          for (var a = 0, i = e.length, n; a < i; a++)
            (n = e[a]), r.shapes.push(n.uuid);
      ...
      function o(e, t) {
        g.a.call(this),
          ...
          this.fromBufferGeometry(new s(e, t)),
          this.mergeVertices();
      }
      function s(e, t) {
        t = t || {};
        ...
        (t.depth = void 0 === t.height ? 50 : t.height),
      ...
      var l = Number.EPSILON,
        ...
        x = r("w+kJ"),
        y = r("IJRe");
      (a.prototype = Object.create(g.a.prototype)),
        (a.prototype.constructor = a),
        (a.prototype.toJSON = function () {
          var e = g.a.prototype.toJSON.call(this),
            t = this.parameters.shapes,
            r = this.parameters.options;
          return n(t, r, e);
        }),
        (i.prototype = Object.create(f.a.prototype)),
        (i.prototype.constructor = i),
        (i.prototype.toJSON = function () {
          var e = f.a.prototype.toJSON.call(this),
            t = this.parameters.shapes,
            r = this.parameters.options;
          return n(t, r, e);
        });
      ...
      r.d(t, "a", function () {
        ...
        (o.prototype = Object.create(g.a.prototype)),
        (o.prototype.constructor = o),
      ...
      Object.assign(a.prototype, {
            ...
            switch (a) {
              ...
              case "rgba":
                if (
                  ...
                  return (
                    (this.r = o(255, parseInt(n[1], 10)) / 255),
                    (this.g = o(255, parseInt(n[2], 10)) / 255),
                    (this.b = o(255, parseInt(n[3], 10)) / 255),
                    t(n[5]),
                    this
                  );
                if (
                  ...
                  return (
                    (this.r = o(100, parseInt(n[1], 10)) / 100),
                    (this.g = o(100, parseInt(n[2], 10)) / 100),
                    (this.b = o(100, parseInt(n[3], 10)) / 100),
                    t(n[5]),
                    this
                  );
                break;
        ...
        copySRGBToLinear: (function () {
          function e(e) {
            return 0.04045 > e
              ? 0.0773993808 * e
              : i(0.9478672986 * e + 0.0521327014, 2.4);
          }
          return function (t) {
            return (
        ...
        copyLinearToSRGB: (function () {
          function e(e) {
            return 0.0031308 > e ? 12.92 * e : 1.055 * i(e, 0.41666) - 0.055;
          }
          return function (t) {
            return (
              (this.r = e(t.r)), (this.g = e(t.g)), (this.b = e(t.b)), this
        ...
        sub: function (e) {
          return (
            (this.r = n(0, this.r - e.r)),
            (this.g = n(0, this.g - e.g)),
            (this.b = n(0, this.b - e.b)),
            this
          );
        },
        multiply: function (e) {
        ...
        lerpHSL: (function () {
          ...
          return function (r, a) {
            ...
            var i = d.a.lerp(e.h, t.h, a),
              n = d.a.lerp(e.s, t.s, a),
              o = d.a.lerp(e.l, t.l, a);
      ...
      (a.prototype = Object.create(i.a.prototype)),
        ...
        (a.prototype.copy = function (e) {
          return (
            ...
            (this.uniforms = Object(n.a)(e.uniforms)),
    ...
    "e/Nn": function (e, t, r) {
      ...
      function a(e, t, r, a, o, s, l, d, c) {
        n.a.call(this, e, t, r, a, o, s, l, d, c),
          (this.format = void 0 === l ? i.Nb : l),
          (this.minFilter = void 0 === s ? i.M : s),
          (this.magFilter = void 0 === o ? i.M : o),
          (this.generateMipmaps = !1);
      }
      r.d(t, "a", function () {
        return a;
    ...
    eu9D: function (e, t, r) {
      ...
      Object.assign(a.prototype, {
        isMatrix3: !0,
        set: function (e, t, r, a, i, n, o, s, l) {
          var d = this.elements;
          return (
            (d[0] = e),
            (d[1] = a),
        ...
        equals: function (e) {
          for (var t = this.elements, r = e.elements, a = 0; 9 > a; a++)
            if (t[a] !== r[a]) return !1;
          return !0;
        },
        fromArray: function (e, t) {
    ...
    nKeq: function (e, t, r) {
      ...
      function a(e, t, r) {
        ...
        (this.name = ""),
          (this.array = e),
          (this.itemSize = t),
          (this.count = void 0 === e ? 0 : e.length / t),
          (this.normalized = !0 === r),
          (this.dynamic = !1),
      ...
      Object.defineProperty(a.prototype, "needsUpdate", {
        ...
        Object.assign(a.prototype, {
          ...
          setArray: function (e) {
            ...
            return (
              (this.count = void 0 === e ? 0 : e.length / this.itemSize),
              (this.array = e),
              this
            );
          },
          ...
          copyAt: function (e, t, r) {
            ...
            for (var a = 0, i = this.itemSize; a < i; a++)
          ...
          copyColorsArray: function (e) {
            for (var t = this.array, r = 0, a = 0, i = e.length, n; a < i; a++)
              (n = e[a]),
                void 0 === n &&
                  (console.warn(
    ...
    p1p1: function (e, t, r) {
      ...
      var o = Math.atan2,
        ...
        p = r("w4Ua"),
        u = r("MnML");
      (a.RotationOrders = ["XYZ", "YZX", "ZXY", "XZY", "YXZ", "ZYX"]),
        (a.DefaultOrder = "XYZ"),
        Object.defineProperties(a.prototype, {
          x: {
            get: function () {
          ...
          setFromRotationMatrix: function (e, t, r) {
            ...
            return (
              ...
              "XYZ" === t
                ? ((this._y = a(i(c, -1, 1))),
                  0.99999 > s(c)
                    ? ((this._x = o(-g, v)), (this._z = o(-d, l)))
                    : ((this._x = o(h, m)), (this._z = 0)))
                : "YXZ" === t
                ? ((this._x = a(-i(g, -1, 1))),
                  0.99999 > s(g)
                    ? ((this._y = o(c, v)), (this._z = o(p, m)))
                    : ((this._y = o(-f, l)), (this._z = 0)))
                : "ZXY" === t
                ? ((this._x = a(i(h, -1, 1))),
                  0.99999 > s(h)
                    ? ((this._y = o(-f, v)), (this._z = o(-d, m)))
                    : ((this._y = 0), (this._z = o(p, l))))
                : "ZYX" === t
                ? ((this._y = a(-i(f, -1, 1))),
                  0.99999 > s(f)
                    ? ((this._x = o(h, v)), (this._z = o(p, l)))
                    : ((this._x = 0), (this._z = o(-d, m))))
                : "YZX" === t
                ? ((this._z = a(i(p, -1, 1))),
                  0.99999 > s(p)
                    ? ((this._x = o(-g, m)), (this._y = o(-f, l)))
                    : ((this._x = 0), (this._y = o(c, v))))
                : "XZY" === t
                ? ((this._z = a(-i(d, -1, 1))),
                  0.99999 > s(d)
                    ? ((this._x = o(h, m)), (this._y = o(c, l)))
                    : ((this._x = o(-g, v)), (this._y = 0)))
                : console.warn(
          ...
          setFromQuaternion: (function () {
            ...
            return function (t, r, a) {
              return (
                ...
                this.setFromRotationMatrix(e, r, a)
              );
            };
          })(),
      ...
      var f = 0;
      (n.DefaultUp = new d.a(0, 1, 0)),
        (n.DefaultMatrixAutoUpdate = !0),
        (n.prototype = Object.assign(Object.create(p.a.prototype), {
          constructor: n,
          isObject3D: !0,
          ...
          rotateOnAxis: (function () {
            ...
            return function (t, r) {
              return (
                e.setFromAxisAngle(t, r), this.quaternion.multiply(e), this
              );
            };
          })(),
          rotateOnWorldAxis: (function () {
            ...
            return function (t, r) {
              return (
                e.setFromAxisAngle(t, r), this.quaternion.premultiply(e), this
              );
            };
          })(),
          rotateX: (function () {
            ...
            return function (i, n, o) {
              ...
              this.updateWorldMatrix(!0, !1),
                ...
                this.isCamera || this.isLight
                  ? t.lookAt(a, r, this.up)
                  : t.lookAt(r, a, this.up),
          ...
          traverse: function (e) {
            e(this);
            for (var t = this.children, r = 0, a = t.length; r < a; r++)
              t[r].traverse(e);
          },
          ...
          updateWorldMatrix: function (e, t) {
            ...
            if (
              ...
              for (var a = this.children, n = 0, i = a.length; n < i; n++)
                a[n].updateWorldMatrix(!1, !0);
          },
          toJSON: function (e) {
            function t(t, r) {
            ...
            var a = void 0 === e || "string" == typeof e,
              n = {};
            a &&
              ((e = {
                geometries: {},
            ...
            if (
              ...
              if (void 0 !== s && void 0 !== s.shapes) {
                var d = s.shapes;
                if (Array.isArray(d))
                  for (var c = 0, i = d.length, l; c < i; c++)
                    (l = d[c]), t(e.shapes, l);
                else t(e.shapes, d);
              }
            }
            if (void 0 !== this.material)
              if (Array.isArray(this.material)) {
                for (var p = [], c = 0, i = this.material.length; c < i; c++)
                  p.push(t(e.materials, this.material[c]));
                o.material = p;
            ...
            if (a) {
              var u = r(e.geometries),
                m = r(e.materials),
                f = r(e.textures),
                h = r(e.images),
                d = r(e.shapes);
              0 < u.length && (n.geometries = u),
                0 < m.length && (n.materials = m),
                0 < f.length && (n.textures = f),
                0 < h.length && (n.images = h),
                0 < d.length && (n.shapes = d);
            }
            return (n.object = o), n;
          },
          clone: function (e) {
          ...
          copy: function (e, t) {
            if (
              ...
              for (var r = 0, a; r < e.children.length; r++)
                (a = e.children[r]), this.add(a.clone());
            return this;
          },
        }));
    },
      ...
      Object.assign(a.prototype, {
        ...
        applyMatrix3: function (t) {
          var r = this.x,
            ...
            n = t.elements;
          return (
            (this.x = n[0] * r + n[3] * a + n[6] * i),
            (this.y = n[1] * r + n[4] * a + n[7] * i),
            (this.z = n[2] * r + n[5] * a + n[8] * i),
            this
          );
        },
        applyMatrix4: function (t) {
          ...
          return (
            (this.x = (n[0] * r + n[4] * a + n[8] * i + n[12]) * e),
            (this.y = (n[1] * r + n[5] * a + n[9] * i + n[13]) * e),
            (this.z = (n[2] * r + n[6] * a + n[10] * i + n[14]) * e),
            this
          );
        },
        applyQuaternion: function (e) {
          var t = this.x,
            ...
            p = -i * t - n * r - o * a;
          return (
            (this.x = l * s + p * -i + d * -o - c * -n),
            (this.y = d * s + p * -n + c * -i - l * -o),
            (this.z = c * s + p * -o + l * -n - d * -i),
            this
          );
        },
        project: function (e) {
        ...
        transformDirection: function (t) {
          var r = this.x,
            ...
            n = t.elements;
          return (
            (this.x = n[0] * r + n[4] * a + n[8] * i),
            (this.y = n[1] * r + n[5] * a + n[9] * i),
            (this.z = n[2] * r + n[6] * a + n[10] * i),
            this.normalize()
          );
        },
        divide: function (e) {
        ...
        clamp: function (e, t) {
          return (
            (this.x = p(e.x, u(t.x, this.x))),
            (this.y = p(e.y, u(t.y, this.y))),
            (this.z = p(e.z, u(t.z, this.z))),
            this
          );
        },
        clampScalar: (function () {
        ...
        setFromSphericalCoords: function (e, t, r) {
          var a = l(t) * e;
          return (
            (this.x = a * l(r)), (this.y = d(t) * e), (this.z = a * d(r)), this
          );
        },
        ...
        Object.assign(a.prototype, {
          ...
          dispatchEvent: function (e) {
            if (void 0 !== this._listeners) {
              ...
              if (void 0 !== r) {
                e.target = this;
                for (var a = r.slice(0), n = 0, i = a.length; n < i; n++)
                  a[n].call(this, e);
              }
            }
          },
    ...
    xC2a: function (e, t, r) {
      ...
      Object.assign(a.prototype, {
        ...
        load: function (e, t, r, a) {
          function i() {
            d.removeEventListener("load", i, !1),
              d.removeEventListener("error", n, !1),
              o.a.add(e, this),
              t && t(this),
              s.manager.itemEnd(e);
          }
          ...
          return (
            d.addEventListener("load", i, !1),
            d.addEventListener("error", n, !1),
            "data:" !== e.substr(0, 5) &&
    ...
    "xvF/": function (e, t, r) {
      ...
      function a(e, t, r, i, n, o, s, u, m, f) {
        Object.defineProperty(this, "id", { value: g++ }),
          (this.uuid = d.a.generateUUID()),
          (this.name = ""),
          (this.image = void 0 === e ? a.DEFAULT_IMAGE : e),
          (this.mipmaps = []),
          (this.mapping = void 0 === t ? a.DEFAULT_MAPPING : t),
          (this.wrapS = void 0 === r ? l.k : r),
          (this.wrapT = void 0 === i ? l.k : i),
          (this.magFilter = void 0 === n ? l.M : n),
          (this.minFilter = void 0 === o ? l.N : o),
          (this.anisotropy = void 0 === m ? 1 : m),
          (this.format = void 0 === s ? l.rb : s),
          (this.type = void 0 === u ? l.kc : u),
      ...
      (a.DEFAULT_IMAGE = void 0),
        (a.DEFAULT_MAPPING = l.ic),
        (a.prototype = Object.assign(Object.create(s.a.prototype), {
          constructor: a,
          isTexture: !0,
          updateMatrix: function () {
          ...
          toJSON: function (e) {
            ...
            if (void 0 !== this.image) {
              var a = this.image;
              if (
                (void 0 === a.uuid && (a.uuid = d.a.generateUUID()),
                !t && void 0 === e.images[a.uuid])
              ) {
                var n;
                if (Array.isArray(a)) {
                  n = [];
                  for (var o = 0, i = a.length; o < i; o++)
                    n.push(u.getDataURL(a[o]));
    ...
    zfxg: function (e, t, r) {
      ...
      Object.assign(a.prototype, {
        computeGroups: function (e) {
          for (
            var t = [], r = void 0, a = e.faces, n = 0, i, o;
            n < a.length;
            n++
          )
            (o = a[n]),
              o.materialIndex !== r &&
                ((r = o.materialIndex),
                void 0 != i && ((i.count = 3 * n - i.start), t.push(i)),
                (i = { start: 3 * n, materialIndex: r }));
          void 0 !== i && ((i.count = 3 * n - i.start), t.push(i)),
            (this.groups = t);
        },
            ...
            if (!0 === n) {
              ...
              void 0 === S
                ? (console.warn(
                  ...
                  this.uvs.push(new c.a(), new c.a(), new c.a()))
            ...
            if (!0 === o) {
              ...
              void 0 === S
                ? (console.warn(
                  ...
                  this.uvs2.push(new c.a(), new c.a(), new c.a()))
                : this.uvs2.push(S[0], S[1], S[2]);
            }
            for (var L = 0, E; L < l; L++)
              (E = s[L].vertices), d[L].data.push(E[x.a], E[x.b], E[x.c]);
            for (var L = 0, T; L < u; L++)
              (T = i[L].vertexNormals[p]), m[L].data.push(T.a, T.b, T.c);
            h && this.skinIndices.push(g[x.a], g[x.b], g[x.c]),
              v && this.skinWeights.push(f[x.a], f[x.b], f[x.c]);
          }
          return (
      ...
      n.prototype = Object.assign(Object.create(s.a.prototype), {
        ...
        setIndex: function (e) {
          this.index = Array.isArray(e)
            ? new (65535 < Object(f.a)(e) ? d.d : d.c)(e, 1)
            : e;
        },
        addAttribute: function (e, t) {
          return (t && t.isBufferAttribute) ||
            ...
            : (console.warn(
              ...
              this.addAttribute(e, new d.a(arguments[1], arguments[2])));
        },
        ...
        setFromObject: function (e) {
          ...
          if (e.isPoints || e.isLine) {
            var r = new d.b(3 * t.vertices.length, 3),
              a = new d.b(3 * t.colors.length, 3);
            if (
              (this.addAttribute("position", r.copyVector3sArray(t.vertices)),
              this.addAttribute("color", a.copyColorsArray(t.colors)),
        ...
        setFromPoints: function (e) {
          for (var t = [], r = 0, a = e.length, i; r < a; r++)
            (i = e[r]), t.push(i.x, i.y, i.z || 0);
        ...
        updateFromObject: function (e) {
          ...
          if (e.isMesh) {
            ...
            if (
              (!0 === t.elementsNeedUpdate &&
                ((r = void 0), (t.elementsNeedUpdate = !1)),
              void 0 === r)
            )
          ...
          return (
            !0 === t.verticesNeedUpdate &&
              ...
              void 0 !== a &&
                (a.copyVector3sArray(t.vertices), (a.needsUpdate = !0)),
              (t.verticesNeedUpdate = !1)),
            !0 === t.normalsNeedUpdate &&
              ((a = this.attributes.normal),
              void 0 !== a &&
                (a.copyVector3sArray(t.normals), (a.needsUpdate = !0)),
              (t.normalsNeedUpdate = !1)),
            !0 === t.colorsNeedUpdate &&
              ((a = this.attributes.color),
              void 0 !== a &&
                (a.copyColorsArray(t.colors), (a.needsUpdate = !0)),
              (t.colorsNeedUpdate = !1)),
            t.uvsNeedUpdate &&
              ((a = this.attributes.uv),
              void 0 !== a &&
                (a.copyVector2sArray(t.uvs), (a.needsUpdate = !0)),
              (t.uvsNeedUpdate = !1)),
            t.lineDistancesNeedUpdate &&
              ((a = this.attributes.lineDistance),
              void 0 !== a &&
                (a.copyArray(t.lineDistances), (a.needsUpdate = !0)),
        ...
        fromGeometry: function (e) {
          return (
            (e.__directGeometry = new a().fromGeometry(e)),
        ...
        fromDirectGeometry: function (e) {
          ...
          if (
            (this.addAttribute(
              "position",
              new d.a(t, 3).copyVector3sArray(e.vertices)
            ),
            0 < e.normals.length)
          ) {
            ...
            this.addAttribute(
              "normal",
              new d.a(r, 3).copyVector3sArray(e.normals)
            );
          }
          ...
          for (var s in ((this.groups = e.groups), e.morphTargets)) {
            for (
              var c = [], p = e.morphTargets[s], u = 0, i = p.length;
              u < i;
              u++
            ) {
              var l = p[u],
                m = new d.b(3 * l.data.length, 3);
        ...
        computeBoundingSphere: (function () {
          ...
          return function () {
            ...
            if (r) {
              ...
              for (var n = 0, o = 0, i = r.count; o < i; o++)
                (t.x = r.getX(o)),
                  (t.y = r.getY(o)),
                  (t.z = r.getZ(o)),
                  (n = Math.max(n, a.distanceToSquared(t)));
        ...
        computeVertexNormals: function () {
          ...
          if (t.position) {
            ...
            if (void 0 === t.normal)
              this.addAttribute(
                "normal",
                new d.a(new Float32Array(r.length), 3)
              );
            else
              for (var a = t.normal.array, n = 0, i = a.length; n < i; n++)
                a[n] = 0;
            var s = t.normal.array,
              ...
              h;
            if (e)
              for (var v = e.array, n = 0, i = e.count; n < i; n += 3)
                (g = 3 * v[n + 0]),
                  (f = 3 * v[n + 1]),
                  (h = 3 * v[n + 2]),
                  l.fromArray(r, g),
              ...
              for (var n = 0, i = r.length; n < i; n += 9)
                l.fromArray(r, n),
                  c.fromArray(r, n + 3),
                  p.fromArray(r, n + 6),
                  u.subVectors(p, c),
        ...
        normalizeNormals: (function () {
          var e = new o.a();
          return function () {
            for (var t = this.attributes.normal, r = 0, a = t.count; r < a; r++)
              (e.x = t.getX(r)),
                (e.y = t.getY(r)),
                (e.z = t.getZ(r)),
                e.normalize(),
        ...
        toNonIndexed: function () {
          function e(e, t) {
            for (
              var r = e.array,
                a = e.itemSize,
                n = new r.constructor(t.length * a),
                o = 0,
                s = 0,
                c = 0,
                i = t.length;
          ...
          for (var f = this.groups, g = 0, h = f.length, l; g < h; g++)
            (l = f[g]), t.addGroup(l.start, l.count, l.materialIndex);
          return t;
        },
        toJSON: function () {
          var e = {
